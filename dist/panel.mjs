...
var canDefine_2_7_9_canDefine = define = canNamespace_1_0_0_canNamespace.define = function(typePrototype, defines, baseDefine) {
...
canStache_4_17_8_canStache.addHelper("plusOne", num => num + 1);
		...
		selectedNode: {
			value({ listenTo, lastSet, resolve }) {
				...
				listenTo(lastSet, node => {
					...
					if (selectedNode) {
						canReflect_1_17_9_canReflect.offKeyValue(selectedNode, "id");
					}
					...
					if (selectedNode) {
						...
						canReflect_1_17_9_canReflect.onKeyValue(selectedNode, "id", () => {
				...
				const selectedComponentTreeNode = canValue_1_1_0_canValue.returnedBy(() => findNode(this.componentTree, node => node.selected));
				...
				const selectedNodeInTree = canValue_1_1_0_canValue.returnedBy(() => findNode(this.componentTree, node => selectedNode && node.id === selectedNode.id));
...
canStache_4_17_8_canStache.addHelper("isList", isList);
canStache_4_17_8_canStache.addHelper("isNumber", val => typeof val === "number");
canStache_4_17_8_canStache.addHelper("isEven", num => num % 2 === 0);
const removeTrailingBracketsOrBraces = str => str.replace(/\[\]|\{\}$/, "");
canStache_4_17_8_canStache.addHelper("removeTrailingBracketsOrBraces", removeTrailingBracketsOrBraces);
	...
	view: `
		{{< singleValueTemplate }}
			{{# switch(type) }}
				...
				{{# case("Undefined") }}
					<div class="value">
						<editable-span text:raw="undefined" on:text="scope.vm.setPathValue(null, path, scope.event.target.text)" />
					</div>
				{{/ case }}
...
canComponent_4_4_11_canComponent.extend({
	...
	ViewModel: {
		...
		messages: { Type: map$2, Default: map$2 },
		undefineds: { Type: list$1, Default: list$1 },
		expandedKeys: list$1,
		error: "string",
		...
		json: {
			value({ listenTo, lastSet, resolve }) {
				...
				listenTo("undefineds", (ev, undefineds) => {
					...
					let undefinedPatches = canDiff_1_4_4_canDiff.deep({}, undefinedsObject);
