		...
		selectedNode: {
			value({ listenTo, lastSet, resolve }) {
				...
				const resetOnIdChange = () => {
					if (selectedNode) {
						canReflect_1_17_9_canReflect.offKeyValue(selectedNode, "id", resetOnIdChange);
					}
				...
				const setSelectedNode = node => {
					...
					if (selectedNode) {
						canReflect_1_17_9_canReflect.onKeyValue(selectedNode, "id", resetOnIdChange);
					}
				};
				...
				const selectedComponentTreeNode = canValue_1_1_0_canValue.returnedBy(() => {
				...
				const selectedNodeInTree = canValue_1_1_0_canValue.returnedBy(() => {
					return findNode(this.componentTree, node => {
