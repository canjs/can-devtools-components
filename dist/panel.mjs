...
var canType_1_1_3_canType = createCommonjsModule(function (module, exports) {
...
function check(Type, val) {
	...
	var error = new Error('Type value ' + typeof val === "string" ? '"' + val + '"' : val + ' (' + valueType + ') is not of type ' + canReflect_1_18_0_canReflect.getName(Type) + '.'	);
...
var canType_1_1_3_canType_1 = canType_1_1_3_canType.check;
var canType_1_1_3_canType_2 = canType_1_1_3_canType.convert;
var canType_1_1_3_canType_3 = canType_1_1_3_canType.maybe;
var canType_1_1_3_canType_4 = canType_1_1_3_canType.maybeConvert;
var canType_1_1_3_canType_5 = canType_1_1_3_canType.Any;
var canType_1_1_3_canType_6 = canType_1_1_3_canType.Integer;
var canType_1_1_3_canType_7 = canType_1_1_3_canType.late;
var canType_1_1_3_canType_8 = canType_1_1_3_canType.isTypeObject;
var canType_1_1_3_canType_9 = canType_1_1_3_canType.normalize;
var canType_1_1_3_canType_10 = canType_1_1_3_canType.all;
var canType_1_1_3_canType_11 = canType_1_1_3_canType.convertAll;
...
define.makeDefineInstanceKey = function(constructor) {
	constructor[Symbol.for("can.defineInstanceKey")] = function(property, value) {
		...
		if(value && typeof value.value !== "undefined") {
			...
			value.type = canType_1_1_3_canType.Any;
			delete value.value;
		}
...
makeDefinition = function(prop, def, defaultDefinition, typePrototype) {
	...
	if (def.type) {
		...
		definition.type = canType_1_1_3_canType.normalize(value);
	}
	...
	if (definition.hasOwnProperty("default")) {
		if (typeof definition.default === "function" && !definition.default.isAGetter && noTypeDefined) {
			definition.type = canType_1_1_3_canType.normalize(Function);
		}

		if (canReflect_1_18_0_canReflect.isPrimitive(definition.default) && noTypeDefined) {
			definition.type = canType_1_1_3_canType.normalize(definition.default.constructor);
		}
	}
	...
	if(canReflect_1_18_0_canReflect.size(definition) === 0) {
		definition.type = canType_1_1_3_canType.Any;
...
getDefinitionOrMethod = function(prop, value, defaultDefinition, typePrototype){
	...
	if(canReflect_1_18_0_canReflect.isPrimitive(value)) {
		definition = {
			...
			type: defaultDefinition.typeSetByDefault ?
				canType_1_1_3_canType.normalize(value.constructor) :
    ...
    // copies a `Type`'s methods over
		...
		definition = { type: canType_1_1_3_canType.normalize(Array) };
...
define.normalizeTypeDefinition = canType_1_1_3_canType.normalize;
...
define.hooks = {
	...
	normalizeTypeDefinition: canType_1_1_3_canType.normalize //define.normalizeTypeDefinition
};
...
class ObservableArray extends MixedInArray {
	...
	static convertsTo(Type) {
		const ConvertedType = canType_1_1_3_canType.convert(Type);
...
class DeepObservableObject extends canObservableObject {
	static get propertyDefaults() {
		return canType_1_1_3_canType.maybeConvert(DeepObservable);
	}
}
...
var canDeepObservable_1_0_1_canDeepObservable = canNamespace_1_0_0_canNamespace.DeepObservable = canType_1_1_3_canType.maybeConvert(DeepObservable);
...
class ComponentTreeNode extends canObservableObject {
	static get props() {
		return {
			selected: Boolean,
			tagName: canType_1_1_3_canType.convert(String),
			id: { type: Number, identity: true },
			children: canType_1_1_3_canType.late(() => canType_1_1_3_canType.convert(ComponentTreeList))
		};
	}
}
...
class ComponentTreeList extends canObservableArray {
	static get items() {
		return canType_1_1_3_canType.convert(ComponentTreeNode);
	}
}
/* jshint +W003 */
...
class ComponentTree extends canStacheElement {
	...
	static get props() {
		return {
			treeError: canType_1_1_3_canType.convert(String),

			componentTree: {
				type: canType_1_1_3_canType.maybeConvert(ComponentTreeList),
...
class EditableSpan extends canStacheElement {
	...
	static get props() {
		return {
			options: canType_1_1_3_canType.convert(canObservableArray),
...
class ParsedJSONNode extends canObservableObject {
	static get props() {
		return {
			key: canType_1_1_3_canType.convert(NumberOrString),
			value: canType_1_1_3_canType.convert(NumberOrString),
			type: String,
			path: String
		};
	}
...
class ParsedJSON extends canObservableArray {
	static get items() {
		return canType_1_1_3_canType.convert(ParsedJSONNode);
	}
}
...
class JSONTreeEditor extends canStacheElement {
	...
	static get props() {
		return {
			...
			typeNames: {
				type: canType_1_1_3_canType.convert(canObservableObject),
...
class ViewmodelEditor extends canStacheElement {
	...
	static get props() {
		return {
			...
			undefineds: {
				type: canType_1_1_3_canType.convert(canObservableArray),
			...
			expandedKeys: canType_1_1_3_canType.convert(canObservableArray),
			editorError: canType_1_1_3_canType.convert(String),
			...
			json: {
				...
				value({ listenTo, resolve }) {
					let json = resolve(canReflect_1_18_0_canReflect.new(canDeepObservable_1_0_1_canDeepObservable, this.getPatchedData(this.serializedViewModelData, this.jsonEditorPatches)));
			...
			jsonEditorPatches: {
				...
				value({ lastSet, listenTo, resolve }) {
					let patches = resolve(lastSet.get() || new canObservableArray([]));
		...
		patches.forEach(({ type, key: key$$1, value, index, deleteCount, insert }) => {
			switch (type) {
				...
				case "delete":
					...
					break;
				case "splice":
					arr = canKey_1_2_1_canKey.get(patchedData, key$$1);
...
class ExpandableSection extends canStacheElement {
	...
	static get props() {
		return {
			...
			sectionTitle: canType_1_1_3_canType.Any,
...
class ComponentsPanel extends canStacheElement {
	...
	static get props() {
		return {
			...
			componentTree: canType_1_1_3_canType.convert(canObservableArray),

			selectedNode: canType_1_1_3_canType.maybeConvert(canObservableObject),
			componentTreeError: String,
			tagName: "",

			// viewmodel editor fields
			viewModelData: canDeepObservable_1_0_1_canDeepObservable,

			typeNamesData: canType_1_1_3_canType.convert(canObservableObject),
			messages: canType_1_1_3_canType.convert(canObservableObject),
			undefineds: canType_1_1_3_canType.convert(canObservableArray),
			expandedKeys: canType_1_1_3_canType.convert(canObservableArray),
			viewModelEditorError: String,

			// breakpoints fields
			breakpoints: canType_1_1_3_canType.convert(canObservableArray),

			breakpointsError: canType_1_1_3_canType.convert(String),
			breakpointsExpanded: Boolean,

			//breakpoints DOM fields
			breakpointsTitle: canType_1_1_3_canType.Any,

			viewModelTitle: canType_1_1_3_canType.Any,
...
export { canStacheElement as StacheElement, canDeepObservable_1_0_1_canDeepObservable as DeepObservable, canObservableObject as ObservableObject, canObservableArray as ObservableArray, canReflect_1_18_0_canReflect as Reflect, canType_1_1_3_canType as type };
