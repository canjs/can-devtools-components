...
canStache_4_15_12_canStache.addBindings(canStacheBindings_4_8_0_canStacheBindings);
...
canStache_4_15_12_canStache.addHelper("plusOne", num => num + 1);

let ComponentTreeList;

const ComponentTreeNode = map$2.extend("ComponentTreeNode", {
	tagName: "string",
...
ComponentTreeList = list$1.extend("ComponentTreeList", {
	"#": ComponentTreeNode
});
...
var panel = canComponent_4_4_10_canComponent.extend({
	tag: "components-panel",
	ViewModel: {
		componentTree: list$1,
		selectedNode: map$2,
		viewModelData: map$2,
		typeNamesData: map$2,
		updateValues: {
...
export { canComponent_4_4_10_canComponent as Component, map$2 as DefineMap, list$1 as DefineList, canReflect_1_17_7_canReflect as Reflect };
