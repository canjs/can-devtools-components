...
define.types = {
	...
	'observable': function(newVal) {
			...
			else if(canReflect_1_17_9_canReflect.isPlainObject(newVal) &&  define.DefineMap) {
	...
	'stringOrObservable': function(newVal) {
		if(Array.isArray(newVal)) {
			...
			return canReflect_1_17_9_canReflect.convert( newVal, define.types.string);
		}
	},
	/**
...
var onKeyValue = canDefine_2_7_4_canDefine.eventsProto[canSymbol_1_6_4_canSymbol.for("can.onKeyValue")];
var offKeyValue = canDefine_2_7_4_canDefine.eventsProto[canSymbol_1_6_4_canSymbol.for("can.offKeyValue")];
...
function portalHelper(elementObservable, options){
	...
	function teardown() {
		...
		if(nodeList) {
			canViewNodelist_4_3_2_canViewNodelist.remove(nodeList);
			nodeList = null;
		}
	}
	...
	function getElementAndRender() {
		...
		if(el) {
			...
			canViewNodelist_4_3_2_canViewNodelist.register(nodeList, null, null, true);

			var observable = new canObservation_4_1_1_canObservation(evaluator, null, {isObservable: false});
	...
	return function(el) {
		...
		canViewNodelist_4_3_2_canViewNodelist.replace([el], frag);

		var nodeList = [comment];
		nodeList.expression = "portal";
		canViewNodelist_4_3_2_canViewNodelist.register(nodeList, teardown, options.nodeList, true);
		canViewNodelist_4_3_2_canViewNodelist.update(options.nodeList, [comment]);
	};
}
...
var canStache_4_16_0_canStache = canNamespace_1_0_0_canNamespace.stache = stache;
...
canStache_4_16_0_canStache.addBindings(canStacheBindings_4_8_0_canStacheBindings);
		...
		setup: function() {
			...
			if (Component) {
				...
				if (typeof this.renderer === "string") {
					...
					this.renderer = canStache_4_16_0_canStache(viewName, this.renderer);
				}
		...
		setup: function(el, componentTagData) {
			...
			if (componentContent !== undefined) {
				...
				if (typeof componentContent === "function") {
					...
					componentTagData.subtemplate = canStache_4_16_0_canStache(componentContent);
				}
			}
			...
			if (componentTemplates !== undefined) {
				canReflect_1_17_9_canReflect.eachKey(componentTemplates, function(template, name) {
					...
					if (typeof template === "string") {
						...
						componentTemplates[name] = canStache_4_16_0_canStache(debugName, template);
					}
				});
			}
...
canStache_4_16_0_canStache.addHelper("plusOne", num => num + 1);
...
canStache_4_16_0_canStache.addHelper("isList", isList);
canStache_4_16_0_canStache.addHelper("isNumber", val => typeof val === "number");
canStache_4_16_0_canStache.addHelper("isEven", num => num % 2 === 0);
const removeTrailingBracketsOrBraces = str => str.replace(/\[\]|\{\}$/, "");
canStache_4_16_0_canStache.addHelper("removeTrailingBracketsOrBraces", removeTrailingBracketsOrBraces);
...
const getType = val => {
	if (canReflect_1_17_9_canReflect.isObservableLike(val)) {
		if (canReflect_1_17_9_canReflect.isListLike(val)) {
			return "Array";
		} else if (canReflect_1_17_9_canReflect.isMapLike(val)) {
			return "Object";
		}
	}
...
const parseKeyValue = ({ key, value, parentPath }) => {
	...
	const mightHaveChildren = canReflect_1_17_9_canReflect.isObservableLike(value) && (canReflect_1_17_9_canReflect.isListLike(value) || canReflect_1_17_9_canReflect.isMapLike(value));
...
const JSONTreeEditor = canComponent_4_4_10_canComponent.extend({
	...
	ViewModel: {
		...
		get parsedJSON() {
			...
			canReflect_1_17_9_canReflect.each(this.json, (value, key) => {
	...
	ViewModel: {
		...
		json: {
			value({ listenTo, lastSet, resolve }) {
				...
				canReflect_1_17_9_canReflect.onValue(serializedJSON, setPatches);
				...
				listenTo("serializedViewModelData", (ev, vmData) => {
					...
					canReflect_1_17_9_canReflect.offValue(serializedJSON, setPatches);
					canReflect_1_17_9_canReflect.assignDeep(json, newJson);
					canReflect_1_17_9_canReflect.onValue(serializedJSON, setPatches);
				});
...
export { canComponent_4_4_10_canComponent as Component, map$2 as DefineMap, list$1 as DefineList, canReflect_1_17_9_canReflect as Reflect };
