...
var canDefine_2_7_8_canDefine = define = canNamespace_1_0_0_canNamespace.define = function(typePrototype, defines, baseDefine) {
...
// Ensure the "obj" passed as an argument has an object on @@can.meta
var canDefine_2_7_8_ensureMeta = function ensureMeta(obj) {
	var metaSymbol = canSymbol_1_6_4_canSymbol.for("can.meta");
	var meta = obj[metaSymbol];
...
var defineHelpers = {
	...
	defineExpando: canDefine_2_7_8_canDefine.expando,
	...
	log: function(key) {
		...
		var meta = canDefine_2_7_8_ensureMeta(instance);
...
function getSchema() {
	...
	return canDefine_2_7_8_canDefine.updateSchemaKeys(schema, definitions);
}

var sealedSetup = function(props){
	canDefine_2_7_8_canDefine.setup.call(
		this,
		props || {},
...
var DefineMap = canConstruct_3_5_4_canConstruct.extend("DefineMap",{
	setup: function(base){
		...
		if(DefineMap) {
			...
			var result = canDefine_2_7_8_canDefine(prototype, prototype, base.prototype._define);
				canDefine_2_7_8_canDefine.makeDefineInstanceKey(this, result);

			type$1(this);
			for(key in DefineMap.prototype) {
				canDefine_2_7_8_canDefine.defineConfigurableAndNotEnumerable(prototype, key, prototype[key]);
			}
			// If someone provided their own setup, we call that.
			if(prototype.setup === DefineMap.prototype.setup) {
				canDefine_2_7_8_canDefine.defineConfigurableAndNotEnumerable(prototype, "setup", sealedSetup);
			}
		...
		canDefine_2_7_8_canDefine.defineConfigurableAndNotEnumerable(prototype, "constructor", this);
	...
	"*": {
		type: canDefine_2_7_8_canDefine.types.observable
	}
});
...
canReflect_1_17_9_canReflect.setKeyValue(DefineMap.prototype, canSymbol_1_6_4_canSymbol.iterator, function() {
	return new canDefine_2_7_8_canDefine.Iterator(this);
});

// Add necessary event methods to this object.
for(var prop in canDefine_2_7_8_canDefine.eventsProto) {
	DefineMap[prop] = canDefine_2_7_8_canDefine.eventsProto[prop];
	Object.defineProperty(DefineMap.prototype, prop, {
		enumerable:false,
		value: canDefine_2_7_8_canDefine.eventsProto[prop],
		writable: true
	});
}
...
var eventsProtoSymbols = ("getOwnPropertySymbols" in Object) ?
  Object.getOwnPropertySymbols(canDefine_2_7_8_canDefine.eventsProto) :
  getSymbolsForIE(canDefine_2_7_8_canDefine.eventsProto);

eventsProtoSymbols.forEach(function(sym) {
  Object.defineProperty(DefineMap.prototype, sym, {
  	configurable: true,
    enumerable:false,
    value: canDefine_2_7_8_canDefine.eventsProto[sym],
    writable: true
  });
});
...
if(process.env.NODE_ENV !== 'production') {
	...
	canDefine_2_7_8_canDefine.defineConfigurableAndNotEnumerable(DefineMap.prototype, "log", defineHelpers_1.log);
}
//!steal-remove-end

// tells `can-define` to use this
canDefine_2_7_8_canDefine.DefineMap = DefineMap;
...
var make$1 = canDefine_2_7_8_canDefine.make;
...
var onKeyValue = canDefine_2_7_8_canDefine.eventsProto[canSymbol_1_6_4_canSymbol.for("can.onKeyValue")];
var offKeyValue = canDefine_2_7_8_canDefine.eventsProto[canSymbol_1_6_4_canSymbol.for("can.offKeyValue")];
...
function getSchema$1() {
	...
	schema = canDefine_2_7_8_canDefine.updateSchemaKeys(schema, definitions);
	if(schema.keys["#"]) {
...
var DefineList = canConstruct_3_5_4_canConstruct.extend("DefineList",
	...
	/** @prototype */
	{
		...
		setup: function(items) {
			...
			canDefine_2_7_8_canDefine.setup.call(this, {}, false);
		...
		__type: canDefine_2_7_8_canDefine.types.observable,
...
for(var prop$1 in canDefine_2_7_8_canDefine.eventsProto) {
	Object.defineProperty(DefineList.prototype, prop$1, {
		enumerable:false,
		value: canDefine_2_7_8_canDefine.eventsProto[prop$1],
		writable: true
	});
}
...
// Add necessary event methods to this object.
for (var prop$1 in canDefine_2_7_8_canDefine.eventsProto) {
	DefineList[prop$1] = canDefine_2_7_8_canDefine.eventsProto[prop$1];
	Object.defineProperty(DefineList.prototype, prop$1, {
		enumerable: false,
		value: canDefine_2_7_8_canDefine.eventsProto[prop$1],
		writable: true
...
canDefine_2_7_8_canDefine.DefineList = DefineList;
...
canComponent_4_4_11_canComponent.extend({
	...
	ViewModel: {
		breakpoints: { Type: list$1, Default: list$1 },
		...
		addBreakpoint: {
			default: () => expression => console.log(`adding breakpoint for ${expression}`)
		},

		toggleBreakpoint: {
			default: () => breakpoint => console.log("toggling breakpoint", breakpoint)
		},

		deleteBreakpoint: {
			default: () => breakpoint => console.log("deleting breakpoint", breakpoint)
		}
	},
	view: `
		<p>
...
var panel = canComponent_4_4_11_canComponent.extend({
	...
	ViewModel: {
		...
		breakpoints: list$1,
		updateValues: {
			default: () => data => console.log("updating viewModel with", data)
		},

		addBreakpoint: {
			default: () => key => console.log(`adding breakpoint for ${key}`)
		},

		toggleBreakpoint: {
			default: () => key => console.log(`toggling breakpoint for ${key}`)
		},

		deleteBreakpoint: {
			default: () => key => console.log(`deleting breakpoint for ${key}`)
		}
	},
	view: `
