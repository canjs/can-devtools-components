...
var canStacheBindings_5_0_3_canStacheBindings = canStacheBindings;

const rendererSymbol = Symbol.for("can.stacheRenderer");
const viewInsertSymbol$2 = Symbol.for("can.viewInsert");

// make bindings work
canStache_5_0_0_canStache.addBindings(canStacheBindings_5_0_3_canStacheBindings);
	...
	return class InitializeBindingsClass extends Base {
		initialize(props) {
			...
			if (bindings && bindings.length) {
				...
				var initializeData = canStacheBindings_5_0_3_canStacheBindings.behaviors.initializeViewModel(bindings, props, (properties) => {
...
function DeriveElement(BaseElement = HTMLElement) {
	...
	mixinLifecycleMethods(
		...
		[initializeSymbol](el, tagData) {
			...
			const teardownBindings = canStacheBindings_5_0_3_canStacheBindings.behaviors.viewModel(
				el,
				tagData,
