...
var canDefine_2_7_5_canDefine = define = canNamespace_1_0_0_canNamespace.define = function(typePrototype, defines, baseDefine) {
...
// Ensure the "obj" passed as an argument has an object on @@can.meta
var canDefine_2_7_5_ensureMeta = function ensureMeta(obj) {
	var metaSymbol = canSymbol_1_6_4_canSymbol.for("can.meta");
	var meta = obj[metaSymbol];
...
var defineHelpers = {
	...
	defineExpando: canDefine_2_7_5_canDefine.expando,
	...
	log: function(key) {
		...
		var meta = canDefine_2_7_5_ensureMeta(instance);
...
function getSchema() {
	...
	return canDefine_2_7_5_canDefine.updateSchemaKeys(schema, definitions);
}

var sealedSetup = function(props){
	canDefine_2_7_5_canDefine.setup.call(
		this,
		props || {},
...
var DefineMap = canConstruct_3_5_3_canConstruct.extend("DefineMap",{
	setup: function(base){
		...
		if(DefineMap) {
			...
			var result = canDefine_2_7_5_canDefine(prototype, prototype, base.prototype._define);
				canDefine_2_7_5_canDefine.makeDefineInstanceKey(this, result);

			type$1(this);
			for(key in DefineMap.prototype) {
				canDefine_2_7_5_canDefine.defineConfigurableAndNotEnumerable(prototype, key, prototype[key]);
			}
			// If someone provided their own setup, we call that.
			if(prototype.setup === DefineMap.prototype.setup) {
				canDefine_2_7_5_canDefine.defineConfigurableAndNotEnumerable(prototype, "setup", sealedSetup);
			}
		...
		canDefine_2_7_5_canDefine.defineConfigurableAndNotEnumerable(prototype, "constructor", this);
	...
	"*": {
		type: canDefine_2_7_5_canDefine.types.observable
	}
});
...
canReflect_1_17_9_canReflect.setKeyValue(DefineMap.prototype, canSymbol_1_6_4_canSymbol.iterator, function() {
	return new canDefine_2_7_5_canDefine.Iterator(this);
});

// Add necessary event methods to this object.
for(var prop in canDefine_2_7_5_canDefine.eventsProto) {
	DefineMap[prop] = canDefine_2_7_5_canDefine.eventsProto[prop];
	Object.defineProperty(DefineMap.prototype, prop, {
		enumerable:false,
		value: canDefine_2_7_5_canDefine.eventsProto[prop],
		writable: true
	});
}
...
var eventsProtoSymbols = ("getOwnPropertySymbols" in Object) ?
  Object.getOwnPropertySymbols(canDefine_2_7_5_canDefine.eventsProto) :
  getSymbolsForIE(canDefine_2_7_5_canDefine.eventsProto);

eventsProtoSymbols.forEach(function(sym) {
  Object.defineProperty(DefineMap.prototype, sym, {
  	configurable: true,
    enumerable:false,
    value: canDefine_2_7_5_canDefine.eventsProto[sym],
    writable: true
  });
});
...
if(process.env.NODE_ENV !== 'production') {
	...
	canDefine_2_7_5_canDefine.defineConfigurableAndNotEnumerable(DefineMap.prototype, "log", defineHelpers_1.log);
}
//!steal-remove-end

// tells `can-define` to use this
canDefine_2_7_5_canDefine.DefineMap = DefineMap;
...
var make$1 = canDefine_2_7_5_canDefine.make;
...
var onKeyValue = canDefine_2_7_5_canDefine.eventsProto[canSymbol_1_6_4_canSymbol.for("can.onKeyValue")];
var offKeyValue = canDefine_2_7_5_canDefine.eventsProto[canSymbol_1_6_4_canSymbol.for("can.offKeyValue")];
...
function getSchema$1() {
	...
	schema = canDefine_2_7_5_canDefine.updateSchemaKeys(schema, definitions);
	if(schema.keys["#"]) {
...
var DefineList = canConstruct_3_5_3_canConstruct.extend("DefineList",
	...
	/** @prototype */
	{
		...
		setup: function(items) {
			...
			canDefine_2_7_5_canDefine.setup.call(this, {}, false);
		...
		__type: canDefine_2_7_5_canDefine.types.observable,
...
for(var prop$1 in canDefine_2_7_5_canDefine.eventsProto) {
	Object.defineProperty(DefineList.prototype, prop$1, {
		enumerable:false,
		value: canDefine_2_7_5_canDefine.eventsProto[prop$1],
		writable: true
	});
}
...
// Add necessary event methods to this object.
for (var prop$1 in canDefine_2_7_5_canDefine.eventsProto) {
	DefineList[prop$1] = canDefine_2_7_5_canDefine.eventsProto[prop$1];
	Object.defineProperty(DefineList.prototype, prop$1, {
		enumerable: false,
		value: canDefine_2_7_5_canDefine.eventsProto[prop$1],
		writable: true
...
canDefine_2_7_5_canDefine.DefineList = DefineList;
...
var canViewCallbacks_4_3_3_canViewCallbacks = createCommonjsModule(function (module) {
...
var enableMutationObserver = function() {
	...
	var MutationObserver = canGlobals_1_2_1_canGlobals.getKeyValue("MutationObserver");
	if(MutationObserver) {
		globalMutationObserver = new MutationObserver(mutationHandler);
		globalMutationObserver.observe(document$1().documentElement, {
			childList: true,
			subtree: true
		});
	...
	function liveAttrsUpdate(newVal) {
		...
		for (name in newAttrs) {
			...
			if (newValue !== oldValue) {
				...
				var callback = canViewCallbacks_4_3_3_canViewCallbacks.attr(name);
				if (callback) {
					callback(el, {
						attributeName: name,
						scope: scope,
...
if(!canViewCallbacks_4_3_3_canViewCallbacks.tag("content")) {
	// This was moved from the legacy view/scanner.js to here.
	// This makes sure content elements will be able to have a callback.
	canViewCallbacks_4_3_3_canViewCallbacks.tag("content", function(el, tagData) {
...
function stache (filename, template) {
	...
	canViewParser_4_1_2_canViewParser(template, {
		...
		start: function(tagName, unary, lineNo){
			...
			var isCustomTag =  canViewCallbacks_4_3_3_canViewCallbacks.tag(tagName);
			...
			if(unary){
				...
				if(isCustomTag) {
					...
					addAttributesCallback(state.node, function(scope, parentNodeList){
						...
						//!steal-remove-end
						canViewCallbacks_4_3_3_canViewCallbacks.tagHandler(this,tagName, {
							scope: scope,
							subtemplate: null,
							templateType: "stache",
		...
		attrEnd: function(attrName, lineNo){
			...
			if(state.node.section) {
				...
				var attrCallback = canViewCallbacks_4_3_3_canViewCallbacks.attr(attrName);
...
stache.addBindings = canViewCallbacks_4_3_3_canViewCallbacks.attrs;

var canStache_4_17_3_canStache = canNamespace_1_0_0_canNamespace.stache = stache;
...
canViewCallbacks_4_3_3_canViewCallbacks.attrs(canStacheBindings);
...
canStache_4_17_3_canStache.addBindings(canStacheBindings_4_8_0_canStacheBindings);
		...
		setup: function() {
			...
			if (Component) {
				...
				if (typeof this.renderer === "string") {
					...
					this.renderer = canStache_4_17_3_canStache(viewName, this.renderer);
				}
				...
				canViewCallbacks_4_3_3_canViewCallbacks.tag(this.prototype.tag, renderComponent);
			}
		}
	}, {
		// ## Prototype
		...
		setup: function(el, componentTagData) {
			...
			if (componentContent !== undefined) {
				...
				if (typeof componentContent === "function") {
					...
					componentTagData.subtemplate = canStache_4_17_3_canStache(componentContent);
				}
			}
			...
			if (componentTemplates !== undefined) {
				canReflect_1_17_9_canReflect.eachKey(componentTemplates, function(template, name) {
					...
					if (typeof template === "string") {
						...
						componentTemplates[name] = canStache_4_17_3_canStache(debugName, template);
					}
				});
			}
...
canStache_4_17_3_canStache.addHelper("plusOne", num => num + 1);
...
canStache_4_17_3_canStache.addHelper("isList", isList);
canStache_4_17_3_canStache.addHelper("isNumber", val => typeof val === "number");
canStache_4_17_3_canStache.addHelper("isEven", num => num % 2 === 0);
const removeTrailingBracketsOrBraces = str => str.replace(/\[\]|\{\}$/, "");
canStache_4_17_3_canStache.addHelper("removeTrailingBracketsOrBraces", removeTrailingBracketsOrBraces);
...
const JSONTreeEditor = canComponent_4_4_11_canComponent.extend({
...
const KeyValueEditor = canComponent_4_4_11_canComponent.extend({
	...
	ViewModel: {
		...
		json: {
			value({ listenTo, lastSet, resolve }) {
				...
				const serializedJSON = new canObservation_4_1_2_canObservation(() => json.serialize());
				...
				listenTo("serializedViewModelData", (ev, vmData) => {
					...
					canReflect_1_17_9_canReflect.updateDeep(json, newJson);
					canReflect_1_17_9_canReflect.onValue(serializedJSON, setPatches);
				});
...
var panel = canComponent_4_4_11_canComponent.extend({
...
export { canComponent_4_4_11_canComponent as Component, map$2 as DefineMap, list$1 as DefineList, canReflect_1_17_9_canReflect as Reflect };
