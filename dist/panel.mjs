...
function portalHelper(elementObservable, options){
	...
	function teardown() {
		...
		if(nodeList) {
			canViewNodelist_4_3_3_canViewNodelist.remove(nodeList);
			nodeList = null;
		}
	}
...
var canStache_4_17_4_canStache = canNamespace_1_0_0_canNamespace.stache = stache;
...
canStache_4_17_4_canStache.addBindings(canStacheBindings_4_8_0_canStacheBindings);
		...
		setup: function() {
			...
			if (Component) {
				...
				if (typeof this.renderer === "string") {
					...
					this.renderer = canStache_4_17_4_canStache(viewName, this.renderer);
				}
		...
		setup: function(el, componentTagData) {
			...
			if (componentContent !== undefined) {
				...
				if (typeof componentContent === "function") {
					...
					componentTagData.subtemplate = canStache_4_17_4_canStache(componentContent);
				}
			}
			...
			if (componentTemplates !== undefined) {
				canReflect_1_17_9_canReflect.eachKey(componentTemplates, function(template, name) {
					...
					if (typeof template === "string") {
						...
						componentTemplates[name] = canStache_4_17_4_canStache(debugName, template);
					}
				});
			}
...
canStache_4_17_4_canStache.addHelper("plusOne", num => num + 1);
...
canStache_4_17_4_canStache.addHelper("isList", isList);
canStache_4_17_4_canStache.addHelper("isNumber", val => typeof val === "number");
canStache_4_17_4_canStache.addHelper("isEven", num => num % 2 === 0);
const removeTrailingBracketsOrBraces = str => str.replace(/\[\]|\{\}$/, "");
canStache_4_17_4_canStache.addHelper("removeTrailingBracketsOrBraces", removeTrailingBracketsOrBraces);
