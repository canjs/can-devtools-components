...
var canReflect_1_17_7_canReflect = canNamespace_1_0_0_canNamespace.Reflect = reflect;
 ...
 * @static
 */
canReflect_1_17_7_canReflect.assignMap(Construct, {
	/**
	 ...
	 */
	setup: function (base) {
		var defaults = canReflect_1_17_7_canReflect.assignDeepMap({},base.defaults);
		this.defaults = canReflect_1_17_7_canReflect.assignDeepMap(defaults,this.defaults);
	},
	...
	extend: function (name, staticProperties, instanceProperties) {
		...
		canReflect_1_17_7_canReflect.assignMap(Constructor, {
...
function getDeepSize ( root, level ) {
	if ( level === 0 ) {
		return canReflect_1_17_7_canReflect.size( root );
	} else if ( canReflect_1_17_7_canReflect.size( root ) === 0 ) {
		return 0;
	} else {
		var count = 0;
		canReflect_1_17_7_canReflect.each( root, function ( value ) {
...
function getDeep ( node, items, depth, maxDepth ) {
	...
	if ( maxDepth === depth ) {
		if ( canReflect_1_17_7_canReflect.isMoreListLikeThanMapLike( node ) ) {
			canReflect_1_17_7_canReflect.addValues( items, canReflect_1_17_7_canReflect.toArray( node ) );
		} else {
			throw new Error( "can-key-tree: Map-type leaf containers are not supported yet." );
		}
	} else {
		canReflect_1_17_7_canReflect.each( node, function ( value ) {
...
function clearDeep ( node, keys, maxDepth, deleteHandler ) {
	if ( maxDepth === keys.length ) {
		if ( canReflect_1_17_7_canReflect.isMoreListLikeThanMapLike( node ) ) {
			var valuesToRemove = canReflect_1_17_7_canReflect.toArray( node );
			if(deleteHandler) {
				valuesToRemove.forEach(function(value){
					deleteHandler.apply(null, keys.concat(value));
				});
			}
			canReflect_1_17_7_canReflect.removeValues( node, valuesToRemove );
		} else {
			throw new Error( "can-key-tree: Map-type leaf containers are not supported yet." );
		}
	} else {
		canReflect_1_17_7_canReflect.each( node, function ( value, key ) {
			clearDeep( value, keys.concat(key), maxDepth, deleteHandler );
			canReflect_1_17_7_canReflect.deleteKeyValue( node, key );
		});
	}
}
...
var KeyTree = function ( treeStructure, callbacks ) {
	...
	if ( canReflect_1_17_7_canReflect.isConstructorLike( FirstConstructor ) ) {
...
// ## Methods
canReflect_1_17_7_canReflect.assign(KeyTree.prototype,{
    // ### Add
    add: function ( keys ) {
        ...
        for ( var i = 0; i < keys.length - 1; i++ ) {
    		var key = keys[i];
    		var childNode = canReflect_1_17_7_canReflect.getKeyValue( place, key );
    		if ( !childNode ) {
    			...
    			canReflect_1_17_7_canReflect.setKeyValue( place, key, childNode );
    		}
    		place = childNode;
    	}

        // Add the final leaf value in the tree.
    	if ( canReflect_1_17_7_canReflect.isMoreListLikeThanMapLike( place ) ) {
    		canReflect_1_17_7_canReflect.addValues( place, [keys[keys.length - 1]] );
    	} else {
    ...
    getNode: function ( keys ) {
        ...
        for ( var i = 0; i < keys.length; i++ ) {
            var key = keys[i];
            node = canReflect_1_17_7_canReflect.getKeyValue( node, key );
            if ( !node ) {
                return;
            }
        }
    ...
    delete: function ( keys, deleteHandler ) {
        ...
        for ( var i = 0; i < keys.length - 1; i++ ) {
    		var key = keys[i];
    		var childNode = canReflect_1_17_7_canReflect.getKeyValue( parentNode, key );
        ...
        if ( !keys.length ) {
    		...
    		if ( canReflect_1_17_7_canReflect.isMoreListLikeThanMapLike( parentNode ) ) {
				if(deleteHandler) {
					deleteHandler.apply(null, keys.concat(lastKey));
				}
    			canReflect_1_17_7_canReflect.removeValues( parentNode, [lastKey] );
    		} else {
    			throw new Error( "can-key-tree: Map types are not supported yet." );
    		}
    	}
            ...
            var nodeToRemove = canReflect_1_17_7_canReflect.getKeyValue( parentNode, lastKey );
    		if ( nodeToRemove !== undefined ) {
    			clearDeep( nodeToRemove, keys, this.treeStructure.length - 1, deleteHandler );
    			canReflect_1_17_7_canReflect.deleteKeyValue( parentNode, lastKey );
    		} else {
    			return false;
    		}
    	}
    	...
    	for ( i = path.length - 2; i >= 0; i-- ) {
    		if ( canReflect_1_17_7_canReflect.size( parentNode ) === 0 ) {
    			parentNode = path[i];
    			canReflect_1_17_7_canReflect.deleteKeyValue( parentNode, keys[i] );
    		} else {
    			break;
    		}
    	}
        // Call `onEmpty` if the tree is now empty.
    	if (  canReflect_1_17_7_canReflect.size( this.root ) === 0 ) {
			this.empty = true;
...
var mergeValueDependencies = function mergeValueDependencies(obj, source) {
	...
	if (sourceValueDeps) {
		...
		canReflect_1_17_7_canReflect.eachIndex(sourceValueDeps, function(dep) {
...
var mergeKeyDependencies = function mergeKeyDependencies(obj, source) {
	...
	if (sourcekeyDeps) {
		...
		canReflect_1_17_7_canReflect.eachKey(sourcekeyDeps, function(keys, obj) {
			...
			canReflect_1_17_7_canReflect.eachIndex(keys, function(key) {
				entry.add(key);
			});
		});
	}
	...
	"can.dispatch": function(value, old) {
		...
		if(process.env.NODE_ENV !== 'production') {
			queuesArgs = [
				...
				, null
				, [canReflect_1_17_7_canReflect.getName(this), "changed to", value, "from", old]
		...
		if(process.env.NODE_ENV !== 'production') {
			...
			if (notifyHandlers.length) {
				notifyHandlers.forEach(function(handler) {
					var changes = canReflect_1_17_7_canReflect.getChangesDependencyRecord(handler);
...
var mixinValueEventBindings = function(obj) {
	canReflect_1_17_7_canReflect.assign(obj, properties);
	canReflect_1_17_7_canReflect.assignSymbols(obj, symbols);
...
function addNewKeyDependenciesIfNotInOld(event) {
    ...
    if(this.oldEventSet === undefined || this.oldEventSet["delete"](event) === false) {
        canReflect_1_17_7_canReflect.onKeyValue(this.observable, event, this.onDependencyChange,"notify");
    }
}
...
function removeKeyDependencies(event) {
    canReflect_1_17_7_canReflect.offKeyValue(this.observable, event, this.onDependencyChange,"notify");
}
...
function addValueDependencies(observable) {
    ...
    if(this.oldDependencies.valueDependencies.delete(observable) === false) {
        canReflect_1_17_7_canReflect.onValue(observable, this.onDependencyChange,"notify");
    }
}
function removeValueDependencies(observable) {
    canReflect_1_17_7_canReflect.offValue(observable, this.onDependencyChange,"notify");
}
...
var unbindTemporarilyBoundValue = function () {
	for (var i = 0, len = observables.length; i < len; i++) {
		canReflect_1_17_7_canReflect.offValue(observables[i], temporarilyBoundNoOperation);
	}
	observables = null;
};
...
function temporarilyBind(compute) {
	...
	canReflect_1_17_7_canReflect.onValue(computeInstance, temporarilyBoundNoOperation);
	if (!observables) {
		observables = [];
...
function Observation(func, context, options){
	...
	if (process.env.NODE_ENV !== 'production') {
		...
		Object.defineProperty(this.onDependencyChange, "name", {
			value: canReflect_1_17_7_canReflect.getName(this) + ".onDependencyChange",
		});
		Object.defineProperty(this.update, "name", {
			value: canReflect_1_17_7_canReflect.getName(this) + ".update",
		});
	}
	//!steal-remove-end
}
...
canReflect_1_17_7_canReflect.assign(Observation.prototype, {
			...
			if (process.env.NODE_ENV !== 'production') {
				queuesArgs = [
					...
					[],
					{
						priority: this.options.priority
						/* jshint laxcomma: true */
						, log: [ canReflect_1_17_7_canReflect.getName(this.update) ]
						/* jshint laxcomma: false */
					}
					/* jshint laxcomma: true */
					, [canReflect_1_17_7_canReflect.getName(context), "changed"]
					/* jshint laxcomma: false */
				];
			}
			//!steal-remove-end
	...
	log: function() {
		...
		if (process.env.NODE_ENV !== 'production') {
			...
			this._log = function(previous, current) {
				dev.log(
					canReflect_1_17_7_canReflect.getName(this),
...
if (process.env.NODE_ENV !== 'production') {
	observationProto["can.getName"] = function() {
		return canReflect_1_17_7_canReflect.getName(this.constructor) + "<" + canReflect_1_17_7_canReflect.getName(this.func) + ">";
	};
}
//!steal-remove-end
canReflect_1_17_7_canReflect.assignSymbols(Observation.prototype, observationProto);
...
canReflect_1_17_7_canReflect.assignMap(SimpleObservable.prototype, {
...
if (process.env.NODE_ENV !== 'production') {
	simpleObservableProto["can.getName"] = function() {
		...
		return canReflect_1_17_7_canReflect.getName(this.constructor) + "<" + value$$1 + ">";
	};
}
//!steal-remove-end

canReflect_1_17_7_canReflect.assignSymbols(SimpleObservable.prototype, simpleObservableProto);

var canSimpleObservable_2_4_1_canSimpleObservable = canNamespace_1_0_0_canNamespace.SimpleObservable = SimpleObservable;

var peek = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canReflect_1_17_7_canReflect.getValue.bind(canReflect_1_17_7_canReflect));
...
function SettableObservable(fn, context, initialValue) {
	...
	//!steal-remove-start
	if (process.env.NODE_ENV !== 'production') {
		canReflect_1_17_7_canReflect.assignSymbols(this, {
			"can.getName": function() {
				return (
					canReflect_1_17_7_canReflect.getName(this.constructor) +
					"<" +
					canReflect_1_17_7_canReflect.getName(fn) +
					">"
				);
			}
		});
		Object.defineProperty(this.handler, "name", {
			value: canReflect_1_17_7_canReflect.getName(this) + ".handler"
		});
		Object.defineProperty(observe, "name", {
			value: canReflect_1_17_7_canReflect.getName(fn) + "::" + canReflect_1_17_7_canReflect.getName(this.constructor)
		});
	}
	//!steal-remove-end
...
canReflect_1_17_7_canReflect.assignMap(SettableObservable.prototype, {
	...
	handler: function(newVal) {
		...
		if (process.env.NODE_ENV !== 'production') {
			...
			reasonLog = [canReflect_1_17_7_canReflect.getName(this),"set to", newVal, "from", old];
		}
		//!steal-remove-end
	...
	activate: function(){
		canReflect_1_17_7_canReflect.onValue(this.observation, this.handler, "notify");
		this._value = peek(this.observation);
	},
	onUnbound: function() {
		this.bound = false;
		canReflect_1_17_7_canReflect.offValue(this.observation, this.handler, "notify");
	},
	set: function(newVal) {
		var oldVal =  this.lastSetValue.get();

		if (
			canReflect_1_17_7_canReflect.isObservableLike(oldVal) &&
			canReflect_1_17_7_canReflect.isValueLike(oldVal) &&
			!canReflect_1_17_7_canReflect.isObservableLike(newVal)
		) {
			canReflect_1_17_7_canReflect.setValue(oldVal, newVal);
		} else {
			if (newVal !== oldVal) {
	...
	hasDependencies: function() {
		return canReflect_1_17_7_canReflect.valueHasDependencies(this.observation);
	},
	getValueDependencies: function() {
		return canReflect_1_17_7_canReflect.getValueDependencies(this.observation);
	}
});
...
canReflect_1_17_7_canReflect.assignSymbols(SettableObservable.prototype, {
	"can.getValue": SettableObservable.prototype.get,
	"can.setValue": SettableObservable.prototype.set,
	"can.isMapLike": false,
	"can.getPriority": function() {
		return canReflect_1_17_7_canReflect.getPriority(this.observation);
	},
	"can.setPriority": function(newPriority) {
		canReflect_1_17_7_canReflect.setPriority(this.observation, newPriority);
	},
...
var peek$1 = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canReflect_1_17_7_canReflect.getValue.bind(canReflect_1_17_7_canReflect));
	...
	if (!this.inGetter) {
		...
		if (process.env.NODE_ENV !== 'production') {
			queuesArgs = [
				...
				null
				/* jshint laxcomma: true */
				, [canReflect_1_17_7_canReflect.getName(this), "resolved with", newVal]
				/* jshint laxcomma: false */
			];
		}
		//!steal-remove-end
...
canReflect_1_17_7_canReflect.assignSymbols(Globals.prototype, {
...
function makeDelegator (domEvents) {
	...
	canReflect_1_17_7_canReflect.assignSymbols( Delegator.prototype, {
		"can.setKeyValue": function(eventType, handlersBySelector){
			var handler = this.delegated[eventType] = function(ev){
				canReflect_1_17_7_canReflect.each(handlersBySelector, function(handlers, selector){
					var cur = ev.target;
					do {
...
var ensureMeta = function ensureMeta(obj) {
	...
	if (!meta) {
		meta = {};
		canReflect_1_17_7_canReflect.setKeyValue(obj, metaSymbol, meta);
	}
...
function stopListeningArgumentsToKeys(bindTarget, event, handler, queueName) {
	if(arguments.length && canReflect_1_17_7_canReflect.isPrimitive(bindTarget)) {
		queueName = handler;
		handler = event;
		event = bindTarget;
...
var props = {
	...
	dispatch: function(event, args) {
		...
		if (!this.__inSetup) {
			...
			if(process.env.NODE_ENV !== 'production') {
				if (!event.reasonLog) {
					event.reasonLog = [canReflect_1_17_7_canReflect.getName(this), "dispatched", '"' + event.type + '"', "with"].concat(args);
				}
			}
	...
	listenTo: function (bindTarget, event, handler, queueName) {
		...
		if(canReflect_1_17_7_canReflect.isPrimitive(bindTarget)) {
			queueName = handler;
			handler = event;
			event = bindTarget;
			bindTarget = this;
	...
	on: function(eventName, handler, queue) {
		...
		if (listenWithDOM) {
			...
			if ("addEventListener" in this) {
				...
				canReflect_1_17_7_canReflect.onKeyValue(this, eventName, handler, queue);
			} else if (this[onEventSymbol]) {
				this[onEventSymbol](eventName, handler, queue);
			} else {
				if (!eventName && this[onValueSymbol$1]) {
					canReflect_1_17_7_canReflect.onValue(this, handler, queue);
				} else {
	...
	off: function(eventName, handler, queue) {
		...
		if (listenWithDOM) {
			...
			if ("removeEventListener" in this) {
				...
				canReflect_1_17_7_canReflect.offKeyValue(this, eventName, handler, queue);
			} else if (this[offEventSymbol]) {
				this[offEventSymbol](eventName, handler, queue);
			} else {
				if (!eventName && this[offValueSymbol]) {
					canReflect_1_17_7_canReflect.offValue(this, handler, queue);
				} else {
...
legacyMapBindings = function(obj) {
	// add properties
	canReflect_1_17_7_canReflect.assignMap(obj, props);
	// add symbols
	return canReflect_1_17_7_canReflect.assignSymbols(obj, symbols$1);
};
...
canReflect_1_17_7_canReflect.assignMap(legacyMapBindings, props);
canReflect_1_17_7_canReflect.assignSymbols(legacyMapBindings, symbols$1);
...
function ResolverObservable(resolver, context, initialValue) {
	...
	if (process.env.NODE_ENV !== 'production') {
		canReflect_1_17_7_canReflect.assignSymbols(this, {
			"can.getName": function() {
				return (
					canReflect_1_17_7_canReflect.getName(this.constructor) +
					"<" +
					canReflect_1_17_7_canReflect.getName(resolver) +
					">"
				);
			}
		});
		...
		canReflect_1_17_7_canReflect.assignSymbols(this._valueOptions.lastSet, {
			"can.getName": function() {
				return (
					canReflect_1_17_7_canReflect.getName(this.constructor)  +"::lastSet"+
					"<" +
					canReflect_1_17_7_canReflect.getName(resolver) +
					">"
				);
...
canReflect_1_17_7_canReflect.assignMap(ResolverObservable.prototype, {
		...
		if (process.env.NODE_ENV !== 'production') {
			if(!handler.name) {
				Object.defineProperty(handler, "name", {
					value:
						(bindTarget ?
							 canReflect_1_17_7_canReflect.getName(bindTarget) : "")+
	...
	resolve: function(newVal) {
		...
		if(this._value !== this.lastValue) {
			...
			if (process.env.NODE_ENV !== 'production') {
				...
				enqueueMeta = {
					log: [canReflect_1_17_7_canReflect.getName(this.update)],
					reasonLog: [canReflect_1_17_7_canReflect.getName(this), "resolved with", newVal]
				};
				/* jshint laxcomma: false */
			}
			//!steal-remove-end
	...
	getValueDependencies: function getValueDependencies() {
		if (this.bound) {
			...
			if (listenHandlers) {
				canReflect_1_17_7_canReflect.each(listenHandlers.root, function(events, obj) {
					canReflect_1_17_7_canReflect.each(events, function(queues, eventName) {
...
canReflect_1_17_7_canReflect.assignSymbols(ResolverObservable.prototype, {
...
function ensureMeta$1(obj) {
    ...
    if (!meta) {
        meta = {};
        canReflect_1_17_7_canReflect.setKeyValue(obj, metaSymbol$1, meta);
    }
...
function mixinTypeBindings(obj){
    return canReflect_1_17_7_canReflect.assignSymbols(obj,props$1);
}
...
var maybeBoolean = canReflect_1_17_7_canReflect.assignSymbols(toBoolean,{
	"can.new": toBoolean,
...
canReflect_1_17_7_canReflect.assignSymbols(DateStringSet.prototype,{
	"can.serialize": function(){
		return this.setValue;
	}
});

var maybeDate = canReflect_1_17_7_canReflect.assignSymbols(toDate,{
	"can.new": toDate,
	"can.getSchema": function(){
		return {
			type: "Or",
...
var maybeNumber = canReflect_1_17_7_canReflect.assignSymbols(toNumber,{
	"can.new": toNumber,
	"can.getSchema": function(){
		return {
			type: "Or",
...
var maybeString = canReflect_1_17_7_canReflect.assignSymbols(toString,{
	"can.new": toString,
	"can.getSchema": function(){
		return {
			type: "Or",
...
var peek$2 = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canReflect_1_17_7_canReflect.getValue.bind(canReflect_1_17_7_canReflect));
	...
	Object_defineNamedPrototypeProperty = function(obj, prop, definition) {
		if (definition.get) {
			Object.defineProperty(definition.get, "name", {
				value: "get "+canReflect_1_17_7_canReflect.getName(obj) + "."+prop,
				writable: true,
				configurable: true
			});
		}
		if (definition.set) {
			Object.defineProperty(definition.set, "name", {
				value:  "set "+canReflect_1_17_7_canReflect.getName(obj) + "."+prop,
				configurable: true
			});
		}
...
function cleanUpDefinition(prop, definition, shouldWarn, typePrototype){
	...
	if(definition.value !== undefined && ( typeof definition.value !== "function" || definition.value.length === 0) ){
		...
		if(process.env.NODE_ENV !== 'production') {
			if(shouldWarn) {
				dev.warn(
					"can-define: Change the 'value' definition for " + canReflect_1_17_7_canReflect.getName(typePrototype)+"."+prop + " to 'default'."
				);
			}
		}
		//!steal-remove-end
...
var canDefine_2_7_1_canDefine = define = canNamespace_1_0_0_canNamespace.define = function(typePrototype, defines, baseDefine) {
	...
	canReflect_1_17_7_canReflect.eachKey(result.definitions, function(definition, property){
...
define.property = function(typePrototype, prop, definition, dataInitializers, computedInitializers, defaultDefinition) {
	...
	//!steal-remove-start
	if(process.env.NODE_ENV !== 'production') {
		if (type && canReflect_1_17_7_canReflect.isConstructorLike(type) && !isDefineType(type)) {
			dev.warn(
				"can-define: the definition for " + canReflect_1_17_7_canReflect.getName(typePrototype) + "."+
                prop +
	...
	if(process.env.NODE_ENV !== 'production') {
		if (definition.get) {
			Object.defineProperty(definition.get, "name", {
				value: canReflect_1_17_7_canReflect.getName(typePrototype) + "'s " + prop + " getter",
				configurable: true
			});
		}
		if (definition.set) {
			Object.defineProperty(definition.set, "name", {
				value: canReflect_1_17_7_canReflect.getName(typePrototype) + "'s " + prop + " setter",
				configurable: true
			});
		}
		if(isValueResolver(definition)) {
			Object.defineProperty(definition.value, "name", {
				value: canReflect_1_17_7_canReflect.getName(typePrototype) + "'s " + prop + " value",
				configurable: true
			});
		}
	}
	...
	// Determine a function that will provide the initial property value.
		...
		if (process.env.NODE_ENV !== 'production') {
			...
			if (definition.default !== null && typeof definition.default === 'object') {
				dev.warn("can-define: The default value for " + canReflect_1_17_7_canReflect.getName(typePrototype)+"."+prop + " is set to an object. This will be shared by all instances of the DefineMap. Use a function that returns the object instead.");
			}
			// If value is a constructor, give a warning
			if (definition.default && canReflect_1_17_7_canReflect.isConstructorLike(definition.default)) {
				dev.warn("can-define: The \"default\" for " + canReflect_1_17_7_canReflect.getName(typePrototype)+"."+prop + " is set to a constructor. Did you mean \"Default\" instead?");
			}
		}
		//!steal-remove-end
		...
		setter = function() {
			...
			if(process.env.NODE_ENV !== 'production') {
				dev.warn("can-define: Set value for property " +
					canReflect_1_17_7_canReflect.getName(typePrototype)+"."+ prop +
...
make = {
		...
		return function(){
			...
			if(process.env.NODE_ENV !== 'production') {
				Object.defineProperty(computeObj.handler, "name", {
					value: canReflect_1_17_7_canReflect.getName(definition.value).replace('value', 'event emitter')
				});
			}
			//!steal-remove-end
			return computeObj;
	...
	compute: function(prop, get, defaultValueFn) {
		...
		return function() {
			...
			if(process.env.NODE_ENV !== 'production') {
				Object.defineProperty(computeObj.handler, "name", {
					value: canReflect_1_17_7_canReflect.getName(get).replace('getter', 'event emitter')
				});
			}
			//!steal-remove-end
	...
	set: {
		...
		computed: function(prop) {
			return function(val) {
				canReflect_1_17_7_canReflect.setValue( this._computed[prop].compute, val );
			};
		},
			...
			return function(newVal) {
				if (this.__inSetup) {
					...
					if (newVal !== current) {
						...
						//!steal-remove-start
						if(process.env.NODE_ENV !== 'production') {
							dispatched.reasonLog = [ canReflect_1_17_7_canReflect.getName(this) + "'s", prop, "changed to", newVal, "from", current ];
						}
						//!steal-remove-end
				...
				if (setterCalled) {
					...
					if (hasGetter) {
						...
						// we are expecting something
							...
							if(process.env.NODE_ENV !== 'production') {
								asyncTimer = setTimeout(function() {
									dev.warn('can-define: Setter "' + canReflect_1_17_7_canReflect.getName(self)+"."+prop + '" did not return a value or call the setter callback.');
								}, dev.warnTimeout);
							}
							//!steal-remove-end
							canQueues_1_2_1_canQueues.batch.stop();
						...
						// we are expecting something
							...
							if(process.env.NODE_ENV !== 'production') {
								asyncTimer = setTimeout(function() {
									dev.warn('can/map/setter.js: Setter "' + canReflect_1_17_7_canReflect.getName(self)+"."+prop + '" did not return a value or call the setter callback.');
								}, dev.warnTimeout);
							}
							//!steal-remove-end
							canQueues_1_2_1_canQueues.batch.stop();
			...
			if(isDefineType(type)) {
				...
				if(type.canDefineType) {
					...
					return function setter(newValue){
						return set.call(this, canReflect_1_17_7_canReflect.convert(newValue, type));
					};
				}
			}
	...
	read: {
		...
		computed: function(prop) {
			...
			return function() {
				return canReflect_1_17_7_canReflect.getValue( this._computed[prop].compute );
			};
		},
		lastSet: function(prop) {
			return function() {
				...
				if(observable.lastSetValue) {
					return canReflect_1_17_7_canReflect.getValue(observable.lastSetValue);
				}
			};
		}
	},
	...
	get: {
		...
		computed: function(prop) {
			return function(val) {
				...
				if (canObservationRecorder_1_2_0_canObservationRecorder.isRecording()) {
					canObservationRecorder_1_2_0_canObservationRecorder.add(this, prop);
					if (!canReflect_1_17_7_canReflect.isBound(compute)) {
...
makeDefinition = function(prop, def, defaultDefinition, typePrototype) {
	...
	canReflect_1_17_7_canReflect.eachKey(def, function(value, behavior) {
		addBehaviorToDefinition(definition, behavior, value);
	});
	// only add default if it doesn't exist
	canReflect_1_17_7_canReflect.eachKey(defaultDefinition, function(value, prop){
	...
	if(typeof def.type !== 'string') {
		...
		if(!definition.type && !definition.Type) {
            var defaultsCopy = canReflect_1_17_7_canReflect.assignMap({},defaultDefinition);
            definition = canReflect_1_17_7_canReflect.assignMap(defaultsCopy, definition);
		}

		if( canReflect_1_17_7_canReflect.size(definition) === 0 ) {
...
getDefinitionOrMethod = function(prop, value, defaultDefinition, typePrototype){
    ...
    // copies a `Type`'s methods over
		...
		if(canReflect_1_17_7_canReflect.isConstructorLike(value)) {
			definition = {Type: value};
		}
		// or leaves as a function
	} else if( Array.isArray(value) ) {
		definition = {Type: value};
	} else if( canReflect_1_17_7_canReflect.isPlainObject(value) ){
		definition = value;
	}
...
getDefinitionsAndMethods = function(defines, baseDefines, typePrototype) {
	...
	eachPropertyDescriptor(defines, function( prop, propertyDescriptor ) {
		...
		if(prop === "constructor") {
			...
			if(result && typeof result === "object" && canReflect_1_17_7_canReflect.size(result) > 0) {
				...
				//!steal-remove-start
					...
					if(process.env.NODE_ENV !== 'production') {
                    	// Ex: {prop: 0}
						dev.error(canReflect_1_17_7_canReflect.getName(typePrototype)+"."+prop + " does not match a supported propDefinition. See: https://canjs.com/doc/can-define.types.propDefinition.html");
					}
				}
				//!steal-remove-end
			}
...
function setupComputed(instance, eventName) {
	...
	if (computedBinding && computedBinding.compute) {
		if (!computedBinding.count) {
			...
			canReflect_1_17_7_canReflect.onValue(computedBinding.compute, computedBinding.handler, "notify");
...
function teardownComputed(instance, eventName){
	...
	if (computedBinding) {
		if (computedBinding.count === 1) {
			...
			canReflect_1_17_7_canReflect.offValue(computedBinding.compute, computedBinding.handler,"notify");
		} else {
			computedBinding.count--;
		}
	}
...
canReflect_1_17_7_canReflect.assignSymbols(eventsProto,{
...
define.setup = function(props, sealed) {
	...
	var map = this;
	canReflect_1_17_7_canReflect.eachKey(props, function(value, prop){
	...
	if(canReflect_1_17_7_canReflect.size(instanceDefinitions) > 0) {
...
function isObservableValue(obj){
	return canReflect_1_17_7_canReflect.isValueLike(obj) && canReflect_1_17_7_canReflect.isObservableLike(obj);
}
...
define.types = {
	...
	'observable': function(newVal) {
			...
			else if(canReflect_1_17_7_canReflect.isPlainObject(newVal) &&  define.DefineMap) {
	...
	'stringOrObservable': function(newVal) {
		...
		else if(canReflect_1_17_7_canReflect.isPlainObject(newVal)) {
			return new define.DefaultMap(newVal);
		}
		else {
			return canReflect_1_17_7_canReflect.convert( newVal, define.types.string);
		}
	},
	/**
	...
	'compute': {
		set: function(newValue, setVal, setErr, oldValue) {
			...
			if (isObservableValue(oldValue)) {
				canReflect_1_17_7_canReflect.setValue(oldValue,newValue);
				return oldValue;
			}
			return newValue;
		},
		get: function(value) {
			return isObservableValue(value) ? canReflect_1_17_7_canReflect.getValue(value) : value;
		}
	}
};
...
// Ensure the "obj" passed as an argument has an object on @@can.meta
var canDefine_2_7_1_ensureMeta = function ensureMeta(obj) {
	var metaSymbol = canSymbol_1_6_1_canSymbol.for("can.meta");
	var meta = obj[metaSymbol];
...
var defineHelpers = {
	...
	defineExpando: canDefine_2_7_1_canDefine.expando,
	reflectSerialize: function(unwrapped){
		...
		this.forEach(function(val, name){
			...
			if(propDef && typeof propDef.serialize === "function") {
				...
				val = canReflect_1_17_7_canReflect.serialize(val);
			}
			if(val !== undefined) {
				unwrapped[name] = val;
			}
	...
	reflectUnwrap: function(unwrapped){
		this.forEach(function(value, key){
			if(value !== undefined) {
				unwrapped[key] = canReflect_1_17_7_canReflect.unwrap(value);
			}
		});
		return unwrapped;
	},
	log: function(key) {
		...
		var meta = canDefine_2_7_1_ensureMeta(instance);
		...
		meta._log = function(event, data) {
			...
			if (type === "add" || type === "remove") {
				dev.log(
					canReflect_1_17_7_canReflect.getName(instance),
...
function assign(source) {
	canQueues_1_2_1_canQueues.batch.start();
	canReflect_1_17_7_canReflect.assignMap(this, source || {});
	canQueues_1_2_1_canQueues.batch.stop();
}
function update(source) {
	canQueues_1_2_1_canQueues.batch.start();
	canReflect_1_17_7_canReflect.updateMap(this, source || {});
	canQueues_1_2_1_canQueues.batch.stop();
}
function assignDeep(source){
	canQueues_1_2_1_canQueues.batch.start();
	// TODO: we should probably just throw an error instead of cleaning
	canReflect_1_17_7_canReflect.assignDeepMap(this, source || {});
	canQueues_1_2_1_canQueues.batch.stop();
}
function updateDeep(source){
	canQueues_1_2_1_canQueues.batch.start();
	// TODO: we should probably just throw an error instead of cleaning
	canReflect_1_17_7_canReflect.updateDeepMap(this, source || {});
	canQueues_1_2_1_canQueues.batch.stop();
}
...
function getSchema() {
	...
	return canDefine_2_7_1_canDefine.updateSchemaKeys(schema, definitions);
}

var sealedSetup = function(props){
	canDefine_2_7_1_canDefine.setup.call(
		this,
		props || {},
...
var DefineMap = canConstruct_3_5_3_canConstruct.extend("DefineMap",{
	setup: function(base){
		...
		if(DefineMap) {
			...
			var result = canDefine_2_7_1_canDefine(prototype, prototype, base.prototype._define);
				canDefine_2_7_1_canDefine.makeDefineInstanceKey(this, result);

			type$1(this);
			for(key in DefineMap.prototype) {
				canDefine_2_7_1_canDefine.defineConfigurableAndNotEnumerable(prototype, key, prototype[key]);
			}
			// If someone provided their own setup, we call that.
			if(prototype.setup === DefineMap.prototype.setup) {
				canDefine_2_7_1_canDefine.defineConfigurableAndNotEnumerable(prototype, "setup", sealedSetup);
			}
		...
		canDefine_2_7_1_canDefine.defineConfigurableAndNotEnumerable(prototype, "constructor", this);
	...
	get: function(prop){
		if(prop) {
			...
			return canReflect_1_17_7_canReflect.unwrap(this, Map);
		}
	},
	...
	serialize: function () {
		return canReflect_1_17_7_canReflect.serialize(this, Map);
	},
	deleteKey: defineHelpers_1.deleteKey,
	forEach: (function(){

		var forEach = function(list, cb, thisarg){
			return canReflect_1_17_7_canReflect.eachKey(list, cb, thisarg);
		},
	...
	"*": {
		type: canDefine_2_7_1_canDefine.types.observable
	}
});
...
var defineMapProto = {
	...
	"can.getOwnKeys": function() {
		var keys = canReflect_1_17_7_canReflect.getOwnEnumerableKeys(this);
		if(this._computed) {
			var computedKeys = canReflect_1_17_7_canReflect.getOwnKeys(this._computed);
...
if(process.env.NODE_ENV !== 'production') {
	defineMapProto["can.getName"] = function() {
		return canReflect_1_17_7_canReflect.getName(this.constructor) + "{}";
	};
}
//!steal-remove-end

canReflect_1_17_7_canReflect.assignSymbols(DefineMap.prototype, defineMapProto);

canReflect_1_17_7_canReflect.setKeyValue(DefineMap.prototype, canSymbol_1_6_1_canSymbol.iterator, function() {
	return new canDefine_2_7_1_canDefine.Iterator(this);
});

// Add necessary event methods to this object.
for(var prop in canDefine_2_7_1_canDefine.eventsProto) {
	DefineMap[prop] = canDefine_2_7_1_canDefine.eventsProto[prop];
	Object.defineProperty(DefineMap.prototype, prop, {
		enumerable:false,
		value: canDefine_2_7_1_canDefine.eventsProto[prop],
		writable: true
	});
}
...
var eventsProtoSymbols = ("getOwnPropertySymbols" in Object) ?
  Object.getOwnPropertySymbols(canDefine_2_7_1_canDefine.eventsProto) :
...
eventsProtoSymbols.forEach(function(sym) {
  Object.defineProperty(DefineMap.prototype, sym, {
  	configurable: true,
    enumerable:false,
    value: canDefine_2_7_1_canDefine.eventsProto[sym],
    writable: true
  });
});
...
if(process.env.NODE_ENV !== 'production') {
	...
	canDefine_2_7_1_canDefine.defineConfigurableAndNotEnumerable(DefineMap.prototype, "log", defineHelpers_1.log);
}
//!steal-remove-end

// tells `can-define` to use this
canDefine_2_7_1_canDefine.DefineMap = DefineMap;
...
function makeIdentityFromMapSchema(typeSchema) {
    if(typeSchema.identity && typeSchema.identity.length) {
        return function identityCheck(a, b) {
            var aId = canReflect_1_17_7_canReflect.getIdentity(a, typeSchema),
                bId = canReflect_1_17_7_canReflect.getIdentity(b, typeSchema);
            return aId === bId;
        };
    } else {
...
function makeIdentityFromListSchema(listSchema) {
    return listSchema.values != null ?
        makeIdentityFromMapSchema( canReflect_1_17_7_canReflect.getSchema(listSchema.values) ) :
        defaultIdentity;
}

function makeIdentity(oldList, oldListLength) {
    var listSchema = canReflect_1_17_7_canReflect.getSchema(oldList),
        typeSchema;
    if(listSchema != null) {
        if(listSchema.values != null) {
            typeSchema = canReflect_1_17_7_canReflect.getSchema(listSchema.values);
        } else {
            return defaultIdentity;
        }
    }
    if(typeSchema == null && oldListLength > 0) {
        typeSchema = canReflect_1_17_7_canReflect.getSchema( canReflect_1_17_7_canReflect.getKeyValue(oldList, 0) );
    }
    if(typeSchema) {
...
var list = function(oldList, newList, schemaOrIdentity){
    var oldIndex = 0,
		newIndex =  0,
		oldLength = canReflect_1_17_7_canReflect.size( oldList ),
		newLength = canReflect_1_17_7_canReflect.size( newList ),
		patches = [];
...
var make$1 = canDefine_2_7_1_canDefine.make;
...
var onKeyValue = canDefine_2_7_1_canDefine.eventsProto[canSymbol_1_6_1_canSymbol.for("can.onKeyValue")];
var offKeyValue = canDefine_2_7_1_canDefine.eventsProto[canSymbol_1_6_1_canSymbol.for("can.offKeyValue")];
...
function getSchema$1() {
	...
	schema = canDefine_2_7_1_canDefine.updateSchemaKeys(schema, definitions);
	if(schema.keys["#"]) {
...
var DefineList = canConstruct_3_5_3_canConstruct.extend("DefineList",
	...
	/** @prototype */
	{
		...
		setup: function(items) {
			...
			canDefine_2_7_1_canDefine.setup.call(this, {}, false);
			...
			if (items) {
				this.splice.apply(this, [ 0, 0 ].concat(canReflect_1_17_7_canReflect.toArray(items)));
			}
		},
		__type: canDefine_2_7_1_canDefine.types.observable,
		_triggerChange: function(attr, how, newVal, oldVal) {
			...
			if ( !isNaN(index)) {
				...
				if (how === 'add') {
					...
					//!steal-remove-start
					if(process.env.NODE_ENV !== 'production') {
						dispatched.reasonLog = [ canReflect_1_17_7_canReflect.getName(this), "added", newVal, "at", index ];
					}
					//!steal-remove-end
					...
					//!steal-remove-start
					if(process.env.NODE_ENV !== 'production') {
						dispatched.reasonLog = [ canReflect_1_17_7_canReflect.getName(this), "remove", oldVal, "at", index ];
					}
					//!steal-remove-end
		...
		set: function(prop, value) {
			...
			// otherwise we are setting multiple
				...
				if (canReflect_1_17_7_canReflect.isListLike(prop)) {
					if (value) {
						this.replace(prop);
					} else {
						canReflect_1_17_7_canReflect.assignList(this, prop);
					}
				} else {
					canReflect_1_17_7_canReflect.assignMap(this, prop);
				}
			}
			return this;
		},
		...
		update: function(prop) {
			if (canReflect_1_17_7_canReflect.isListLike(prop)) {
				canReflect_1_17_7_canReflect.updateList(this, prop);
			} else {
				canReflect_1_17_7_canReflect.updateMap(this, prop);
			}
			return this;
		},
		assignDeep: function(prop) {
			if (canReflect_1_17_7_canReflect.isListLike(prop)) {
				canReflect_1_17_7_canReflect.assignDeepList(this, prop);
			} else {
				canReflect_1_17_7_canReflect.assignDeepMap(this, prop);
			}
			return this;
		},
		updateDeep: function(prop) {
			if (canReflect_1_17_7_canReflect.isListLike(prop)) {
				canReflect_1_17_7_canReflect.updateDeepList(this, prop);
			} else {
				canReflect_1_17_7_canReflect.updateDeepMap(this, prop);
			}
			return this;
		},
		_items: function() {
		...
		splice: function(index, howMany) {
			var args = canReflect_1_17_7_canReflect.toArray(arguments),
				added = [],
				i, len, listIndex,
...
for(var prop$1 in canDefine_2_7_1_canDefine.eventsProto) {
	Object.defineProperty(DefineList.prototype, prop$1, {
		enumerable:false,
		value: canDefine_2_7_1_canDefine.eventsProto[prop$1],
		writable: true
	});
}
...
var getArgs = function(args) {
	return args[0] && Array.isArray(args[0]) ?
		args[0] :
		canReflect_1_17_7_canReflect.toArray(args);
};
// Create `push`, `pop`, `shift`, and `unshift`
canReflect_1_17_7_canReflect.eachKey({
	push: "length",
	unshift: 0
},
	// Adds a method
...
canAssign_1_3_1_canAssign(DefineList.prototype, {
	...
	concat: function() {
		...
		canReflect_1_17_7_canReflect.eachIndex(arguments, function(arg) {
			if (canReflect_1_17_7_canReflect.isListLike(arg)) {
				// If it is list-like we want convert to a JS array then
				// pass each item of the array to this.__type
				var arr = Array.isArray(arg) ? arg : canReflect_1_17_7_canReflect.toArray(arg);
		...
		return new this.constructor(Array.prototype.concat.apply(canReflect_1_17_7_canReflect.toArray(this), args));
	},
...
// Add necessary event methods to this object.
for (var prop$1 in canDefine_2_7_1_canDefine.eventsProto) {
	DefineList[prop$1] = canDefine_2_7_1_canDefine.eventsProto[prop$1];
	Object.defineProperty(DefineList.prototype, prop$1, {
		enumerable: false,
		value: canDefine_2_7_1_canDefine.eventsProto[prop$1],
		writable: true
...
var defineListProto = {
		...
		if (isNaN(key)) {
			...
			if(process.env.NODE_ENV !== 'production') {
				Object.defineProperty(translationHandler, "name", {
					value: "translationHandler(" + key + ")::" + canReflect_1_17_7_canReflect.getName(this) + ".onKeyValue('length'," + canReflect_1_17_7_canReflect.getName(handler) + ")",
				});
			}
			//!steal-remove-end
	...
	"can.assignDeep": function(source){
		canQueues_1_2_1_canQueues.batch.start();
		canReflect_1_17_7_canReflect.assignList(this, source);
		canQueues_1_2_1_canQueues.batch.stop();
	},
...
canReflect_1_17_7_canReflect.assignSymbols(DefineList.prototype, defineListProto);

canReflect_1_17_7_canReflect.setKeyValue(DefineList.prototype, canSymbol_1_6_1_canSymbol.iterator, function() {
	var index = -1;
...
canDefine_2_7_1_canDefine.DefineList = DefineList;
...
function setupPromise(value) {
	...
	canReflect_1_17_7_canReflect.assignSymbols(proto, {
...
var peek$3 = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canReflect_1_17_7_canReflect.getKeyValue.bind(canReflect_1_17_7_canReflect));
var observeReader;
...
if (process.env.NODE_ENV !== 'production') {
	bindName = function(source){
		...
		Object.defineProperty(fn, "name", {
			value: canReflect_1_17_7_canReflect.getName(source) + "."+canReflect_1_17_7_canReflect.getName(this)
		});
		return fn;
	};
}
...
var objHasKeyAtIndex = function(obj, reads, index) {
	return !!(
		reads && reads.length &&
		canReflect_1_17_7_canReflect.hasKey(obj, reads[index].key)
	);
};
	...
	valueReaders: [
		{
			...
			test: function(value){
				return value && canReflect_1_17_7_canReflect.isFunctionLike(value) && !canReflect_1_17_7_canReflect.isConstructorLike(value);
			},
			read: function(value, i, reads, options, state, prev){
				if(options.callMethodsOnObservables && canReflect_1_17_7_canReflect.isObservableLike(prev) && canReflect_1_17_7_canReflect.isMapLike(prev)) {
		...
		},
		{
			...
			read: function(value, i, reads, options){
				...
				return canReflect_1_17_7_canReflect.getValue(value);
			},
	...
	propertyReaders: [
		{
			...
			test: function(value){
				...
				//  special reflections.
				if(canReflect_1_17_7_canReflect.isPromise(value) || typeof value === "object" && value && typeof value.then === "function") {
					canReflectPromise_2_2_0_canReflectPromise(value);
				}

				return canReflect_1_17_7_canReflect.isObservableLike(value) && canReflect_1_17_7_canReflect.isMapLike(value);
			},
			read: function(value, prop){
				var res = canReflect_1_17_7_canReflect.getKeyValue(value, prop.key);
				if(res !== undefined) {
					return res;
				} else {
			...
			write: canReflect_1_17_7_canReflect.setKeyValue
		},
		...
		// read a normal object
		{
			...
			write: function(base, prop, newVal){
				...
				if(newVal != null && typeof newVal === "object" && canReflect_1_17_7_canReflect.isMapLike(propValue) ) {
					dev.warn("can-stache-key: Merging data into \"" + prop + "\" because its parent is non-observable");
					canReflect_1_17_7_canReflect.update(propValue, newVal);
				} else if(propValue != null && propValue[setValueSymbol$1] !== undefined){
					canReflect_1_17_7_canReflect.setValue(propValue, newVal);
				} else {
					base[prop] = newVal;
				}
			}
...
function get(obj, name) {
    ...
    for (i = 0; i < length && canKey_1_2_0_utils.isContainer(current) && current !== null; i++) {
        container = current;
        current = canReflect_1_17_7_canReflect.getKeyValue( container, parts[i] );
    }
...
var eliminate$1 = canDomMutate_1_3_5_Util.eliminate;
var subscription$1 = canDomMutate_1_3_5_Util.subscription;
var isDocumentElement$1 = canDomMutate_1_3_5_Util.isDocumentElement;
var getAllNodes$1 = canDomMutate_1_3_5_Util.getAllNodes;
...
function handleTreeMutations(mutations) {
	...
	for (var m = 0; m < mutationCount; m++) {
		...
		for (var a = 0; a < addedCount; a++) {
			canDomMutate_1_3_5_Util.addToSet( getAllNodes$1(mutation.addedNodes[a]), added);
		}

		var removedCount = mutation.removedNodes.length;
		for (var r = 0; r < removedCount; r++) {
			canDomMutate_1_3_5_Util.addToSet( getAllNodes$1(mutation.removedNodes[r]), removed);
		}
	}

	dispatchRemoval( toMutationEvents( canReflect_1_17_7_canReflect.toArray(removed) ) );
	dispatchInsertion( toMutationEvents( canReflect_1_17_7_canReflect.toArray(added) ) );
}
...
domMutate = {
	...
	*/
	dispatchNodeInsertion: function (node, callback) {
		var nodes = new Set();
		canDomMutate_1_3_5_Util.addToSet( getAllNodes$1(node), nodes);
		var events = toMutationEvents( canReflect_1_17_7_canReflect.toArray(nodes) );
...
var canDomMutate_1_3_5_canDomMutate = canNamespace_1_0_0_canNamespace.domMutate = domMutate;
	 ...
	 */
	{
      ...
      if(process.env.NODE_ENV !== 'production') {
	      Object.defineProperty(controlMethod, "name", {
	      	value: canReflect_1_17_7_canReflect.getName(this) + "["+name+"]",
	      });
	     }
      //!steal-remove-end
      return controlMethod;
			...
			if (options || !paramReplacer.test(methodName)) {
                var controlActionData = function() {
					...
					var name = methodName.replace(paramReplacer, function(matched, key) {
						...
						if (!parent || !(canReflect_1_17_7_canReflect.isObservableLike(parent) && canReflect_1_17_7_canReflect.isMapLike(parent)) && !value) {
                            unableToBind = true;
							return null;
						}
        ...
        if(process.env.NODE_ENV !== 'production') {
		    	Object.defineProperty(controlActionData, "name", {
		      	value: canReflect_1_17_7_canReflect.getName(controlInstance || this.prototype) + "["+methodName+"].actionData",
		      });
	      }
        //!steal-remove-end
          ...
          if(process.env.NODE_ENV !== 'production') {
          	Object.defineProperty(handler, "name", {
            	value: canReflect_1_17_7_canReflect.getName(controlInstance) + "["+methodName+"].handler",
            });
          }
					//!steal-remove-end


					canReflect_1_17_7_canReflect.onValue(readyCompute, handler, "mutate");
          //!steal-remove-start
          if(process.env.NODE_ENV !== 'production') {
	          if(unableToBind) {
		...
		setup: function (element, options) {
			...
			if (canReflect_1_17_7_canReflect.isObservableLike(options) && canReflect_1_17_7_canReflect.isMapLike(options)) {
		...
		on: function (el, selector, eventName, func) {
			if (!el) {
				...
				var removalDisposal = canDomMutate_1_3_5_canDomMutate.onNodeRemoval(element, function () {
		...
		off: function () {
			...
			if( bindings ) {
				...
				canReflect_1_17_7_canReflect.eachKey(bindings.control || {}, function (value) {
					value(el);
				});
				canReflect_1_17_7_canReflect.eachKey(bindings.readyComputes || {}, function(value) {
					canReflect_1_17_7_canReflect.offValue(value.compute, value.handler, "mutate");
				});
			}
			// Adds bindings.
...
var ComponentControl = canControl_4_4_1_canControl.extend({
	...
	// rebinds all templated event handlers.
	{
		...
		off: function() {
			...
			if (this._bindings) {
				canReflect_1_17_7_canReflect.eachKey(this._bindings.readyComputes || {}, function(value) {
					canReflect_1_17_7_canReflect.offValue(value.compute, value.handler);
				});
			}
...
var addMutatedBy = function(mutatedByMap) {
	return function addMutatedBy(mutated, key, mutator) {
		...
		if (mutator.valueDependencies) {
			canReflect_1_17_7_canReflect.addValues(
		...
		if (mutator.keyDependencies) {
			canReflect_1_17_7_canReflect.each(mutator.keyDependencies, function(keysSet, obj) {
				...
				canReflect_1_17_7_canReflect.addValues(entry, keysSet);
			});
		}
	};
};
...
var deleteMutatedBy = function(mutatedByMap) {
	return function deleteMutatedBy(mutated, key, mutator) {
		...
		if (mutator.valueDependencies) {
			canReflect_1_17_7_canReflect.removeValues(
				dependencyRecord.valueDependencies,
				mutator.valueDependencies
			);
		}
		...
		if (mutator.keyDependencies) {
			canReflect_1_17_7_canReflect.each(mutator.keyDependencies, function(keysSet, obj) {
				...
				if (entry) {
					canReflect_1_17_7_canReflect.removeValues(entry, keysSet);
					if (!entry.size) {
...
var getKeyDependencies = function getKeyDependencies(obj, key) {
	if (isFunction(obj[getKeyDependenciesSymbol])) {
		return canReflect_1_17_7_canReflect.getKeyDependencies(obj, key);
	}
};

var getValueDependencies = function getValueDependencies(obj) {
	if (isFunction(obj[getValueDependenciesSymbol$1])) {
		return canReflect_1_17_7_canReflect.getValueDependencies(obj);
	}
};
...
var getWhatIChange = function getWhatIChange(obj, key) {
	if (isFunction(obj[getWhatIChangeSymbol])) {
		...
		return gotKey ?
			canReflect_1_17_7_canReflect.getWhatIChange(obj, key) :
			canReflect_1_17_7_canReflect.getWhatIChange(obj);
	}
};
...
function defaultSetValue(newValue, observable) {
	canReflect_1_17_7_canReflect.setValue(observable, newValue);
}
...
function turnOffListeningAndUpdate(listenToObservable, updateObservable, updateFunction, queue) {
	if (listenToObservable[onValueSymbol$2]) {
		canReflect_1_17_7_canReflect.offValue(listenToObservable, updateFunction, queue);
...
function turnOnListeningAndUpdate(listenToObservable, updateObservable, updateFunction, queue) {
	if (listenToObservable[onValueSymbol$2]) {
		canReflect_1_17_7_canReflect.onValue(listenToObservable, updateFunction, queue);
...
function Bind(options) {
	...
	if (options.priority !== undefined) {
		canReflect_1_17_7_canReflect.setPriority(options.child, options.priority);
		canReflect_1_17_7_canReflect.setPriority(options.parent, options.priority);
	}
	...
	if(process.env.NODE_ENV !== 'production') {
		...
		Object.defineProperty(this._updateChild, "name", {
			value: options.updateChildName ? options.updateChildName : "update "+canReflect_1_17_7_canReflect.getName(options.child),
			configurable: true
		});

		Object.defineProperty(this._updateParent, "name", {
			value: options.updateParentName ? options.updateParentName : "update "+canReflect_1_17_7_canReflect.getName(options.parent),
			configurable: true
		});
	}
	//!steal-remove-end
...
Object.defineProperty(Bind.prototype, "parentValue", {
	get: function() {
		return canReflect_1_17_7_canReflect.getValue(this._options.parent);
	}
});
...
canAssign_1_3_1_canAssign(Bind.prototype, {
	...
	start: function() {
		...
		if (this._childToParent === true && this._parentToChild === true) {
			// Two-way binding
			parentValue = canReflect_1_17_7_canReflect.getValue(options.parent);
			if (parentValue === undefined) {
				childValue = canReflect_1_17_7_canReflect.getValue(options.child);
...
function updateValue(args) {
	...
	if ((semaphore.value + args.partnerSemaphore.value) <= args.allowedUpdates) {
		...
		if (args.sticky) {
			var observableValue = canReflect_1_17_7_canReflect.getValue(args.observable);
			if (observableValue !== canReflect_1_17_7_canReflect.getValue(args.partner)) {
		...
		//!steal-remove-start
		if(process.env.NODE_ENV !== 'production'){
			var currentValue = canReflect_1_17_7_canReflect.getValue(args.observable);
			if (currentValue !== args.newValue) {
				var warningParts = [
					"can-bind: attempting to update " + args.debugObservableName + " " + canReflect_1_17_7_canReflect.getName(args.observable) + " to new value: %o",
				...
				if(console.groupCollapsed) {
					...
					this._debugSemaphores.forEach(function(semaphoreMutation){
						if(semaphoreMutation.action === "increment") {
							console.groupCollapsed(semaphoreMutation.type+" "+canReflect_1_17_7_canReflect.getName(semaphoreMutation.observable)+" set.");
							...
							console.log(canReflect_1_17_7_canReflect.getName(semaphoreMutation.observable),semaphoreMutation.observable,"set to ", semaphoreMutation.newValue);
							console.groupEnd();
						}
					});
					console.groupCollapsed(args.debugObservableName+" "+canReflect_1_17_7_canReflect.getName(args.observable)+" NOT set.");
					...
					console.log(args.debugObservableName+" semaphore ("+semaphore.value+
					 ...
					 args.allowedUpdates+")");
					console.log("Prevented from setting "+canReflect_1_17_7_canReflect.getName(args.observable), args.observable, "to", args.newValue);
					console.groupEnd();
				}
			}
		}
...
var canBind_1_1_1_canBind = canNamespace_1_0_0_canNamespace.Bind = Bind;

var canAttributeEncoder_1_1_1_canAttributeEncoder = createCommonjsModule(function (module) {
...
var callAttrStart = function(state, curIndex, handler, rest, lineNo){
	var attrName = rest.substring(typeof state.nameStart === "number" ? state.nameStart : curIndex, curIndex),
		newAttrName = canAttributeEncoder_1_1_1_canAttributeEncoder.encode(attrName);
...
var isInDocument$1 = canDomMutate_1_3_5_Util.isInDocument;
var getParents$1 = canDomMutate_1_3_5_Util.getParents;

var synthetic = {
	dispatchNodeInsertion: function (container, node) {
		if (isInDocument$1(node)) {
			canDomMutate_1_3_5_canDomMutate.dispatchNodeInsertion(node);
		}
	},
	dispatchNodeRemoval: function (container, node) {
		if (isInDocument$1(container) && !isInDocument$1(node)) {
			canDomMutate_1_3_5_canDomMutate.dispatchNodeRemoval(node);
		}
	}
};
...
var compat = {
	...
	setAttribute: function (name, value) {
		...
		if (oldAttributeValue !== newAttributeValue) {
			canDomMutate_1_3_5_canDomMutate.dispatchNodeAttributeChange(this, name, oldAttributeValue);
		}
		return result;
	},
...
var canDomMutate_1_3_5_node = canNamespace_1_0_0_canNamespace.domMutateNode = canDomMutate_1_3_5_canDomMutate.node = mutate;
...
var nodeLists = {
	...
	*/
	...
	after: function (oldElements, newFrag) {
		...
		if (last.nextSibling) {
			canDomMutate_1_3_5_node.insertBefore.call(last.parentNode, newFrag, last.nextSibling);
		} else {
			canDomMutate_1_3_5_node.appendChild.call(last.parentNode, newFrag );
		}
	},
	/**
	...
	replace: function (oldElements, newFrag) {
		...
		if(oldElements.length === 1) {
			canDomMutate_1_3_5_node.replaceChild.call(parentNode, newFrag, oldElements[0]);
		} else {
	...
	remove: function(elementsToBeRemoved){
		...
		for (var i = 0; i < elementsToBeRemoved.length; i++) {
			canDomMutate_1_3_5_node.removeChild.call(parent, elementsToBeRemoved[i]);
		}
	},
	nodeMap: nodeMap
};
...
var makeFrag = function(item, doc) {
	...
	if (!item || typeof item === "string") {
		...
		return frag;
	} else if (canReflect_1_17_7_canReflect.isListLike(item)) {
		frag = document.createDocumentFragment();
		canReflect_1_17_7_canReflect.eachIndex(item, function(item) {
...
var attrs = function(attrMap) {
	var map = canReflect_1_17_7_canReflect.getKeyValue(attrMap, callbackMapSymbol) || attrMap;
	...
	canReflect_1_17_7_canReflect.eachKey(map, function(callback, exp){
		attr(exp, callback);
	});
};
...
var callbacks = {
	...
	tagHandler: function(el, tagName, tagData){
		...
		if (res && tagData.subtemplate) {
			...
			canDomMutate_1_3_5_node.appendChild.call(el, frag);
		}
	}
};
		...
		if(node.attributes) {
			...
			for (var i = 0; i < attributes.length; i++) {
				...
				if (attribute && attribute.specified) {
					canDomMutate_1_3_5_node.setAttribute.call(copy, attribute.nodeName || attribute.name, attribute.nodeValue || attribute.value);
				}
			}
		}
			...
			if(node.attrs) {
				for(var attrName in node.attrs) {
					...
					if(typeof value === "function"){
						...
						canDomMutate_1_3_5_node.setAttribute.call(el, attrName, value);
					}
				}
			}
			if(node.attributes) {
		...
		if(keepsTextNodes) {
			...
			getCallback().callbacks.push({
				callback: function(){
					...
					canDomMutate_1_3_5_node.replaceChild.call(this.parentNode, el, this);
...
canNamespace_1_0_0_canNamespace.view = canNamespace_1_0_0_canNamespace.view || {};
var canViewTarget_4_1_1_canViewTarget = canNamespace_1_0_0_canNamespace.view.target = makeTarget;
...
var SimpleMap = canConstruct_3_5_3_canConstruct.extend("SimpleMap",
	{
		...
		attr: function(prop, value) {
			...
			if(arguments.length === 0 ) {
				canObservationRecorder_1_2_0_canObservationRecorder.add(this,"can.keys");
				var data = {};
				canReflect_1_17_7_canReflect.eachKey(this._data, function(value, prop){
					canObservationRecorder_1_2_0_canObservationRecorder.add(this, prop);
					data[prop] = value;
				}, this);
				return data;
				...
				if(old !== value) {
					...
					if (process.env.NODE_ENV !== 'production') {
						dispatched = {
							keyChanged: !had ? prop : undefined,
							type: prop,
							reasonLog: [ canReflect_1_17_7_canReflect.getName(this) + "'s", prop, "changed to", value, "from", old ],
						};
					}
					//!steal-remove-end
			...
			// 1 argument
				...
				canQueues_1_2_1_canQueues.batch.start();
				canReflect_1_17_7_canReflect.eachKey(prop, function(value, key) {
					self.attr(key, value);
				});
				canQueues_1_2_1_canQueues.batch.stop();
			}
		...
		if( this._data.hasOwnProperty(prop) ) {
			...
			if (process.env.NODE_ENV !== 'production') {
				dispatched = {
					keyChanged: prop,
					type: prop,
					reasonLog: [ canReflect_1_17_7_canReflect.getName(this) + "'s", prop, "deleted", old ]
				};
			}
			//!steal-remove-end
...
//!steal-remove-end
canReflect_1_17_7_canReflect.assignSymbols(SimpleMap.prototype,simpleMapProto);
...
var canViewScope_4_11_1_templateContext = TemplateContext;

var Compute = function(newVal){
	if(arguments.length) {
		return canReflect_1_17_7_canReflect.setValue(this, newVal);
	} else {
		return canReflect_1_17_7_canReflect.getValue(this);
	}
};

var canViewScope_4_11_1_makeComputeLike = function(observable) {
    var compute = Compute.bind(observable);

	//!steal-remove-start
	if (process.env.NODE_ENV !== 'production') {
		Object.defineProperty(compute, "name", {
			value: "Compute<"+canReflect_1_17_7_canReflect.getName(observable) + ">",
		});
	}
	//!steal-remove-end
    ...
    canReflect_1_17_7_canReflect.assignSymbols(compute, {
        "can.getValue": function(){
            return canReflect_1_17_7_canReflect.getValue(observable);
        },
        "can.setValue": function(newVal){
            return canReflect_1_17_7_canReflect.setValue(observable, newVal);
        },
        "can.onValue": function(handler, queue){
            return canReflect_1_17_7_canReflect.onValue(observable, handler, queue);
        },
        "can.offValue": function(handler, queue){
            return canReflect_1_17_7_canReflect.offValue(observable, handler, queue);
        },
        "can.valueHasDependencies": function(){
            return canReflect_1_17_7_canReflect.valueHasDependencies(observable);
        },
        "can.getPriority": function(){
    		return canReflect_1_17_7_canReflect.getPriority( observable );
    	},
    	"can.setPriority": function(newPriority){
    		canReflect_1_17_7_canReflect.setPriority( observable, newPriority );
    	},
		"can.isValueLike": true,
...
var peekValue = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canReflect_1_17_7_canReflect.getValue.bind(canReflect_1_17_7_canReflect));
var peekGet = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canObservation_4_1_1_canObservation.prototype.get);
...
var getFastPathRoot = canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(computeData){
	if( computeData.reads &&
		...
		if( root && root[canSymbol_1_6_1_canSymbol.for("can.getValue")] ) {
			root = canReflect_1_17_7_canReflect.getValue(root);
		}
		// on a map
		return root && canReflect_1_17_7_canReflect.isObservableLike(root) && canReflect_1_17_7_canReflect.isMapLike(root) &&
...
var ScopeKeyData = function(scope, key, options){
	...
	if (process.env.NODE_ENV !== 'production') {
		Object.defineProperty(this.read, "name", {
			value: canReflect_1_17_7_canReflect.getName(this) + ".read",
		});
		Object.defineProperty(this.dispatch, "name", {
			value: canReflect_1_17_7_canReflect.getName(this) + ".dispatch",
		});
	}
	//!steal-remove-end
...
canAssign_1_3_1_canAssign(ScopeKeyData.prototype, {
	...
	onBound: function onBound(){
		this.bound = true;
		canReflect_1_17_7_canReflect.onValue(this.observation, this.dispatch, "notify");
	...
	onUnbound: function onUnbound() {
		this.bound = false;
		canReflect_1_17_7_canReflect.offValue(this.observation, this.dispatch, "notify");
		this.toSlowPath();
	},
	set: function(newVal){
		...
		if(root) {
			if(this.reads.length) {
				...
				canReflect_1_17_7_canReflect.setValue(root,newVal);
			}
		} else {
...
if (process.env.NODE_ENV !== 'production') {
	scopeKeyDataPrototype["can.getName"] = function() {
		return canReflect_1_17_7_canReflect.getName(this.constructor) + "{{" + this.key + "}}";
	};
}
//!steal-remove-end
canReflect_1_17_7_canReflect.assignSymbols(ScopeKeyData.prototype, scopeKeyDataPrototype);

// Creates a compute-like for legacy reasons ...
Object.defineProperty(ScopeKeyData.prototype, "compute", {
	get: function(){
		var compute = canViewScope_4_11_1_makeComputeLike(this);
...
var canViewScope_4_11_1_scopeKeyData = ScopeKeyData;

var canViewScope_4_11_1_compute_data = function(scope, key, options){
	return new canViewScope_4_11_1_scopeKeyData(scope, key, options || {
		args: []
	});
};
...
canAssign_1_3_1_canAssign(Scope, {
	...
	TemplateContext: canViewScope_4_11_1_templateContext,
	// ### keyInfo(key)
	...
	isTemplateContextOrCanNotHaveProperties: function(currentScope){
		...
		if(currentContext instanceof canViewScope_4_11_1_templateContext) {
			return true;
...
canAssign_1_3_1_canAssign(Scope.prototype, {
			...
			readOptions = canAssign_1_3_1_canAssign({
				...
				earlyExit: function(parentValue, nameIndex) {
					...
					if(isVariableScope === true && nameIndex === 0) {
						...
						updateSetObservable = canReflect_1_17_7_canReflect.hasKey( parentValue, keyReads[nameIndex].key);
					} else {
						updateSetObservable =
							// Has more matches
							nameIndex > setObserveDepth ||
							// The same number of matches but it has the key
							nameIndex === setObserveDepth && (typeof parentValue === "object" && canReflect_1_17_7_canReflect.hasOwnKey( parentValue, keyReads[nameIndex].key));
					}
	...
	getDataForScopeSet: function getDataForScopeSet(key, options) {
		...
		var opts = canAssign_1_3_1_canAssign({
			...
			read: function(context, keys){
				...
				if(keys.length > 1) {
					...
					if( parent != null && canReflect_1_17_7_canReflect.hasKey(parent, keys[keys.length-1].key ) ) {
						return {
							parent: parent,
							parentHasKey: true,
							value: undefined
				...
				// If we have only one key, try to find a context with this key
					...
					if( canReflect_1_17_7_canReflect.hasKey(context, keys[0].key ) ) {
						return {
							parent: context,
							parentHasKey: true,
							value: undefined
		...
		if(!canReflect_1_17_7_canReflect.isObservableLike(parent) && canReflect_1_17_7_canReflect.isObservableLike(parent[propName])) {
			if(canReflect_1_17_7_canReflect.isMapLike(parent[propName])) {
				return {
					parent: parent,
					key: propName,
					how: "updateDeep",
			...
			else if(canReflect_1_17_7_canReflect.isValueLike(parent[propName])){
	...
	getHelperOrPartial: function(keyReads) {
		...
		while (scope) {
			...
			if (context instanceof canViewScope_4_11_1_templateContext) {
	...
	getTemplateContext: function() {
		...
		var templateContext = this.getScope(function(scope) {
			lastScope = scope;
			return scope._context instanceof canViewScope_4_11_1_templateContext;
		});

		// if there is no reference scope, add one as the root
		if(!templateContext) {
			templateContext = new Scope(new canViewScope_4_11_1_templateContext());
	...
	addTemplateContext: function(){
		return this.add(new canViewScope_4_11_1_templateContext());
	},
	...
	getRoot: function() {
		...
		if (cur._context instanceof canViewScope_4_11_1_templateContext) {
			cur = child;
		}
		return cur._context;
	},
	...
	getPathsForKey: function getPathsForKey(key) {
		//!steal-remove-start
			...
			var getKeyDefinition = function(obj, key) {
				...
				var objHasKey = canReflect_1_17_7_canReflect.hasKey(obj, key);
	...
	set: function(key, value, options) {
		...
		switch (data.how) {
			...
			case "setValue":
				canReflect_1_17_7_canReflect.setValue("key" in data ? parent[data.key] : parent, value);
				break;

			case "setKeyValue":
				canReflect_1_17_7_canReflect.setKeyValue(parent, data.key, value);
				break;

			case "updateDeep":
				canReflect_1_17_7_canReflect.updateDeep(parent[data.key], value);
				break;
		}
	},
	...
	computeData: function(key, options) {
		return canViewScope_4_11_1_compute_data(this, key, options);
	},
	...
	isSpecial: function(){
		return this._meta.notContext || this._meta.special || (this._context instanceof canViewScope_4_11_1_templateContext) || this._meta.variable;
	}
});
// Legacy name for _walk.
Scope.prototype._read = Scope.prototype._walk;

canReflect_1_17_7_canReflect.assignSymbols(Scope.prototype, {
...
if (process.env.NODE_ENV !== 'production') {
	Scope.prototype.log = function() {
		...
		while(scope) {
			...
			console.log(indent, canReflect_1_17_7_canReflect.getName(scope._context) + contextType, scope._context);
	        scope = scope._parent;
	        indent += " ";
	    }
	};
...
canNamespace_1_0_0_canNamespace.view = canNamespace_1_0_0_canNamespace.view || {};
var canViewScope_4_11_1_canViewScope = canNamespace_1_0_0_canNamespace.view.Scope = Scope;
...
var utils$1 = {
	...
	makeRendererConvertScopes: function (renderer, parentScope, nodeList, observeObservables, metadata) {
		var convertedRenderer = function (newScope, newOptions, parentNodeList) {
			...
			if (newScope !== undefined && !(newScope instanceof canViewScope_4_11_1_canViewScope)) {
				if (parentScope) {
					newScope = parentScope.add(newScope);
				}
				else {
					newScope = new canViewScope_4_11_1_canViewScope(newScope || {});
				}
			}
			if (metadata) {
				metadata.rendered = true;
	...
	makeView: function(renderer){
		var view = canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(scope, nodeList){
			if(!(scope instanceof canViewScope_4_11_1_canViewScope)) {
				scope = new canViewScope_4_11_1_canViewScope(scope);
			}
	...
	getItemsStringContent: function(items, isObserveList, helperOptions){
		var txt = "",
			...
			isObservable = canReflect_1_17_7_canReflect.isObservableLike(items);
	...
	getItemsFragContent: function(items, helperOptions, scope) {
		...
		// Check if using hash
		if (canReflect_1_17_7_canReflect.size(hashExprs) > 0) {
			hashOptions = {};
			canReflect_1_17_7_canReflect.eachKey(hashExprs, function (exprs, key) {
		...
		for (var i = 0; i < len; i++) {
			...
			if (canReflect_1_17_7_canReflect.size(hashOptions) > 0) {
...
canAssign_1_3_1_canAssign(HTMLSection.prototype,{
	...
	compile: function(){
		this.compiled = canViewTarget_4_1_1_canViewTarget(this.targetData, document$1());
		if(this.inverseData) {
			this.inverseCompiled = canViewTarget_4_1_1_canViewTarget(this.inverseData, document$1());
...
var live = {
	setup: function(el, bind, unbind) {
		...
		removalDisposal = canDomMutate_1_3_5_canDomMutate.onNodeRemoval(el, function () {
	...
	listen: function(el, compute, change, queueName) {
		return live.setup(
			...
			function bind() {
				...
				canReflect_1_17_7_canReflect.onValue(compute, change, queueName || "notify");
			...
			function unbind(data) {
				canReflect_1_17_7_canReflect.offValue(compute, change, queueName || "notify");
...
var setData = function(name, value) {
	...
	if (name !== undefined) {
		...
		if (isNode && !removedDisposalMap[id]) {
			var target = this;
			removedDisposalMap[id] = canDomMutate_1_3_5_canDomMutate.onNodeRemoval(target, function () {
		...
		return {
			...
			set: function(value){
				if(prop in this) {
					...
					canDomMutate_1_3_5_node.setAttribute.call(this, prop, "");
				}
			},
			remove: function(){
				this[prop] = false;
...
var specialAttributes = {
	...
	"class": {
		...
		set: function(val){
			...
			if(isSVG(this)) {
				canDomMutate_1_3_5_node.setAttribute.call(this, "class", "" + val);
			} else {
				this.className = val;
			}
		}
		...
		set: function(val){
			...
			if (cur !== val) {
				if (!docEl.contains(element)) {
					var insertionDisposal = canDomMutate_1_3_5_canDomMutate.onNodeInsertion(element, function () {
						insertionDisposal();
						focusTask();
					});
				} else {
	...
	style: {
		set: (function () {
			...
			if ( el && el.style && ("cssText" in el.style) ) {
				...
				return function (val) {
					canDomMutate_1_3_5_node.setAttribute.call(this, "style", val);
				};
			}
		})()
	},
		...
		set: function(value){
			...
			if(nodeName === "select") {
				...
				if(!docEl.contains(this)) {
					var select = this;
					var insertionDisposal = canDomMutate_1_3_5_canDomMutate.onNodeInsertion(select, function () {
						insertionDisposal();
...
var attr = {
	...
	attribute: function(attrName) {
		return {
			...
			set: function(val) {
				canDomMutate_1_3_5_node.setAttribute.call(this, attrName, val);
			}
		};
	},
	...
	remove: function (el, attrName) {
		...
		if(typeof remover === "function" && test.call(el)) {
			...
			canDomMutate_1_3_5_node.removeAttribute.call(el, attrName);
		}
	}
};

var canAttributeObservable_1_1_6_behaviors = attr;
...
core.attr = function(el, attributeName, compute) {
	function liveUpdateAttr(newVal) {
		canQueues_1_2_1_canQueues.domUIQueue.enqueue(canAttributeObservable_1_1_6_behaviors.set, canAttributeObservable_1_1_6_behaviors, [el, attributeName, newVal]);
	}
	//!steal-remove-start
	if(process.env.NODE_ENV !== 'production') {
		// register that the handler changes the parent element
		canReflect_1_17_7_canReflect.assignSymbols(liveUpdateAttr, {
		...
		Object.defineProperty(liveUpdateAttr, "name", {
			value: "live.attr update::"+canReflect_1_17_7_canReflect.getName(compute),
		});
	}
	//!steal-remove-end
	...
	canAttributeObservable_1_1_6_behaviors.set(el, attributeName, canReflect_1_17_7_canReflect.getValue(compute));
};
...
core.attrs = function(el, compute, scope, options) {
	...
	if (!canReflect_1_17_7_canReflect.isObservableLike(compute)) {
		...
		for (var name in attrs) {
			canDomMutate_1_3_5_node.setAttribute.call(el, name, attrs[name]);
		}
		return;
	}
	...
	function liveAttrsUpdate(newVal) {
		...
		for (name in newAttrs) {
			...
			if (newValue !== oldValue) {
				...
				canDomMutate_1_3_5_node.setAttribute.call(el, name, newValue);
		...
		for (name in oldAttrs) {
			canDomMutate_1_3_5_node.removeAttribute.call(el, name);
		}
		oldAttrs = newAttrs;
	}
	...
	if(process.env.NODE_ENV !== 'production') {
		// register that the handler changes the parent element
		canReflect_1_17_7_canReflect.assignSymbols(liveAttrsUpdate, {
			"can.getChangesDependencyRecord": function() {
				var s = new Set();
				s.add(el);
				return {
		...
		Object.defineProperty(liveAttrsUpdate, "name", {
			value: "live.attrs update::"+canReflect_1_17_7_canReflect.getName(compute),
		});
		canReflectDependencies_1_1_1_canReflectDependencies.addMutatedBy(el, compute);
	}
	//!steal-remove-end
	...
	canReflect_1_17_7_canReflect.onValue(compute, liveAttrsUpdate,"domUI");

	var removalDisposal;
	var teardownHandler = function() {
		canReflect_1_17_7_canReflect.offValue(compute, liveAttrsUpdate,"domUI");
		if (removalDisposal) {
			removalDisposal();
			removalDisposal = undefined;
		}
	...
	liveAttrsUpdate(canReflect_1_17_7_canReflect.getValue(compute));
};
...
function updateNodeList(data, frag, nodeListUpdatedByFn) {
	if(data.nodeList.isUnregistered !== true) {
		...
		var newChildren = canReflect_1_17_7_canReflect.toArray(canChildNodes_1_2_0_canChildNodes(frag));
...
core.html = function(el, compute, parentNode, nodeListOrOptions) {
	...
	var meta = {reasonLog: "live.html replace::"+canReflect_1_17_7_canReflect.getName(compute)};
	...
	if(process.env.NODE_ENV !== 'production') {
		// register that the handler changes the parent element
		canReflect_1_17_7_canReflect.assignSymbols(liveHTMLUpdateHTML, {
			"can.getChangesDependencyRecord": function() {
				var s = new Set();
				s.add(parentNode);
				return {
		...
		Object.defineProperty(liveHTMLUpdateHTML, "name", {
			value: "live.html update::"+canReflect_1_17_7_canReflect.getName(compute),
		});
	}
	//!steal-remove-end
	...
	makeAndPut(canReflect_1_17_7_canReflect.getValue(compute));
};
...
canReflect_1_17_7_canReflect.assignSymbols(SetObservable.prototype, {
...
var Patcher = function(observableOrList, priority) {
	...
	this.isObservableValue = canReflect_1_17_7_canReflect.isValueLike(this.observableOrList) || canReflect_1_17_7_canReflect.isObservableLike(this.observableOrList);
	if(this.isObservableValue) {
	    this.priority = canReflect_1_17_7_canReflect.getPriority(observableOrList);
	} else {
	...
	if(process.env.NODE_ENV !== 'production') {
		Object.defineProperty(this.onList, "name", {
			value: "live.list new list::"+canReflect_1_17_7_canReflect.getName(observableOrList),
		});
		Object.defineProperty(this.onPatchesNotify, "name", {
			value: "live.list notify::"+canReflect_1_17_7_canReflect.getName(observableOrList),
		});
		Object.defineProperty(this.onPatchesDerive, "name", {
			value: "live.list derive::"+canReflect_1_17_7_canReflect.getName(observableOrList),
		});
	}
	//!steal-remove-end
};
...
Patcher.prototype = {
	...
	setup: function() {
		if (this.observableOrList[onValueSymbol$3]) {
			...
			// new list.
			canReflect_1_17_7_canReflect.onValue(this.observableOrList, this.onList, "notify");
			// listen on the current value (which shoudl be a list) if there is one
			this.setupList(canReflect_1_17_7_canReflect.getValue(this.observableOrList));
		} else {
	...
	teardown: function() {
		if (this.observableOrList[offValueSymbol$1]) {
			canReflect_1_17_7_canReflect.offValue(this.observableOrList, this.onList, "notify");
		}
	},
...
canReflect_1_17_7_canReflect.assignSymbols(Patcher.prototype, {
	"can.onPatches": function(handler, queue) {
		this.handlers.add([queue || "mutate", handler]);
	},
	"can.offPatches": function(handler, queue) {
...
var renderAndAddToNodeLists = function(newNodeLists, parentNodeList, render, context, args) {
		...
		var children = canReflect_1_17_7_canReflect.toArray(canChildNodes_1_2_0_canChildNodes(itemFrag));
		if (parentNodeList) {
...
function ListDOMPatcher(el, compute, render, context, parentNode, nodeList, falseyRender) {
	...
	this.isValueLike = canReflect_1_17_7_canReflect.isValueLike(this.value);
	this.isObservableLike = canReflect_1_17_7_canReflect.isObservableLike(this.value);
	...
	if(process.env.NODE_ENV !== 'production') {
		Object.defineProperty(this.onPatches, "name", {
			value: "live.list update::"+canReflect_1_17_7_canReflect.getName(compute),
		});
	}
	//!steal-remove-end
}
...
ListDOMPatcher.prototype = {
	...
	add: function(items, index) {
		...
		items.forEach( function(item, key) {
			...
			var itemIndex = new canSimpleObservable_2_4_1_canSimpleObservable(key + index),
				itemCompute = new setObservable(item, function(newVal) {
					canReflect_1_17_7_canReflect.setKeyValue(this.patcher.currentList, itemIndex.get(), newVal );
				}.bind(this)),
		...
		if (!masterNodeList[masterListIndex]) {
			...
			canDomMutate_1_3_5_node.insertBefore.call(el.parentNode, frag, el);
		}
...
core.text = function(el, compute, parentNode, nodeList) {
	...
	el.nodeValue = core.makeString(canReflect_1_17_7_canReflect.getValue(compute));
	...
	if(process.env.NODE_ENV !== 'production') {
		// register that the handler changes the parent element
		canReflect_1_17_7_canReflect.assignSymbols(liveTextUpdateTextNode, {
			"can.getChangesDependencyRecord": function() {
				var s = new Set();
				s.add(parent);
				return {
		...
		Object.defineProperty(liveTextUpdateTextNode, "name", {
			value: "live.text update::"+canReflect_1_17_7_canReflect.getName(compute),
		});
	}
	//!steal-remove-end
...
canAssign_1_3_1_canAssign(TextSectionBuilder.prototype,{
	...
	compile: function(state){
		...
		return function(scope){
			...
			canReflect_1_17_7_canReflect.onValue(observation, noop);

			var value = canReflect_1_17_7_canReflect.getValue(observation);
			if( canReflect_1_17_7_canReflect.valueHasDependencies( observation ) ) {
				...
				canReflect_1_17_7_canReflect.offValue(observation, noop);
			} else {
				if(state.textContentOnly) {
					this.nodeValue = value;
				}
				else if(state.attr) {
					canDomMutate_1_3_5_node.setAttribute.call(this, state.attr, value);
				}
				else {
		...
		canReflect_1_17_7_canReflect.assignSymbols(this, {
			"can.getName": function() {
				return (
					canReflect_1_17_7_canReflect.getName(this.constructor) +
					"<" +
					canReflect_1_17_7_canReflect.getName(getter) +
					">"
				);
			}
		});
...
canReflect_1_17_7_canReflect.assignSymbols(SetterObservable.prototype, {
...
function computeHasDependencies(compute){
	return compute[canSymbol_1_6_1_canSymbol.for("can.valueHasDependencies")] ?
		canReflect_1_17_7_canReflect.valueHasDependencies(compute) : compute.computeInstance.hasDependencies;
}
...
function getObservableValue_fromDynamicKey_fromObservable(key, root, helperOptions, readOptions) {
	...
	var getKeys = function(){
		return canStacheKey_1_4_0_canStacheKey.reads(("" + canReflect_1_17_7_canReflect.getValue(key)).replace(/\./g, "\\."));
	};
	var parentHasKey;
	var computeValue = new setter(function getDynamicKey() {
		var readData = canStacheKey_1_4_0_canStacheKey.read( canReflect_1_17_7_canReflect.getValue(root) , getKeys());
		parentHasKey = readData.parentHasKey;
		return readData.value;
	}, function setDynamicKey(newVal){
		canStacheKey_1_4_0_canStacheKey.write(canReflect_1_17_7_canReflect.getValue(root), getKeys(), newVal);
	});
	canObservation_4_1_1_canObservation.temporarilyBind(computeValue);
	computeValue.initialValue = canReflect_1_17_7_canReflect.getValue(computeValue);
...
function toComputeOrValue(value) {
	...
	if(canReflect_1_17_7_canReflect.isObservableLike(value)) {
		// we only want to do this for things that `should` have dependencies, but dont.
		if(canReflect_1_17_7_canReflect.isValueLike(value) && canReflect_1_17_7_canReflect.valueHasDependencies(value) === false) {
			return canReflect_1_17_7_canReflect.getValue(value);
		}
		// if compute data
		if(value.compute) {
			...
			return canViewScope_4_11_1_makeComputeLike(value);
		}
	}
	return value;
}
...
Hashes.prototype.value = function(scope, helperOptions){
	...
	return new canObservation_4_1_1_canObservation(function(){
		...
		for(var prop in hash) {
			finalHash[prop] = hash[prop].call ? canReflect_1_17_7_canReflect.getValue( hash[prop].value ) : expressionHelpers.toComputeOrValue( hash[prop].value );
		}
		return finalHash;
	});
};
...
if (process.env.NODE_ENV !== 'production') {
	Hashes.prototype.sourceText = function(){
		var hashes = [];
		canReflect_1_17_7_canReflect.eachKey(this.hashExprs, function(expr, prop){
		...
		for(var i = 0, len = args.length; i < len; i++) {
			if (doNotWrapArguments) {
				...
				finalArgs[i] = args[i].call ?
					canReflect_1_17_7_canReflect.getValue( args[i].value ) :
...
Call.prototype.value = function(scope, helperOptions){
	...
	var method = this.methodExpr.value(scope, { proxyMethods: false }),
		func = canReflect_1_17_7_canReflect.getValue( method );

	var getArgs = callExpression.args(scope , func && func.ignoreArgLookup);

	var computeFn = function(newVal){
		var func = canReflect_1_17_7_canReflect.getValue( method );
		...
		if(typeof func === "function") {
			...
			if(func[isViewSymbol$1] === true) {
				...
				if(!(args[0] instanceof canViewScope_4_11_1_canViewScope)){
	...
	if (typeof initialValue === "function") {
		...
		if (process.env.NODE_ENV !== 'production') {
			Object.defineProperty(helperFn, "name", {
				configurable: true,
				value: canReflect_1_17_7_canReflect.getName(this)
			});
		}
		//!steal-remove-end
	}
...
if (process.env.NODE_ENV !== 'production') {
	Helper.prototype.sourceText = function(){
		...
		if(canReflect_1_17_7_canReflect.size(this.hashExprs) > 0){
...
//!steal-remove-end
if (process.env.NODE_ENV !== 'production') {
	canReflect_1_17_7_canReflect.assignSymbols(Helper.prototype,{
		"can.getName": function() {
			return canReflect_1_17_7_canReflect.getName(this.constructor) + "{{" + (this.sourceText()) + "}}";
		}
	});
}
//!steal-remove-end
...
var Lookup = function(key, root, sourceText) {
	this.key = key;
	this.rootExpr = root;
	canReflect_1_17_7_canReflect.setKeyValue(this, sourceTextSymbol$1, sourceText);
};
...
var convertToAtLookup = function(ast){
	if(ast.type === "Lookup") {
		canReflect_1_17_7_canReflect.setKeyValue(ast, sourceTextSymbol$2, ast.key);
		...
		while(cursor.index < tokens.length) {
			...
			// Bracket
				...
				if (lastToken && (lastToken.type === "Call" || lastToken.type === "Bracket"  )  ) {
					...
					//!steal-remove-start
					if (process.env.NODE_ENV !== 'production') {
						canReflect_1_17_7_canReflect.setKeyValue(bracket$$1, canSymbol_1_6_1_canSymbol.for("can-stache.originalKey"), top.key);
					}
					//!steal-remove-end
...
var core$1 = {
	...
	makeEvaluator: function (scope, nodeList, mode, exprData, truthyRenderer, falseyRenderer, stringOnly) {
		...
		if(!mode || helperOptions.metadata.rendered) {
			...
			return function(){
				// Get the value
				var finalValue = canReflect_1_17_7_canReflect.getValue(value);
				var result;
				...
				else if ( typeof finalValue !== "string" && canReflect_1_17_7_canReflect.isListLike(finalValue) ) {
					var isObserveList = canReflect_1_17_7_canReflect.isObservableLike(finalValue) &&
						canReflect_1_17_7_canReflect.isListLike(finalValue);

					if(canReflect_1_17_7_canReflect.getKeyValue(finalValue, "length")) {
						if (stringOnly) {
		...
		return function(scope, parentSectionNodeList){
			...
			var partialFrag = new canObservation_4_1_1_canObservation(function(){
				...
				if(exprData && exprData.argExprs.length === 1) {
					var newContext = canReflect_1_17_7_canReflect.getValue( exprData.argExprs[0].value(scope) );
				...
				var partial = canReflect_1_17_7_canReflect.getKeyValue(scope.templateContext.partials, localPartialName);
				var renderer;
			...
			canReflect_1_17_7_canReflect.setPriority(partialFrag,nodeList.nesting );
	...
	makeStringBranchRenderer: function(mode, expressionString, state){
		...
		var branchRenderer = function branchRenderer(scope, truthyRenderer, falseyRenderer){
			...
			if(gotObservableValue) {
				res = canReflect_1_17_7_canReflect.getValue(evaluator);
			} else {
				res = evaluator();
			}
	...
	makeLiveBindingBranchRenderer: function(mode, expressionString, state){
		...
		var branchRenderer = function branchRenderer(scope, parentSectionNodeList, truthyRenderer, falseyRenderer){
			...
			if(canReflect_1_17_7_canReflect.setPriority(observable, nodeList.nesting) === false) {
			...
			canReflect_1_17_7_canReflect.onValue(observable, k);

			var value = canReflect_1_17_7_canReflect.getValue(observable);
			...
			else if( canReflect_1_17_7_canReflect.valueHasDependencies(observable) ) {
			...
			// If the computeValue has no observable dependencies, just set the value on the element.
				...
				if(state.attr) {
					canDomMutate_1_3_5_canDomMutate.setAttribute(this, state.attr, value);
				}
				else if(state.tag) {
					canViewLive_4_2_7_canViewLive.attrs(this, value);
				}
			...
			// Unbind the compute.
			canReflect_1_17_7_canReflect.offValue(observable, k);
		};
...
//!steal-remove-start
if (process.env.NODE_ENV !== 'production') {
	var canReflect = canReflect_1_17_7_canReflect;
...
var truthyObservable = function(observable){
    return new canObservation_4_1_1_canObservation(function truthyObservation(){
        var val = canReflect_1_17_7_canReflect.getValue(observable);
...
var bindAndRead = function (value) {
	if ( value && canReflect_1_17_7_canReflect.isValueLike(value) ) {
...
function forOfObject(object, variableName, options){
	var result = [];
	canReflect_1_17_7_canReflect.each(object, function(val, key){
...
var forHelper = function(helperOptions) {
	...
	if(resolved && !canReflect_1_17_7_canReflect.isListLike(resolved)) {
		return forOfObject(resolved,variableName, helperOptions);
	}
	if(options.stringOnly) {
		var parts = [];
		canReflect_1_17_7_canReflect.eachIndex(resolved, function(value, index){
			var variableScope = {};
			if(variableName !== undefined){
				variableScope[variableName] = value;
			}
...
canStacheHelpers_1_2_0_canStacheHelpers["let"] = function(options){
	...
	canReflect_1_17_7_canReflect.assignMap(variableScope._context, options.hash);
...
var helpersCore = {
	...
	makeSimpleHelper: function(fn) {
		return function() {
			var realArgs = [];
			canReflect_1_17_7_canReflect.eachIndex(arguments, function(val) {
	...
	addBuiltInHelpers: function() {
		canReflect_1_17_7_canReflect.each(builtInHelpers, function(helper, helperName) {
			...
			if (process.env.NODE_ENV !== 'production') {
				Object.defineProperty(callLogic, "name", {
					value: name+"("+args.map(function(arg){
						return canReflect_1_17_7_canReflect.getName(arg);
					}).join(",")+")",
					configurable: true
				});
			}
...
var ifHelper = canAssign_1_3_1_canAssign(function ifHelper(expr, options) {
	...
	if (expr && canReflect_1_17_7_canReflect.isValueLike(expr)) {
		value = canReflect_1_17_7_canReflect.getValue(new truthyObservable(expr));
	} else {
...
var switchHelper = function(expression, options){
	...
	canReflect_1_17_7_canReflect.assignSymbols(defaultHelper, {
		"can.isValueLike": true,
		"can.isFunctionLike": false,
		"can.getValue": function() {
...
var joinBaseHelper = function(firstExpr/* , expr... */){
	...
	var templateModule = canReflect_1_17_7_canReflect.getKeyValue(options.scope.templateContext.helpers, 'module');
...
var eachHelper = function(items) {
	...
	if ((
		canReflect_1_17_7_canReflect.isObservableLike(resolved) && canReflect_1_17_7_canReflect.isListLike(resolved) ||
			( canReflect_1_17_7_canReflect.isListLike(resolved) && canReflect_1_17_7_canReflect.isValueLike(items) )
	) && !options.stringOnly) {
		// Tells that a helper has been called, this function should be returned through
		// checking its value.
		options.metadata.rendered = true;
	...
	if (!!expr && canReflect_1_17_7_canReflect.isListLike(expr)) {
		result = utils$1.getItemsFragContent(expr, options, options.scope);
		return options.stringOnly ? result.join('') : result;
	} else if (canReflect_1_17_7_canReflect.isObservableLike(expr) && canReflect_1_17_7_canReflect.isMapLike(expr) || expr instanceof Object) {
		result = [];
		canReflect_1_17_7_canReflect.each(expr, function(val, key){
...
var withHelper = function (expr, options) {
	...
	if(!options) {
		...
		if(options.hash && canReflect_1_17_7_canReflect.size(options.hash) > 0) {
...
core$2.addConverter = function(name, getterSetter) {
	if(typeof name === "object") {
		if(!converterPackages.has(name)) {
			...
			canReflect_1_17_7_canReflect.eachKey(name, function(getterSetter, name) {
	...
	"not": {
		get: function(obs, options){
			if(core$2.looksLikeOptions(options)) {
				return canReflect_1_17_7_canReflect.getValue(obs) ? options.inverse() : options.fn();
			} else {
				return !canReflect_1_17_7_canReflect.getValue(obs);
			}

		},
		set: function(newVal, obs){
			canReflect_1_17_7_canReflect.setValue(obs, !newVal);
		}
	}
};
...
function stache (filename, template) {
	...
	canViewParser_4_1_2_canViewParser(template, {
		...
		attrEnd: function(attrName, lineNo){
			...
			if(state.node.section) {
				...
				//!steal-remove-start
				if (process.env.NODE_ENV !== 'production') {
					var decodedAttrName = canAttributeEncoder_1_1_1_canAttributeEncoder.decode(attrName);
	...
	var scopifiedRenderer = canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(scope, options, nodeList){
		...
		if (nodeList === undefined && canReflect_1_17_7_canReflect.isListLike(options)) {
			nodeList = options;
			options = undefined;
		}
		...
		// helperOptions (.fn, .inverse, etc) when called as Call Expressions
		canReflect_1_17_7_canReflect.eachKey(options && options.helpers, function(helperValue) {
			helperValue.requiresOptionsArgument = true;
		});

		// helpers, partials, tags, vars
		var templateContext = new canViewScope_4_11_1_templateContext(options);

		// copy inline partials over
		canReflect_1_17_7_canReflect.eachKey(inlinePartials, function(partial, partialName) {
			canReflect_1_17_7_canReflect.setKeyValue(templateContext.partials, partialName, partial);
		});

		// allow the current renderer to be called with {{>scope.view}}
		canReflect_1_17_7_canReflect.setKeyValue(templateContext, 'view', scopifiedRenderer);
		//!steal-remove-start
		if (process.env.NODE_ENV !== 'production') {
			canReflect_1_17_7_canReflect.setKeyValue(templateContext, 'filename', section.filename);
		}
		//!steal-remove-end
		...
		if ( !(scope instanceof canViewScope_4_11_1_canViewScope) ) {
			scope = new canViewScope_4_11_1_canViewScope(templateContext).add(scope);
		} else {
			// we are going to split ...
			var templateContextScope = new canViewScope_4_11_1_canViewScope(templateContext);
...
stache.safeString = function(text){
	...
	return canReflect_1_17_7_canReflect.assignSymbols({},{
		"can.toDOM": function(){
			return text;
		}
	});
...
var canStache_4_15_8_canStache = canNamespace_1_0_0_canNamespace.stache = stache;
...
var canViewModel_4_0_1_canViewModel = canNamespace_1_0_0_canNamespace.viewModel = function (el, attr, val) {
	...
	} else if (canReflect_1_17_7_canReflect.isListLike(el) && !el.nodeType) {
		el = el[0];
	}

	if (canReflect_1_17_7_canReflect.isObservableLike(attr) && canReflect_1_17_7_canReflect.isMapLike(attr)) {
	...
	switch (arguments.length) {
		...
		case 1:
			return scope;
		case 2:
			return canReflect_1_17_7_canReflect.getKeyValue(scope, attr);
		default:
			canReflect_1_17_7_canReflect.setKeyValue(scope, attr, val);
			return el;
	}
};
...
var canAttributeObservable_1_1_6_event = canEvent;
...
var canAttributeObservable_1_1_6_getEventName = function getEventName(el, prop, bindingData) {
	var event = "change";
	...
	if (canAttributeObservable_1_1_6_behaviors.findSpecialListener(prop)) {
		event = prop;
	}
...
function AttributeObservable(el, prop, bindingData, event) {
	...
	this.event = event || canAttributeObservable_1_1_6_getEventName(el, prop, bindingData);
	this.handler = this.handler.bind(this);
...
canAssign_1_3_1_canAssign(AttributeObservable.prototype, {
	...
	get: function get() {
		...
		var value = canAttributeObservable_1_1_6_behaviors.get(this.el, this.prop);
		if (typeof value === 'function') {
	...
	set: function set(newVal) {
		var setterDispatchedEvents = canAttributeObservable_1_1_6_behaviors.setAttrOrProp(this.el, this.prop, newVal);
	...
	handler: function handler(newVal, event) {
		var old = this._value;
		var queuesArgs = [];
		this._value = canAttributeObservable_1_1_6_behaviors.get(this.el, this.prop);
	...
	onBound: function onBound() {
		...
		observable._handler = function(event) {
			observable.handler(canAttributeObservable_1_1_6_behaviors.get(observable.el, observable.prop), event);
		};

		if (observable.event === internalRadioChangeEventType) {
			canAttributeObservable_1_1_6_event.on.call(observable.el, "change", observable._handler);
		}

		var specialBinding = canAttributeObservable_1_1_6_behaviors.findSpecialListener(observable.prop);
		if (specialBinding) {
			observable._specialDisposal = specialBinding.call(observable.el, observable.prop, observable._handler, canUtilAEL);
		}

		canAttributeObservable_1_1_6_event.on.call(observable.el, observable.event, observable._handler);
	...
	onUnbound: function onUnbound() {
		...
		if (observable.event === internalRadioChangeEventType) {
			canAttributeObservable_1_1_6_event.off.call(observable.el, "change", observable._handler);
		}
		...
		canAttributeObservable_1_1_6_event.off.call(observable.el, observable.event, observable._handler);
	},
...
canReflect_1_17_7_canReflect.assignSymbols(AttributeObservable.prototype, {
	"can.isMapLike": false,
...
var canAttributeObservable_1_1_6_canAttributeObservable = AttributeObservable;
...
var runEventCallback = function (el, ev, data, scope, expr, attributeName, attrVal) {
	...
	var updateFn = function() {
		...
		value = canReflect_1_17_7_canReflect.isValueLike(value) ?
			canReflect_1_17_7_canReflect.getValue(value) :
			value;
...
var behaviors = {
	...
	viewModel: function(el, tagData, makeViewModel, initialViewModelData, staticDataBindingsOnly) {
		...
		canReflect_1_17_7_canReflect.each(el.attributes || [], function(node) {
			...
			if (dataBinding) {
				...
				if (bindingInfo.parentToChild) {
					var parentValue = bindingInfo.stickyParentToChild ? canViewScope_4_11_1_makeComputeLike(dataBinding.parent) : dataBinding.canBinding.parentValue;
		...
		if (!bindingsState.isSettingViewModel) {
			attributeDisposal = canDomMutate_1_3_5_canDomMutate.onNodeAttributeChange(el, function(ev) {
	...
	data: function(el, attrData) {
		...
		attributeDisposal = canDomMutate_1_3_5_canDomMutate.onNodeAttributeChange(el, attributeListener);
		removedDisposal = canDomMutate_1_3_5_canDomMutate.onNodeRemoval(el, function() {
			var doc = el.ownerDocument;
			var ownerNode = doc.contains ? doc : doc.documentElement;
	...
	event: function(el, data) {
		...
		var attributeName = canAttributeEncoder_1_1_1_canAttributeEncoder.decode(data.attributeName),
		...
		var handler = function(ev) {
			var attrVal = el.getAttribute(canAttributeEncoder_1_1_1_canAttributeEncoder.encode(attributeName));
			if (!attrVal) {
				return;
			}
			...
			if (expr instanceof expression_1.Hashes) {
				...
				var isObservableValue = canReflect_1_17_7_canReflect.isObservableLike(value) && canReflect_1_17_7_canReflect.isValueLike(value);
				runScope.set(key, isObservableValue ? canReflect_1_17_7_canReflect.getValue(value) : value);
		...
		var unbindEvent = function() {
			canAttributeObservable_1_1_6_event.off.call(bindingContext, event, handler);
		...
		canAttributeObservable_1_1_6_event.on.call(bindingContext, event, handler);
		attributesDisposal = canDomMutate_1_3_5_canDomMutate.onNodeAttributeChange(el, attributesHandler);
		removalDisposal = canDomMutate_1_3_5_canDomMutate.onNodeRemoval(el, removalHandler);
	}
};
...
var getObservableFrom = {
			...
			if (mustBeGettable || scopeProp.indexOf("(") >= 0 || scopeProp.indexOf("=") >= 0) {
				...
				if (parentExpression instanceof expression_1.Hashes) {
					return new canSimpleObservable_2_4_1_canSimpleObservable(function () {
						...
						var isObservableValue = canReflect_1_17_7_canReflect.isObservableLike(value) && canReflect_1_17_7_canReflect.isValueLike(value);
						scope.set(key, isObservableValue ? canReflect_1_17_7_canReflect.getValue(value) : value);
					});
				} else {
				...
				var observation = {};
				canReflect_1_17_7_canReflect.assignSymbols(observation, {
					...
					"can.setValue": function setValue(newVal) {
						...
						var value = expr.value(scope);
						canReflect_1_17_7_canReflect.setValue(value, newVal);
					},
						...
						if (process.env.NODE_ENV !== 'production') {
							...
							if (data.parent && data.key) {
								result = "ObservableFromScope<" +
									canReflect_1_17_7_canReflect.getName(data.parent) +
									"." +
									data.key +
									">";
							}
		...
		var observation = new setter(
			...
			function setViewModelProperty(newVal) {
				...
				if (stickyCompute) {
					...
					var oldValue = canReflect_1_17_7_canReflect.getKeyValue(viewModel, setName);
					if (canReflect_1_17_7_canReflect.isObservableLike(oldValue)) {
						canReflect_1_17_7_canReflect.setValue(oldValue, newVal);
					} else {
						canReflect_1_17_7_canReflect.setKeyValue(
							viewModel,
							setName,
							new canSimpleObservable_2_4_1_canSimpleObservable(canReflect_1_17_7_canReflect.getValue(stickyCompute))
						);
					}
				} else {
					if (isBoundToContext) {
						canReflect_1_17_7_canReflect.setValue(viewModel, newVal);
					} else {
						canReflect_1_17_7_canReflect.setKeyValue(viewModel, setName, newVal);
					}
				}
			}
		);
	...
	attribute: function(el, scope, prop, bindingData, mustBeGettable, stickyCompute, event, bindingInfo) {
		return new canAttributeObservable_1_1_6_canAttributeObservable(el, prop, bindingData, event);
	}
};
...
canReflect_1_17_7_canReflect.each(bindingRules, function(value, key) {
...
var getBindingInfo = function(node, attributeViewModelBindings, templateType, tagName, favorViewModel) {
	var bindingInfo,
		attributeName = canAttributeEncoder_1_1_1_canAttributeEncoder.decode(node.name),
...
var makeDataBinding = function(node, el, bindingData) {
	...
	//!steal-remove-start
	if (process.env.NODE_ENV !== 'production') {
		var nodeHTML = canAttributeEncoder_1_1_1_canAttributeEncoder.decode(node.name)+"="+JSON.stringify(node.value);
	...
	// Create the binding
	var canBinding = new canBind_1_1_1_canBind(bindingOptions);
...
var canStacheBindings_4_6_4_canStacheBindings = canStacheBindings;
...
canStache_4_15_8_canStache.addBindings(canStacheBindings_4_6_4_canStacheBindings);
...
function addContext(el, tagData, insertionElementTagData) {
	...
	var teardown = canStacheBindings_4_6_4_canStacheBindings.behaviors.viewModel(el, insertionElementTagData, function(initialData, hasDataBinding, bindingState) {
...
function makeInsertionTagCallback(tagName, componentTagData, shadowTagData, leakScope, getPrimaryTemplate) {
	...
	return function hookupFunction(el, insertionElementTagData) {
		...
		if (template) {
			...
			var newNodes = canReflect_1_17_7_canReflect.toArray( canChildNodes_1_2_0_canChildNodes(frag) );
...
function getSetupFunctionForComponentVM(componentInitVM) {
	...
	return canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(el, makeViewModel, initialVMData) {
		...
		canReflect_1_17_7_canReflect.eachKey(componentInitVM, function(parent, propName) {
			...
			if (canGetParentValue === true || canSetParentValue) {
				...
				var child = new setter(
					...
					function(newValue) {
						canReflect_1_17_7_canReflect.setKeyValue(viewModel, propName, newValue);
					}
				);

				// Create the binding similar to what’s in can-stache-bindings
				var canBinding = new canBind_1_1_1_canBind({
					child: child,
					parent: parent,
					queue: "domUI",
					...
					updateParentName: "update " + canReflect_1_17_7_canReflect.getName(parent) + " of <" + el.nodeName.toLowerCase() + ">"
					//!steal-remove-end
				});
	...
	// ## Static
	{
		...
		setup: function() {
			...
			if (Component) {
				...
				if(this.prototype.events !== undefined && canReflect_1_17_7_canReflect.size(this.prototype.events) !== 0) {
				...
				if (process.env.NODE_ENV !== 'production') {
					...
					if (this.prototype.viewModel && canReflect_1_17_7_canReflect.isConstructorLike(this.prototype.viewModel)) {
				...
				if(this.prototype.ViewModel) {
					...
					if(protoViewModel) {
						if(typeof protoViewModel === "function") {
							if(canReflect_1_17_7_canReflect.isObservableLike(protoViewModel.prototype) && canReflect_1_17_7_canReflect.isMapLike(protoViewModel.prototype)) {
								this.ViewModel = protoViewModel;
							} else {
								this.viewModelHandler = protoViewModel;
							}
						} else {
							if(canReflect_1_17_7_canReflect.isObservableLike(protoViewModel) && canReflect_1_17_7_canReflect.isMapLike(protoViewModel)) {
								//!steal-remove-start
								if (process.env.NODE_ENV !== 'production') {
				...
				if (typeof this.renderer === "string") {
					...
					this.renderer = canStache_4_15_8_canStache(viewName, this.renderer);
				}
		...
		setup: function(el, componentTagData) {
			...
			if (componentContent !== undefined) {
				...
				if (typeof componentContent === "function") {
					...
					componentTagData.subtemplate = canStache_4_15_8_canStache(componentContent);
				}
			}

			// Check for the component being instantiated with a scope
			var componentScope = componentTagData.scope;
			if (componentScope !== undefined && componentScope instanceof canViewScope_4_11_1_canViewScope === false) {
				componentTagData.scope = new canViewScope_4_11_1_canViewScope(componentScope);
			}
			...
			if (componentTemplates !== undefined) {
				canReflect_1_17_7_canReflect.eachKey(componentTemplates, function(template, name) {
					// Check if it’s a string that needs to be parsed by stache
					if (typeof template === "string") {
						var debugName = name + " template";
						componentTemplates[name] = canStache_4_15_8_canStache(debugName, template);
					}
				});
			}
			...
			if (preventDataBindings) {
				...
				if (componentTagData.setupBindings) {
					...
					setupFn = function(el, callback, data) {
						return canStacheBindings_4_6_4_canStacheBindings.behaviors.viewModel(el, componentTagData, callback, data);
					};
				}
				teardownBindings = setupFn(el, function(initialViewModelData) {
					...
					if(viewModelHandler) {
						...
						if (canReflect_1_17_7_canReflect.isObservableLike(scopeResult) && canReflect_1_17_7_canReflect.isMapLike(scopeResult) ) {
							// If the function returns a can.Map, use that as the viewModel
							viewModelInstance = scopeResult;
						} else if (canReflect_1_17_7_canReflect.isObservableLike(scopeResult.prototype) && canReflect_1_17_7_canReflect.isMapLike(scopeResult.prototype)) {
			...
			if(this.helpers !== undefined) {
				canReflect_1_17_7_canReflect.eachKey(this.helpers, function(val, prop) {
			...
			if(this.constructor.Control) {
				...
				var removalDisposal = canDomMutate_1_3_5_canDomMutate.onNodeRemoval(el, function () {
					var doc = el.ownerDocument;
			...
			if( hasShadowTemplate ) {
				...
				if (leakScope.intoShadowContent) {
					...
					shadowTagData = {
						scope: new canViewScope_4_11_1_canViewScope(this.viewModel, null, { viewModel: true }),
						options: options
					};
				}
			...
			if(viewModel && viewModel.connectedCallback) {
				...
				if(componentInPage) {
					...
					var insertionDisposal = canDomMutate_1_3_5_canDomMutate.onNodeInsertion(el, function () {
						insertionDisposal();
						disconnectedCallback = viewModel.connectedCallback(el);
					});
				}
...
var canComponent_4_4_9_canComponent = canNamespace_1_0_0_canNamespace.Component = Component;
...
var map$3 = function(oldObject, newObject){
	...
	oldObjectClone = canReflect_1_17_7_canReflect.assignMap({}, oldObject);

    canReflect_1_17_7_canReflect.eachKey(newObject, function(value, newProp){
...
function makeDiffListIdentityComparison(oldList, newList, parentKey, nestedPatches) {
    var listSchema = canReflect_1_17_7_canReflect.getSchema(oldList),
        ...
        oldListLength = canReflect_1_17_7_canReflect.size( oldList );
    if(listSchema != null) {
        if(listSchema.values != null) {
            typeSchema = canReflect_1_17_7_canReflect.getSchema(listSchema.values);
        }
    ...
    return function(a, b, aIndex) {
        if(canReflect_1_17_7_canReflect.isPrimitive(a)) {
            return a === b;
        }
        if(canReflect_1_17_7_canReflect.isPrimitive(b)) {
            return a === b;
        }
...
function diffDeep(dest, source, parentKey){
    ...
    if (dest && canReflect_1_17_7_canReflect.isMoreListLikeThanMapLike(dest)) {
        var nestedPatches = [],
        ...
        patches.forEach(function(patch){
            ...
            var destVal = dest && canReflect_1_17_7_canReflect.getKeyValue(dest, key),
                sourceVal = source && canReflect_1_17_7_canReflect.getKeyValue(source, key);
...
function smartMerge(instance, props) {
	...
	props = canReflect_1_17_7_canReflect.serialize(props);

	if (canReflect_1_17_7_canReflect.isMoreListLikeThanMapLike(instance)) {
...
function mergeMap(instance, data) {
	...
	// for each key in
	canReflect_1_17_7_canReflect.eachKey(instance, function(value, prop) {
		if(!canReflect_1_17_7_canReflect.hasKey(data, prop)) {
			canReflect_1_17_7_canReflect.deleteKeyValue(instance, prop);
			return;
		}
		var newValue = canReflect_1_17_7_canReflect.getKeyValue(data, prop);
		canReflect_1_17_7_canReflect.deleteKeyValue(data, prop);
		...
		if (canReflect_1_17_7_canReflect.isPrimitive(value)) {
			canReflect_1_17_7_canReflect.setKeyValue(instance, prop, newValue);
			return;
		}


		var newValueIsList = Array.isArray(newValue),
			currentValueIsList = canReflect_1_17_7_canReflect.isMoreListLikeThanMapLike(value);

		if (currentValueIsList && newValueIsList) {

			mergeList(value, newValue);

		} else if (!newValueIsList && !currentValueIsList && canReflect_1_17_7_canReflect.isMapLike(value) && canReflect_1_17_7_canReflect.isPlainObject(newValue)) {

			// TODO: the `TYPE` should probably be infered from the `_define` property definition.
			var schema = canReflect_1_17_7_canReflect.getSchema(value);
			if (schema && schema.identity && schema.identity.length) {
				var id = canReflect_1_17_7_canReflect.getIdentity(value, schema);
				if (id != null && id === canReflect_1_17_7_canReflect.getIdentity(newValue, schema)) {
					mergeMap(value, newValue);
					return;
				}
			}
			canReflect_1_17_7_canReflect.setKeyValue(instance, prop, canReflect_1_17_7_canReflect.new(value.constructor, newValue));
		} else {
			canReflect_1_17_7_canReflect.setKeyValue(instance, prop, newValue);
		}
	});
	canReflect_1_17_7_canReflect.eachKey(data, function(value, prop) {
		canReflect_1_17_7_canReflect.setKeyValue(instance, prop, value);
	});
}

function mergeList(list$$1, data) {
	var ItemType, itemSchema;
	var listSchema = canReflect_1_17_7_canReflect.getSchema(list$$1);
	if (listSchema) {
		ItemType = listSchema.values;
	}

	if (ItemType) {
		itemSchema = canReflect_1_17_7_canReflect.getSchema(ItemType);
	}
	if (!itemSchema && canReflect_1_17_7_canReflect.size(list$$1) > 0) {
		itemSchema = canReflect_1_17_7_canReflect.getSchema(canReflect_1_17_7_canReflect.getKeyValue(list$$1, 0));
	}

	var identity;
	if(itemSchema && itemSchema.identity && itemSchema.identity.length) {
		identity = function(a, b) {
		   var aId = canReflect_1_17_7_canReflect.getIdentity(a, itemSchema),
			   bId = canReflect_1_17_7_canReflect.getIdentity(b, itemSchema);
		   var eq = aId === bId;
		   if (eq) {
	...
	var hydrate = ItemType ? canReflect_1_17_7_canReflect.new.bind(canReflect_1_17_7_canReflect, ItemType) : function(v) {
		return v;
	};
...
var _delete = function deleteAtPath(data, path) {
    ...
    for(var i = 0; i < parts.length - 1; i++) {
        if(current) {
            current = canReflect_1_17_7_canReflect.getKeyValue( current, parts[i]);
        }
    }

    if(current) {
        canReflect_1_17_7_canReflect.deleteKeyValue(current, parts[parts.length - 1 ]);
    }
};
...
function set$1(object, path, value) {
    ...
    // Set the value
    if (current) {
        canReflect_1_17_7_canReflect.setKeyValue(current, parts[i], value);
    } else {
...
var walk = function walk(obj, name, keyCallback){
    ...
    for (i = 0; i < length; i++) {
        container = current;
        part = parts[i];
        current = canKey_1_2_0_utils.isContainer(container) && canReflect_1_17_7_canReflect.getKeyValue( container, part );
...
function deleteKeys(parentsAndKeys) {
    for(var i  = parentsAndKeys.length - 1; i >= 0; i--) {
        ...
        if(canReflect_1_17_7_canReflect.size(parentAndKey.parent) !== 0) {
            return;
        }
    }
}
...
var transform = function(obj, transformer){
    var copy = canReflect_1_17_7_canReflect.serialize( obj);

    canReflect_1_17_7_canReflect.eachKey(transformer, function(writeKey, readKey){
...
function withKey(obj, key, fn) {
	...
	if (isFunction$2(obj[onKeyValueSymbol$3])) {
		canReflect_1_17_7_canReflect.onKeyValue(obj, key, noop$2);
	}

	result = fn(obj, key);

	if (isFunction$2(obj[offKeyValueSymbol$2])) {
		canReflect_1_17_7_canReflect.offKeyValue(obj, key, noop$2);
	}
...
function withoutKey(obj, fn) {
	...
	if (isFunction$2(obj[onValueSymbol$4])) {
		canReflect_1_17_7_canReflect.onValue(obj, noop$2);
	}

	result = fn(obj);

	if (isFunction$2(obj[offValueSymbol$2])) {
		canReflect_1_17_7_canReflect.offValue(obj, noop$2);
	}
...
var makeNode = function makeNode(obj, key) {
	...
	var node = {
		obj: obj,
		name: canReflect_1_17_7_canReflect.getName(obj),
		value: gotKey ? canReflect_1_17_7_canReflect.getKeyValue(obj, key) : canReflect_1_17_7_canReflect.getValue(obj)
	};
...
var getGraph = function getGraph(obj, key) {
	...
	var visitKeyDependencies = function visitKeyDependencies(source, meta, cb) {
		canReflect_1_17_7_canReflect.eachKey(source.keyDependencies || {}, function(keys, obj) {
			canReflect_1_17_7_canReflect.each(keys, function(key) {
				cb(obj, meta, key);
			});
		});
	};
	...
	var visitValueDependencies = function visitValueDependencies(source, meta, cb) {
		canReflect_1_17_7_canReflect.eachIndex(source.valueDependencies || [], function(obj) {
			cb(obj, meta);
		});
	};
	...
	var visit = function visit(obj, meta, key) {
		...
		if (data && data.whatIChange) {
			...
			// kind :: derive | mutate
			canReflect_1_17_7_canReflect.eachKey(data.whatIChange, function(dependencyRecord, kind) {
				nextMeta.kind = kind;
		...
		if (data && data.whatChangesMe) {
			...
			// kind :: derive | mutate
			canReflect_1_17_7_canReflect.eachKey(data.whatChangesMe, function(dependencyRecord, kind) {
				nextMeta.kind = kind;
				visitKeyDependencies(dependencyRecord, nextMeta, visit);
				visitValueDependencies(dependencyRecord, nextMeta, visit);
			});
...
var formatGraph = function formatGraph(graph) {
	...
	var nodesDataSet = graph.nodes.map(function(node) {
		return {
			...
			label:
				canReflect_1_17_7_canReflect.getName(node.obj) +
				(node.key ? "." + node.key : "")
		};
	});
...
var logData = function log(data) {
	...
	if (data.derive.length) {
		...
		canReflect_1_17_7_canReflect.eachIndex(data.derive, log);
		console.groupEnd();
	}

	if (data.mutations.length) {
		console.group("MUTATED BY");
		canReflect_1_17_7_canReflect.eachIndex(data.mutations, log);
		console.groupEnd();
	}

	if (data.twoWay.length) {
		console.group("TWO WAY");
		canReflect_1_17_7_canReflect.eachIndex(data.twoWay, log);
		console.groupEnd();
	}
...
function registerWithDevtools() {
	...
	var devtoolsCanModules = {
		...
		Reflect: canReflect_1_17_7_canReflect,
...
canComponent_4_4_9_canComponent.extend({
	tag: "editable-span",
...
canStache_4_15_8_canStache.addHelper("isList", isList);
canStache_4_15_8_canStache.addHelper("isNumber", val => typeof val === "number");
canStache_4_15_8_canStache.addHelper("isEven", num => num % 2 === 0);
...
const getTypeName = val => {
	if (canReflect_1_17_7_canReflect.isObservableLike(val)) {
		if (canReflect_1_17_7_canReflect.isListLike(val)) {
			return "Array";
		} else if (canReflect_1_17_7_canReflect.isMapLike(val)) {
			return "Object";
		}
	}
...
const parseKeyValue = (key, value, parentPath) => {
	...
	const mightHaveChildren = canReflect_1_17_7_canReflect.isObservableLike(value) && (canReflect_1_17_7_canReflect.isListLike(value) || canReflect_1_17_7_canReflect.isMapLike(value));
...
const JSONTreeEditor = canComponent_4_4_9_canComponent.extend({
	...
	ViewModel: {
		...
		get parsedJSON() {
			...
			canReflect_1_17_7_canReflect.each(this.json, (value, key) => {
...
const KeyValueEditor = canComponent_4_4_9_canComponent.extend({
...
var viewmodelEditor = canComponent_4_4_9_canComponent.extend({
	...
	ViewModel: {
		...
		json: {
			value({ listenTo, lastSet, resolve }) {
				...
				canReflect_1_17_7_canReflect.onValue(serializedJSON, setPatches);
				...
				listenTo("serializedViewModelData", (ev, vmData) => {
					...
					canReflect_1_17_7_canReflect.offValue(serializedJSON, setPatches);
					canReflect_1_17_7_canReflect.assignDeep(json, newJson);
					canReflect_1_17_7_canReflect.onValue(serializedJSON, setPatches);
				});
...
export { canComponent_4_4_9_canComponent as Component, map$2 as DefineMap, canKey_1_2_0_canKey as key, canDiff_1_4_2_canDiff as diff, canReflect_1_17_7_canReflect as Reflect, canObservation_4_1_1_canObservation as Observation };
