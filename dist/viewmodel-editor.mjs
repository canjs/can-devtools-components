...
function isFunctionLike(obj){
	var result,
		symbolValue = !!obj && obj[canSymbol_1_6_1_canSymbol.for("can.isFunctionLike")];
...
var canReflect_1_17_6_canReflect = canNamespace_1_0_0_canNamespace.Reflect = reflect;
 ...
 * @static
 */
canReflect_1_17_6_canReflect.assignMap(Construct, {
	/**
	 ...
	 */
	setup: function (base) {
		var defaults = canReflect_1_17_6_canReflect.assignDeepMap({},base.defaults);
		this.defaults = canReflect_1_17_6_canReflect.assignDeepMap(defaults,this.defaults);
	},
	...
	extend: function (name, staticProperties, instanceProperties) {
		...
		canReflect_1_17_6_canReflect.assignMap(Constructor, {
...
var canConstruct_3_5_3_canConstruct = canNamespace_1_0_0_canNamespace.Construct = Construct;
...
var canQueues_1_1_4_queueState = {
	lastTask: null
};
...
var Queue = function ( name, callbacks ) {
	this.callbacks = canAssign_1_3_1_canAssign( {
		...
		onComplete: function () {
			canQueues_1_1_4_queueState.lastTask = null;
		}
	}, callbacks || {});
	this.name = name;
	this.index = 0;
...
if(process.env.NODE_ENV !== 'production') {
	Queue.prototype._logEnqueue = function ( task ) {
		...
		// run task.
		task.meta.parentTask = canQueues_1_1_4_queueState.lastTask;
	...
	Queue.prototype._logFlush = function ( task ) {
		...
		canQueues_1_1_4_queueState.lastTask = task;
	};
}
//!steal-remove-end

var canQueues_1_1_4_queue = Queue;

var PriorityQueue = function () {
	canQueues_1_1_4_queue.apply( this, arguments );
...
PriorityQueue.prototype = Object.create( canQueues_1_1_4_queue.prototype );
...
var canQueues_1_1_4_priorityQueue = PriorityQueue;
...
CompletionQueue.prototype = Object.create( canQueues_1_1_4_queue.prototype );
...
var canQueues_1_1_4_completionQueue = CompletionQueue;

var canQueues_1_1_4_canQueues = createCommonjsModule(function (module) {
...
NOTIFY_QUEUE = new canQueues_1_1_4_queue( "NOTIFY", {
	onComplete: function () {
		DERIVE_QUEUE.flush();
	},
...
DERIVE_QUEUE = new canQueues_1_1_4_priorityQueue( "DERIVE", {
	onComplete: function () {
		DOM_UI_QUEUE.flush();
	},
	onFirstTask: function () {
...
DOM_UI_QUEUE = new canQueues_1_1_4_completionQueue( "DOM_UI", {
	onComplete: function () {
		MUTATE_QUEUE.flush();
	},
	onFirstTask: function () {
...
MUTATE_QUEUE = new canQueues_1_1_4_queue( "MUTATE", {
	onComplete: function () {
		canQueues_1_1_4_queueState.lastTask = null;
	},
	onFirstTask: function () {
...
var queues = {
	Queue: canQueues_1_1_4_queue,
	PriorityQueue: canQueues_1_1_4_priorityQueue,
	CompletionQueue: canQueues_1_1_4_completionQueue,
	...
	stack: function () {
		var current = canQueues_1_1_4_queueState.lastTask;
		var stack = [];
		while ( current ) {
...
var canObservationRecorder_1_2_0_canObservationRecorder = createCommonjsModule(function (module) {
...
function getDeepSize ( root, level ) {
	if ( level === 0 ) {
		return canReflect_1_17_6_canReflect.size( root );
	} else if ( canReflect_1_17_6_canReflect.size( root ) === 0 ) {
		return 0;
	} else {
		var count = 0;
		canReflect_1_17_6_canReflect.each( root, function ( value ) {
...
function getDeep ( node, items, depth, maxDepth ) {
	...
	if ( maxDepth === depth ) {
		if ( canReflect_1_17_6_canReflect.isMoreListLikeThanMapLike( node ) ) {
			canReflect_1_17_6_canReflect.addValues( items, canReflect_1_17_6_canReflect.toArray( node ) );
		} else {
			throw new Error( "can-key-tree: Map-type leaf containers are not supported yet." );
		}
	} else {
		canReflect_1_17_6_canReflect.each( node, function ( value ) {
...
function clearDeep ( node, keys, maxDepth, deleteHandler ) {
	if ( maxDepth === keys.length ) {
		if ( canReflect_1_17_6_canReflect.isMoreListLikeThanMapLike( node ) ) {
			var valuesToRemove = canReflect_1_17_6_canReflect.toArray( node );
			if(deleteHandler) {
				valuesToRemove.forEach(function(value){
					deleteHandler.apply(null, keys.concat(value));
				});
			}
			canReflect_1_17_6_canReflect.removeValues( node, valuesToRemove );
		} else {
			throw new Error( "can-key-tree: Map-type leaf containers are not supported yet." );
		}
	} else {
		canReflect_1_17_6_canReflect.each( node, function ( value, key ) {
			clearDeep( value, keys.concat(key), maxDepth, deleteHandler );
			canReflect_1_17_6_canReflect.deleteKeyValue( node, key );
		});
	}
}
...
var KeyTree = function ( treeStructure, callbacks ) {
	...
	if ( canReflect_1_17_6_canReflect.isConstructorLike( FirstConstructor ) ) {
...
// ## Methods
canReflect_1_17_6_canReflect.assign(KeyTree.prototype,{
    // ### Add
    add: function ( keys ) {
        ...
        for ( var i = 0; i < keys.length - 1; i++ ) {
    		var key = keys[i];
    		var childNode = canReflect_1_17_6_canReflect.getKeyValue( place, key );
    		if ( !childNode ) {
    			...
    			canReflect_1_17_6_canReflect.setKeyValue( place, key, childNode );
    		}
    		place = childNode;
    	}

        // Add the final leaf value in the tree.
    	if ( canReflect_1_17_6_canReflect.isMoreListLikeThanMapLike( place ) ) {
    		canReflect_1_17_6_canReflect.addValues( place, [keys[keys.length - 1]] );
    	} else {
    ...
    getNode: function ( keys ) {
        ...
        for ( var i = 0; i < keys.length; i++ ) {
            var key = keys[i];
            node = canReflect_1_17_6_canReflect.getKeyValue( node, key );
            if ( !node ) {
                return;
            }
        }
    ...
    delete: function ( keys, deleteHandler ) {
        ...
        for ( var i = 0; i < keys.length - 1; i++ ) {
    		var key = keys[i];
    		var childNode = canReflect_1_17_6_canReflect.getKeyValue( parentNode, key );
        ...
        if ( !keys.length ) {
    		...
    		if ( canReflect_1_17_6_canReflect.isMoreListLikeThanMapLike( parentNode ) ) {
				if(deleteHandler) {
					deleteHandler.apply(null, keys.concat(lastKey));
				}
    			canReflect_1_17_6_canReflect.removeValues( parentNode, [lastKey] );
    		} else {
    			throw new Error( "can-key-tree: Map types are not supported yet." );
    		}
    	}
            ...
            var nodeToRemove = canReflect_1_17_6_canReflect.getKeyValue( parentNode, lastKey );
    		if ( nodeToRemove !== undefined ) {
    			clearDeep( nodeToRemove, keys, this.treeStructure.length - 1, deleteHandler );
    			canReflect_1_17_6_canReflect.deleteKeyValue( parentNode, lastKey );
    		} else {
    			return false;
    		}
    	}
    	...
    	for ( i = path.length - 2; i >= 0; i-- ) {
    		if ( canReflect_1_17_6_canReflect.size( parentNode ) === 0 ) {
    			parentNode = path[i];
    			canReflect_1_17_6_canReflect.deleteKeyValue( parentNode, keys[i] );
    		} else {
    			break;
    		}
    	}
        // Call `onEmpty` if the tree is now empty.
    	if (  canReflect_1_17_6_canReflect.size( this.root ) === 0 ) {
			this.empty = true;
...
var mergeValueDependencies = function mergeValueDependencies(obj, source) {
	...
	if (sourceValueDeps) {
		...
		canReflect_1_17_6_canReflect.eachIndex(sourceValueDeps, function(dep) {
...
var mergeKeyDependencies = function mergeKeyDependencies(obj, source) {
	...
	if (sourcekeyDeps) {
		...
		canReflect_1_17_6_canReflect.eachKey(sourcekeyDeps, function(keys, obj) {
			...
			canReflect_1_17_6_canReflect.eachIndex(keys, function(key) {
				entry.add(key);
			});
		});
	}
	...
	"can.dispatch": function(value, old) {
		...
		if(process.env.NODE_ENV !== 'production') {
			queuesArgs = [
				...
				, null
				, [canReflect_1_17_6_canReflect.getName(this), "changed to", value, "from", old]
				/* jshint laxcomma: false */
			];
		}
		//!steal-remove-end
		canQueues_1_1_4_canQueues.enqueueByQueue.apply(canQueues_1_1_4_canQueues, queuesArgs);
		//!steal-remove-start
		if(process.env.NODE_ENV !== 'production') {
		...
		if(process.env.NODE_ENV !== 'production') {
			...
			if (notifyHandlers.length) {
				notifyHandlers.forEach(function(handler) {
					var changes = canReflect_1_17_6_canReflect.getChangesDependencyRecord(handler);
...
var mixinValueEventBindings = function(obj) {
	canReflect_1_17_6_canReflect.assign(obj, properties);
	canReflect_1_17_6_canReflect.assignSymbols(obj, symbols);
...
function addNewKeyDependenciesIfNotInOld(event) {
    ...
    if(this.oldEventSet === undefined || this.oldEventSet["delete"](event) === false) {
        canReflect_1_17_6_canReflect.onKeyValue(this.observable, event, this.onDependencyChange,"notify");
    }
}
...
function removeKeyDependencies(event) {
    canReflect_1_17_6_canReflect.offKeyValue(this.observable, event, this.onDependencyChange,"notify");
}
...
function addValueDependencies(observable) {
    ...
    if(this.oldDependencies.valueDependencies.delete(observable) === false) {
        canReflect_1_17_6_canReflect.onValue(observable, this.onDependencyChange,"notify");
    }
}
function removeValueDependencies(observable) {
    canReflect_1_17_6_canReflect.offValue(observable, this.onDependencyChange,"notify");
}


var canObservation_4_1_1_recorderDependencyHelpers = {
    // ## updateObservations
    //
...
var unbindTemporarilyBoundValue = function () {
	for (var i = 0, len = observables.length; i < len; i++) {
		canReflect_1_17_6_canReflect.offValue(observables[i], temporarilyBoundNoOperation);
	}
	observables = null;
};
...
function temporarilyBind(compute) {
	...
	canReflect_1_17_6_canReflect.onValue(computeInstance, temporarilyBoundNoOperation);
	if (!observables) {
		observables = [];
...
var canObservation_4_1_1_temporarilyBind = temporarilyBind;
...
function Observation(func, context, options){
	...
	this.newDependencies = canObservationRecorder_1_2_0_canObservationRecorder.makeDependenciesRecord();
	...
	if (process.env.NODE_ENV !== 'production') {
		...
		Object.defineProperty(this.onDependencyChange, "name", {
			value: canReflect_1_17_6_canReflect.getName(this) + ".onDependencyChange",
		});
		Object.defineProperty(this.update, "name", {
			value: canReflect_1_17_6_canReflect.getName(this) + ".update",
		});
	}
	//!steal-remove-end
}
...
canReflect_1_17_6_canReflect.assign(Observation.prototype, {
			...
			if (process.env.NODE_ENV !== 'production') {
				queuesArgs = [
					...
					[],
					{
						priority: this.options.priority
						/* jshint laxcomma: true */
						, log: [ canReflect_1_17_6_canReflect.getName(this.update) ]
						/* jshint laxcomma: false */
					}
					/* jshint laxcomma: true */
					, [canReflect_1_17_6_canReflect.getName(context), "changed"]
					/* jshint laxcomma: false */
				];
			}
			//!steal-remove-end
			// Update this observation after all `notify` tasks have been run.
			canQueues_1_1_4_canQueues.deriveQueue.enqueue.apply(canQueues_1_1_4_canQueues.deriveQueue, queuesArgs);
		}
	},
	...
	onUnbound: function(){
		this.bound = false;
		canObservation_4_1_1_recorderDependencyHelpers.stopObserving(this.newDependencies, this.onDependencyChange);
		// Setup newDependencies in case someone binds again to this observable.
		this.newDependencies = canObservationRecorder_1_2_0_canObservationRecorder.makeDependenciesRecorder();
	},
	...
	get: function(){
		...
		if( this.options.isObservable && canObservationRecorder_1_2_0_canObservationRecorder.isRecording() ) {

			// ... tell the tracking compute to listen to change on this observation.
			canObservationRecorder_1_2_0_canObservationRecorder.add(this);
		...
		if(this.bound === true ) {
			...
			if(canQueues_1_1_4_canQueues.deriveQueue.tasksRemainingCount() > 0) {
	...
	log: function() {
		...
		if (process.env.NODE_ENV !== 'production') {
			...
			this._log = function(previous, current) {
				dev.log(
					canReflect_1_17_6_canReflect.getName(this),
...
if (process.env.NODE_ENV !== 'production') {
	observationProto["can.getName"] = function() {
		return canReflect_1_17_6_canReflect.getName(this.constructor) + "<" + canReflect_1_17_6_canReflect.getName(this.func) + ">";
	};
}
//!steal-remove-end
canReflect_1_17_6_canReflect.assignSymbols(Observation.prototype, observationProto);
...
Observation.updateChildrenAndSelf = function(observation){
	...
	if(observation.update !== undefined && canQueues_1_1_4_canQueues.deriveQueue.isEnqueued( observation.update ) === true) {
		// TODO: In the future, we should be able to send log information
		// to explain why this needed to be updated.
		canQueues_1_1_4_canQueues.deriveQueue.flushQueuedTask(observation.update);
		return true;
	}
...
["add","addAll","ignore","trap","trapsCount","isRecording"].forEach(function(methodName){
	Observation[methodName] = function(){
		...
		return canObservationRecorder_1_2_0_canObservationRecorder[name].apply(this, arguments);
	};
});
...
Observation.temporarilyBind = canObservation_4_1_1_temporarilyBind;


var canObservation_4_1_1_canObservation = canNamespace_1_0_0_canNamespace.Observation = Observation;
...
var canSimpleObservable_2_4_0_log = function log() {
	//!steal-remove-start
	if (process.env.NODE_ENV !== 'production') {
		this._log = function(previous, current) {
			dev.log(
...
canReflect_1_17_6_canReflect.assignMap(SimpleObservable.prototype, {
	log: canSimpleObservable_2_4_0_log,
	get: function(){
		canObservationRecorder_1_2_0_canObservationRecorder.add(this);
		return this._value;
	},
...
if (process.env.NODE_ENV !== 'production') {
	simpleObservableProto["can.getName"] = function() {
		...
		return canReflect_1_17_6_canReflect.getName(this.constructor) + "<" + value$$1 + ">";
	};
}
//!steal-remove-end

canReflect_1_17_6_canReflect.assignSymbols(SimpleObservable.prototype, simpleObservableProto);

var canSimpleObservable_2_4_0_canSimpleObservable = canNamespace_1_0_0_canNamespace.SimpleObservable = SimpleObservable;

var peek = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canReflect_1_17_6_canReflect.getValue.bind(canReflect_1_17_6_canReflect));
...
function SettableObservable(fn, context, initialValue) {
	...
	this.lastSetValue = new canSimpleObservable_2_4_0_canSimpleObservable(initialValue);
	function observe() {
	...
	//!steal-remove-start
	if (process.env.NODE_ENV !== 'production') {
		canReflect_1_17_6_canReflect.assignSymbols(this, {
			"can.getName": function() {
				return (
					canReflect_1_17_6_canReflect.getName(this.constructor) +
					"<" +
					canReflect_1_17_6_canReflect.getName(fn) +
					">"
				);
			}
		});
		Object.defineProperty(this.handler, "name", {
			value: canReflect_1_17_6_canReflect.getName(this) + ".handler"
		});
		Object.defineProperty(observe, "name", {
			value: canReflect_1_17_6_canReflect.getName(fn) + "::" + canReflect_1_17_6_canReflect.getName(this.constructor)
		});
	}
	//!steal-remove-end

	this.observation = new canObservation_4_1_1_canObservation(observe, this);
}

value(SettableObservable.prototype);

canReflect_1_17_6_canReflect.assignMap(SettableObservable.prototype, {
	...
	handler: function(newVal) {
		...
		if (process.env.NODE_ENV !== 'production') {
			...
			reasonLog = [canReflect_1_17_6_canReflect.getName(this),"set to", newVal, "from", old];
		}
		//!steal-remove-end

		// adds callback handlers to be called w/i their respective queue.
		canQueues_1_1_4_canQueues.enqueueByQueue(
			this.handlers.getNode([]),
			this,
			[newVal, old],
			null,
	...
	activate: function(){
		canReflect_1_17_6_canReflect.onValue(this.observation, this.handler, "notify");
		this._value = peek(this.observation);
	},
	onUnbound: function() {
		this.bound = false;
		canReflect_1_17_6_canReflect.offValue(this.observation, this.handler, "notify");
	},
	set: function(newVal) {
		var oldVal =  this.lastSetValue.get();

		if (
			canReflect_1_17_6_canReflect.isObservableLike(oldVal) &&
			canReflect_1_17_6_canReflect.isValueLike(oldVal) &&
			!canReflect_1_17_6_canReflect.isObservableLike(newVal)
		) {
			canReflect_1_17_6_canReflect.setValue(oldVal, newVal);
		} else {
			if (newVal !== oldVal) {
	...
	get: function() {
		if (canObservationRecorder_1_2_0_canObservationRecorder.isRecording()) {
			canObservationRecorder_1_2_0_canObservationRecorder.add(this);
			if (!this.bound) {
	...
	hasDependencies: function() {
		return canReflect_1_17_6_canReflect.valueHasDependencies(this.observation);
	},
	getValueDependencies: function() {
		return canReflect_1_17_6_canReflect.getValueDependencies(this.observation);
	}
});
...
canReflect_1_17_6_canReflect.assignSymbols(SettableObservable.prototype, {
	"can.getValue": SettableObservable.prototype.get,
	"can.setValue": SettableObservable.prototype.set,
	"can.isMapLike": false,
	"can.getPriority": function() {
		return canReflect_1_17_6_canReflect.getPriority(this.observation);
	},
	"can.setPriority": function(newPriority) {
		canReflect_1_17_6_canReflect.setPriority(this.observation, newPriority);
	},
...
var peek$1 = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canReflect_1_17_6_canReflect.getValue.bind(canReflect_1_17_6_canReflect));
	...
	if (!this.inGetter) {
		...
		if (process.env.NODE_ENV !== 'production') {
			queuesArgs = [
				...
				null
				/* jshint laxcomma: true */
				, [canReflect_1_17_6_canReflect.getName(this), "resolved with", newVal]
				/* jshint laxcomma: false */
			];
		}
		//!steal-remove-end
...
canReflect_1_17_6_canReflect.assignSymbols(Globals.prototype, {
...
var canGlobals_1_2_0_canGlobalsProto = Globals;

var canGlobals_1_2_0_canGlobalsInstance = createCommonjsModule(function (module) {


var globals = new canGlobals_1_2_0_canGlobalsProto();
 ...
 */
canGlobals_1_2_0_canGlobalsInstance.define('global', function(){
	// Web Worker
...
var global_1 = canGlobals_1_2_0_canGlobalsInstance.makeExport('global');
 ...
 */
canGlobals_1_2_0_canGlobalsInstance.define('document', function(){
	return canGlobals_1_2_0_canGlobalsInstance.getKeyValue('global').document;
});

var document$1 = canGlobals_1_2_0_canGlobalsInstance.makeExport('document');
...
canGlobals_1_2_0_canGlobalsInstance.define('isNode', function(){
	return typeof process === "object" &&
		{}.toString.call(process) === "[object process]";
});

var isNode = canGlobals_1_2_0_canGlobalsInstance.makeExport('isNode');
...
canGlobals_1_2_0_canGlobalsInstance.define('isBrowserWindow', function(){
	var isNode = canGlobals_1_2_0_canGlobalsInstance.getKeyValue('isNode');
	return typeof window !== "undefined" &&
		typeof document !== "undefined" &&
		isNode === false;
});

var isBrowserWindow = canGlobals_1_2_0_canGlobalsInstance.makeExport('isBrowserWindow');
...
function makeDelegator (domEvents) {
	...
	canReflect_1_17_6_canReflect.assignSymbols( Delegator.prototype, {
		"can.setKeyValue": function(eventType, handlersBySelector){
			var handler = this.delegated[eventType] = function(ev){
				canReflect_1_17_6_canReflect.each(handlersBySelector, function(handlers, selector){
					var cur = ev.target;
					do {
...
var canDomEvents_1_3_2_canDomEvents = canNamespace_1_0_0_canNamespace.domEvents = domEvents;
...
var ensureMeta = function ensureMeta(obj) {
	...
	if (!meta) {
		meta = {};
		canReflect_1_17_6_canReflect.setKeyValue(obj, metaSymbol, meta);
	}
...
function stopListeningArgumentsToKeys(bindTarget, event, handler, queueName) {
	if(arguments.length && canReflect_1_17_6_canReflect.isPrimitive(bindTarget)) {
		queueName = handler;
		handler = event;
		event = bindTarget;
...
var props = {
	...
	dispatch: function(event, args) {
		...
		if (!this.__inSetup) {
			...
			if(process.env.NODE_ENV !== 'production') {
				if (!event.reasonLog) {
					event.reasonLog = [canReflect_1_17_6_canReflect.getName(this), "dispatched", '"' + event.type + '"', "with"].concat(args);
				}
			}
			...
			if ( batch ) {
				canQueues_1_1_4_canQueues.batch.start();
			}
			if(handlersByType) {
				if (handlersByType.onKeyValue) {
					canQueues_1_1_4_canQueues.enqueueByQueue(handlersByType.onKeyValue, this, args, event.makeMeta, event.reasonLog);
				}
				if (handlersByType.event) {
					event.batchNum = canQueues_1_1_4_canQueues.batch.number();
					var eventAndArgs = [event].concat(args);
					canQueues_1_1_4_canQueues.enqueueByQueue(handlersByType.event, this, eventAndArgs, event.makeMeta, event.reasonLog);
				}
			}
			if(keysNode) {
				canQueues_1_1_4_canQueues.enqueueByQueue(keysNode, this, [event.keyChanged], event.makeMeta, event.reasonLog);
			}
			if(patchesNode) {
				canQueues_1_1_4_canQueues.enqueueByQueue(patchesNode, this, [event.patches], event.makeMeta, event.reasonLog);
			}
			if(dispatchConstructorPatches) {
				this.constructor[dispatchInstanceOnPatchesSymbol](this, event.patches);
			}
			if ( batch ) {
				canQueues_1_1_4_canQueues.batch.stop();
			}
		}
		return event;
	},
	...
	listenTo: function (bindTarget, event, handler, queueName) {
		...
		if(canReflect_1_17_6_canReflect.isPrimitive(bindTarget)) {
			queueName = handler;
			handler = event;
			event = bindTarget;
			bindTarget = this;
	...
	on: function(eventName, handler, queue) {
		...
		if (listenWithDOM) {
			if (typeof handler === 'string') {
				canDomEvents_1_3_2_canDomEvents.addDelegateListener(this, eventName, handler, queue);
			} else {
				canDomEvents_1_3_2_canDomEvents.addEventListener(this, eventName, handler, queue);
			}
		} else {
			if ("addEventListener" in this) {
				this.addEventListener(eventName, handler, queue);
			} else if (this[onKeyValueSymbol$1]) {
				canReflect_1_17_6_canReflect.onKeyValue(this, eventName, handler, queue);
			} else if (this[onEventSymbol]) {
				this[onEventSymbol](eventName, handler, queue);
			} else {
				if (!eventName && this[onValueSymbol$1]) {
					canReflect_1_17_6_canReflect.onValue(this, handler, queue);
				} else {
	...
	off: function(eventName, handler, queue) {
		...
		if (listenWithDOM) {
			if (typeof handler === 'string') {
				canDomEvents_1_3_2_canDomEvents.removeDelegateListener(this, eventName, handler, queue);
			} else {
				canDomEvents_1_3_2_canDomEvents.removeEventListener(this, eventName, handler, queue);
			}
		} else {
			if ("removeEventListener" in this) {
				this.removeEventListener(eventName, handler, queue);
			} else if (this[offKeyValueSymbol]) {
				canReflect_1_17_6_canReflect.offKeyValue(this, eventName, handler, queue);
			} else if (this[offEventSymbol]) {
				this[offEventSymbol](eventName, handler, queue);
			} else {
				if (!eventName && this[offValueSymbol]) {
					canReflect_1_17_6_canReflect.offValue(this, handler, queue);
				} else {
...
legacyMapBindings = function(obj) {
	// add properties
	canReflect_1_17_6_canReflect.assignMap(obj, props);
	// add symbols
	return canReflect_1_17_6_canReflect.assignSymbols(obj, symbols$1);
};
...
canReflect_1_17_6_canReflect.assignMap(legacyMapBindings, props);
canReflect_1_17_6_canReflect.assignSymbols(legacyMapBindings, symbols$1);
...
defineNonEnumerable$1(legacyMapBindings, "flush", function() {
	...
	canQueues_1_1_4_canQueues.flush();
});

defineNonEnumerable$1(legacyMapBindings, "afterPreviousEvents", function(handler) {
	console.warn("don't use afterPreviousEvents");
	canQueues_1_1_4_canQueues.mutateQueue.enqueue(function afterPreviousEvents() {
		canQueues_1_1_4_canQueues.mutateQueue.enqueue(handler);
	});
	canQueues_1_1_4_canQueues.flush();
});
...
function ResolverObservable(resolver, context, initialValue) {
	...
	this.resolver = canObservationRecorder_1_2_0_canObservationRecorder.ignore(resolver);
	this.context = context;
	this._valueOptions = {
		resolve: this.resolve.bind(this),
		listenTo: this.listenTo.bind(this),
		stopListening: this.stopListening.bind(this),
		lastSet: new canSimpleObservable_2_4_0_canSimpleObservable(initialValue)
	};
	...
	if (process.env.NODE_ENV !== 'production') {
		canReflect_1_17_6_canReflect.assignSymbols(this, {
			"can.getName": function() {
				return (
					canReflect_1_17_6_canReflect.getName(this.constructor) +
					"<" +
					canReflect_1_17_6_canReflect.getName(resolver) +
					">"
				);
			}
		});
		...
		canReflect_1_17_6_canReflect.assignSymbols(this._valueOptions.lastSet, {
			"can.getName": function() {
				return (
					canReflect_1_17_6_canReflect.getName(this.constructor)  +"::lastSet"+
					"<" +
					canReflect_1_17_6_canReflect.getName(resolver) +
					">"
				);
...
canReflect_1_17_6_canReflect.assignMap(ResolverObservable.prototype, {
		...
		if (process.env.NODE_ENV !== 'production') {
			if(!handler.name) {
				Object.defineProperty(handler, "name", {
					value:
						(bindTarget ?
							 canReflect_1_17_6_canReflect.getName(bindTarget) : "")+
	...
	resolve: function(newVal) {
		...
		if(this._value !== this.lastValue) {
			...
			if (process.env.NODE_ENV !== 'production') {
				...
				enqueueMeta = {
					log: [canReflect_1_17_6_canReflect.getName(this.update)],
					reasonLog: [canReflect_1_17_6_canReflect.getName(this), "resolved with", newVal]
				};
				/* jshint laxcomma: false */
			}
			//!steal-remove-end
			...
			canQueues_1_1_4_canQueues.batch.start();
			canQueues_1_1_4_canQueues.deriveQueue.enqueue(
				this.update,
				this,
				[],
				enqueueMeta
	...
	getValueDependencies: function getValueDependencies() {
		if (this.bound) {
			...
			if (listenHandlers) {
				canReflect_1_17_6_canReflect.each(listenHandlers.root, function(events, obj) {
					canReflect_1_17_6_canReflect.each(events, function(queues, eventName) {
...
canReflect_1_17_6_canReflect.assignSymbols(ResolverObservable.prototype, {
...
function ensureMeta$1(obj) {
    ...
    if (!meta) {
        meta = {};
        canReflect_1_17_6_canReflect.setKeyValue(obj, metaSymbol$1, meta);
    }
...
function onOffAndDispatch(symbolName, dispatchName, handlersName){
    ...
    props$1["can."+dispatchName] = function(instance, arg){
        canQueues_1_1_4_canQueues.enqueueByQueue(ensureMeta$1(this)[handlersName].getNode([]), this, [instance, arg]);
    };
}
...
function mixinTypeBindings(obj){
    return canReflect_1_17_6_canReflect.assignSymbols(obj,props$1);
}
...
var maybeBoolean = canReflect_1_17_6_canReflect.assignSymbols(toBoolean,{
	"can.new": toBoolean,
...
canReflect_1_17_6_canReflect.assignSymbols(DateStringSet.prototype,{
	"can.serialize": function(){
		return this.setValue;
	}
});

var maybeDate = canReflect_1_17_6_canReflect.assignSymbols(toDate,{
	"can.new": toDate,
	"can.getSchema": function(){
		return {
			type: "Or",
...
var maybeNumber = canReflect_1_17_6_canReflect.assignSymbols(toNumber,{
	"can.new": toNumber,
	"can.getSchema": function(){
		return {
			type: "Or",
...
var maybeString = canReflect_1_17_6_canReflect.assignSymbols(toString,{
	"can.new": toString,
	"can.getSchema": function(){
		return {
			type: "Or",
...
var peek$2 = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canReflect_1_17_6_canReflect.getValue.bind(canReflect_1_17_6_canReflect));
	...
	Object_defineNamedPrototypeProperty = function(obj, prop, definition) {
		if (definition.get) {
			Object.defineProperty(definition.get, "name", {
				value: "get "+canReflect_1_17_6_canReflect.getName(obj) + "."+prop,
				writable: true,
				configurable: true
			});
		}
		if (definition.set) {
			Object.defineProperty(definition.set, "name", {
				value:  "set "+canReflect_1_17_6_canReflect.getName(obj) + "."+prop,
				configurable: true
			});
		}
...
function cleanUpDefinition(prop, definition, shouldWarn, typePrototype){
	...
	if(definition.value !== undefined && ( typeof definition.value !== "function" || definition.value.length === 0) ){
		...
		if(process.env.NODE_ENV !== 'production') {
			if(shouldWarn) {
				dev.warn(
					"can-define: Change the 'value' definition for " + canReflect_1_17_6_canReflect.getName(typePrototype)+"."+prop + " to 'default'."
				);
			}
		}
		//!steal-remove-end
...
var canDefine_2_7_0_canDefine = define = canNamespace_1_0_0_canNamespace.define = function(typePrototype, defines, baseDefine) {
	...
	canReflect_1_17_6_canReflect.eachKey(result.definitions, function(definition, property){
...
define.property = function(typePrototype, prop, definition, dataInitializers, computedInitializers, defaultDefinition) {
	...
	//!steal-remove-start
	if(process.env.NODE_ENV !== 'production') {
		if (type && canReflect_1_17_6_canReflect.isConstructorLike(type) && !isDefineType(type)) {
			dev.warn(
				"can-define: the definition for " + canReflect_1_17_6_canReflect.getName(typePrototype) + "."+
                prop +
	...
	if(process.env.NODE_ENV !== 'production') {
		if (definition.get) {
			Object.defineProperty(definition.get, "name", {
				value: canReflect_1_17_6_canReflect.getName(typePrototype) + "'s " + prop + " getter",
				configurable: true
			});
		}
		if (definition.set) {
			Object.defineProperty(definition.set, "name", {
				value: canReflect_1_17_6_canReflect.getName(typePrototype) + "'s " + prop + " setter",
				configurable: true
			});
		}
		if(isValueResolver(definition)) {
			Object.defineProperty(definition.value, "name", {
				value: canReflect_1_17_6_canReflect.getName(typePrototype) + "'s " + prop + " value",
				configurable: true
			});
		}
	}
	...
	// Determine a function that will provide the initial property value.
		...
		if (process.env.NODE_ENV !== 'production') {
			...
			if (definition.default !== null && typeof definition.default === 'object') {
				dev.warn("can-define: The default value for " + canReflect_1_17_6_canReflect.getName(typePrototype)+"."+prop + " is set to an object. This will be shared by all instances of the DefineMap. Use a function that returns the object instead.");
			}
			// If value is a constructor, give a warning
			if (definition.default && canReflect_1_17_6_canReflect.isConstructorLike(definition.default)) {
				dev.warn("can-define: The \"default\" for " + canReflect_1_17_6_canReflect.getName(typePrototype)+"."+prop + " is set to a constructor. Did you mean \"Default\" instead?");
			}
		}
		//!steal-remove-end

		getInitialValue = canObservationRecorder_1_2_0_canObservationRecorder.ignore(make.get.defaultValue(prop, definition, typeConvert, eventsSetter));
	}
		...
		setter = function() {
			...
			if(process.env.NODE_ENV !== 'production') {
				dev.warn("can-define: Set value for property " +
					canReflect_1_17_6_canReflect.getName(typePrototype)+"."+ prop +
...
make = {
		...
		return function(){
			...
			if(process.env.NODE_ENV !== 'production') {
				Object.defineProperty(computeObj.handler, "name", {
					value: canReflect_1_17_6_canReflect.getName(definition.value).replace('value', 'event emitter')
				});
			}
			//!steal-remove-end
			return computeObj;
	...
	compute: function(prop, get, defaultValueFn) {
		...
		return function() {
			...
			if(get.length === 0) {
				observable = new canObservation_4_1_1_canObservation(get, map);
			...
			if(process.env.NODE_ENV !== 'production') {
				Object.defineProperty(computeObj.handler, "name", {
					value: canReflect_1_17_6_canReflect.getName(get).replace('getter', 'event emitter')
				});
			}
			//!steal-remove-end
	...
	set: {
		...
		computed: function(prop) {
			return function(val) {
				canReflect_1_17_6_canReflect.setValue( this._computed[prop].compute, val );
			};
		},
			...
			return function(newVal) {
				if (this.__inSetup) {
					...
					if (newVal !== current) {
						...
						//!steal-remove-start
						if(process.env.NODE_ENV !== 'production') {
							dispatched.reasonLog = [ canReflect_1_17_6_canReflect.getName(this) + "'s", prop, "changed to", newVal, "from", current ];
						}
						//!steal-remove-end
				...
				if (setterCalled) {
					...
					if (hasGetter) {
						...
						// we are expecting something
							...
							if(process.env.NODE_ENV !== 'production') {
								asyncTimer = setTimeout(function() {
									dev.warn('can-define: Setter "' + canReflect_1_17_6_canReflect.getName(self)+"."+prop + '" did not return a value or call the setter callback.');
								}, dev.warnTimeout);
							}
							//!steal-remove-end
							canQueues_1_1_4_canQueues.batch.stop();
						...
						// we are expecting something
							...
							if(process.env.NODE_ENV !== 'production') {
								asyncTimer = setTimeout(function() {
									dev.warn('can/map/setter.js: Setter "' + canReflect_1_17_6_canReflect.getName(self)+"."+prop + '" did not return a value or call the setter callback.');
								}, dev.warnTimeout);
							}
							//!steal-remove-end
							canQueues_1_1_4_canQueues.batch.stop();
			...
			if(isDefineType(type)) {
				...
				if(type.canDefineType) {
					...
					return function setter(newValue){
						return set.call(this, canReflect_1_17_6_canReflect.convert(newValue, type));
					};
				}
			}
	...
	read: {
		...
		computed: function(prop) {
			...
			return function() {
				return canReflect_1_17_6_canReflect.getValue( this._computed[prop].compute );
			};
		},
		lastSet: function(prop) {
			return function() {
				...
				if(observable.lastSetValue) {
					return canReflect_1_17_6_canReflect.getValue(observable.lastSetValue);
				}
			};
		}
	},
	...
	get: {
		...
		data: function(prop) {
			return function() {
				if (!this.__inSetup) {
					canObservationRecorder_1_2_0_canObservationRecorder.add(this, prop);
				}
		...
		computed: function(prop) {
			return function(val) {
				...
				if (canObservationRecorder_1_2_0_canObservationRecorder.isRecording()) {
					canObservationRecorder_1_2_0_canObservationRecorder.add(this, prop);
					if (!canReflect_1_17_6_canReflect.isBound(compute)) {
						canObservation_4_1_1_canObservation.temporarilyBind(compute);
					}
				}
...
makeDefinition = function(prop, def, defaultDefinition, typePrototype) {
	...
	canReflect_1_17_6_canReflect.eachKey(def, function(value, behavior) {
		addBehaviorToDefinition(definition, behavior, value);
	});
	// only add default if it doesn't exist
	canReflect_1_17_6_canReflect.eachKey(defaultDefinition, function(value, prop){
	...
	if(typeof def.type !== 'string') {
		...
		if(!definition.type && !definition.Type) {
            var defaultsCopy = canReflect_1_17_6_canReflect.assignMap({},defaultDefinition);
            definition = canReflect_1_17_6_canReflect.assignMap(defaultsCopy, definition);
		}

		if( canReflect_1_17_6_canReflect.size(definition) === 0 ) {
...
getDefinitionOrMethod = function(prop, value, defaultDefinition, typePrototype){
    ...
    // copies a `Type`'s methods over
		...
		if(canReflect_1_17_6_canReflect.isConstructorLike(value)) {
			definition = {Type: value};
		}
		// or leaves as a function
	} else if( Array.isArray(value) ) {
		definition = {Type: value};
	} else if( canReflect_1_17_6_canReflect.isPlainObject(value) ){
		definition = value;
	}
...
getDefinitionsAndMethods = function(defines, baseDefines, typePrototype) {
	...
	eachPropertyDescriptor(defines, function( prop, propertyDescriptor ) {
		...
		if(prop === "constructor") {
			...
			if(result && typeof result === "object" && canReflect_1_17_6_canReflect.size(result) > 0) {
				...
				//!steal-remove-start
					...
					if(process.env.NODE_ENV !== 'production') {
                    	// Ex: {prop: 0}
						dev.error(canReflect_1_17_6_canReflect.getName(typePrototype)+"."+prop + " does not match a supported propDefinition. See: https://canjs.com/doc/can-define.types.propDefinition.html");
					}
				}
				//!steal-remove-end
			}
...
function setupComputed(instance, eventName) {
	...
	if (computedBinding && computedBinding.compute) {
		if (!computedBinding.count) {
			...
			canReflect_1_17_6_canReflect.onValue(computedBinding.compute, computedBinding.handler, "notify");
			computedBinding.oldValue = canReflect_1_17_6_canReflect.getValue(computedBinding.compute);
		} else {
...
function teardownComputed(instance, eventName){
	...
	if (computedBinding) {
		if (computedBinding.count === 1) {
			...
			canReflect_1_17_6_canReflect.offValue(computedBinding.compute, computedBinding.handler,"notify");
		} else {
			computedBinding.count--;
		}
	}
...
canReflect_1_17_6_canReflect.assignSymbols(eventsProto,{
...
define.setup = function(props, sealed) {
	...
	var map = this;
	canReflect_1_17_6_canReflect.eachKey(props, function(value, prop){
	...
	if(canReflect_1_17_6_canReflect.size(instanceDefinitions) > 0) {
...
define.replaceWith = canDefineLazyValue_1_1_0_defineLazyValue;
...
function isObservableValue(obj){
	return canReflect_1_17_6_canReflect.isValueLike(obj) && canReflect_1_17_6_canReflect.isObservableLike(obj);
}
...
define.types = {
	...
	'observable': function(newVal) {
			...
			else if(canReflect_1_17_6_canReflect.isPlainObject(newVal) &&  define.DefineMap) {
	...
	'stringOrObservable': function(newVal) {
		...
		else if(canReflect_1_17_6_canReflect.isPlainObject(newVal)) {
			return new define.DefaultMap(newVal);
		}
		else {
			return canReflect_1_17_6_canReflect.convert( newVal, define.types.string);
		}
	},
	/**
	...
	'compute': {
		set: function(newValue, setVal, setErr, oldValue) {
			...
			if (isObservableValue(oldValue)) {
				canReflect_1_17_6_canReflect.setValue(oldValue,newValue);
				return oldValue;
			}
			return newValue;
		},
		get: function(value) {
			return isObservableValue(value) ? canReflect_1_17_6_canReflect.getValue(value) : value;
		}
	}
};
...
// Ensure the "obj" passed as an argument has an object on @@can.meta
var canDefine_2_7_0_ensureMeta = function ensureMeta(obj) {
	var metaSymbol = canSymbol_1_6_1_canSymbol.for("can.meta");
	var meta = obj[metaSymbol];
...
var defineHelpers = {
	...
	defineExpando: canDefine_2_7_0_canDefine.expando,
	reflectSerialize: function(unwrapped){
		...
		this.forEach(function(val, name){
			...
			if(propDef && typeof propDef.serialize === "function") {
				...
				val = canReflect_1_17_6_canReflect.serialize(val);
			}
			if(val !== undefined) {
				unwrapped[name] = val;
			}
	...
	reflectUnwrap: function(unwrapped){
		this.forEach(function(value, key){
			if(value !== undefined) {
				unwrapped[key] = canReflect_1_17_6_canReflect.unwrap(value);
			}
		});
		return unwrapped;
	},
	log: function(key) {
		...
		var meta = canDefine_2_7_0_ensureMeta(instance);
		...
		meta._log = function(event, data) {
			...
			if (type === "add" || type === "remove") {
				dev.log(
					canReflect_1_17_6_canReflect.getName(instance),
...
function assign(source) {
	canQueues_1_1_4_canQueues.batch.start();
	canReflect_1_17_6_canReflect.assignMap(this, source || {});
	canQueues_1_1_4_canQueues.batch.stop();
}
function update(source) {
	canQueues_1_1_4_canQueues.batch.start();
	canReflect_1_17_6_canReflect.updateMap(this, source || {});
	canQueues_1_1_4_canQueues.batch.stop();
}
function assignDeep(source){
	canQueues_1_1_4_canQueues.batch.start();
	// TODO: we should probably just throw an error instead of cleaning
	canReflect_1_17_6_canReflect.assignDeepMap(this, source || {});
	canQueues_1_1_4_canQueues.batch.stop();
}
function updateDeep(source){
	canQueues_1_1_4_canQueues.batch.start();
	// TODO: we should probably just throw an error instead of cleaning
	canReflect_1_17_6_canReflect.updateDeepMap(this, source || {});
	canQueues_1_1_4_canQueues.batch.stop();
}
...
function getKeyValue(key) {
	...
	if(value !== undefined || key in this || Object.isSealed(this)) {
		...
		canObservationRecorder_1_2_0_canObservationRecorder.add(this, key);
		return this[key];
	}
}
...
function getSchema() {
	...
	return canDefine_2_7_0_canDefine.updateSchemaKeys(schema, definitions);
}

var sealedSetup = function(props){
	canDefine_2_7_0_canDefine.setup.call(
		this,
		props || {},
...
var DefineMap = canConstruct_3_5_3_canConstruct.extend("DefineMap",{
	setup: function(base){
		var key,
			prototype = this.prototype;
		if(DefineMap) {
			// we have already created
			var result = canDefine_2_7_0_canDefine(prototype, prototype, base.prototype._define);
				canDefine_2_7_0_canDefine.makeDefineInstanceKey(this, result);

			type$1(this);
			for(key in DefineMap.prototype) {
				canDefine_2_7_0_canDefine.defineConfigurableAndNotEnumerable(prototype, key, prototype[key]);
			}
			// If someone provided their own setup, we call that.
			if(prototype.setup === DefineMap.prototype.setup) {
				canDefine_2_7_0_canDefine.defineConfigurableAndNotEnumerable(prototype, "setup", sealedSetup);
			}
		...
		canDefine_2_7_0_canDefine.defineConfigurableAndNotEnumerable(prototype, "constructor", this);
	...
	get: function(prop){
		if(prop) {
			...
			return canReflect_1_17_6_canReflect.unwrap(this, Map);
		}
	},
	...
	serialize: function () {
		return canReflect_1_17_6_canReflect.serialize(this, Map);
	},
	deleteKey: defineHelpers_1.deleteKey,
	forEach: (function(){

		var forEach = function(list, cb, thisarg){
			return canReflect_1_17_6_canReflect.eachKey(list, cb, thisarg);
		},
			noObserve = canObservationRecorder_1_2_0_canObservationRecorder.ignore(forEach);
	...
	"*": {
		type: canDefine_2_7_0_canDefine.types.observable
	}
});
...
var defineMapProto = {
	...
	"can.getOwnKeys": function() {
		var keys = canReflect_1_17_6_canReflect.getOwnEnumerableKeys(this);
		if(this._computed) {
			var computedKeys = canReflect_1_17_6_canReflect.getOwnKeys(this._computed);
	...
	"can.getOwnEnumerableKeys": function(){
		canObservationRecorder_1_2_0_canObservationRecorder.add(this, 'can.keys');
		canObservationRecorder_1_2_0_canObservationRecorder.add(Object.getPrototypeOf(this), 'can.keys');
...
if(process.env.NODE_ENV !== 'production') {
	defineMapProto["can.getName"] = function() {
		return canReflect_1_17_6_canReflect.getName(this.constructor) + "{}";
	};
}
//!steal-remove-end

canReflect_1_17_6_canReflect.assignSymbols(DefineMap.prototype, defineMapProto);

canReflect_1_17_6_canReflect.setKeyValue(DefineMap.prototype, canSymbol_1_6_1_canSymbol.iterator, function() {
	return new canDefine_2_7_0_canDefine.Iterator(this);
});

// Add necessary event methods to this object.
for(var prop in canDefine_2_7_0_canDefine.eventsProto) {
	DefineMap[prop] = canDefine_2_7_0_canDefine.eventsProto[prop];
	Object.defineProperty(DefineMap.prototype, prop, {
		enumerable:false,
		value: canDefine_2_7_0_canDefine.eventsProto[prop],
		writable: true
	});
}
...
var eventsProtoSymbols = ("getOwnPropertySymbols" in Object) ?
  Object.getOwnPropertySymbols(canDefine_2_7_0_canDefine.eventsProto) :
...
eventsProtoSymbols.forEach(function(sym) {
  Object.defineProperty(DefineMap.prototype, sym, {
  	configurable: true,
    enumerable:false,
    value: canDefine_2_7_0_canDefine.eventsProto[sym],
    writable: true
  });
});
...
if(process.env.NODE_ENV !== 'production') {
	...
	canDefine_2_7_0_canDefine.defineConfigurableAndNotEnumerable(DefineMap.prototype, "log", defineHelpers_1.log);
}
//!steal-remove-end

// tells `can-define` to use this
canDefine_2_7_0_canDefine.DefineMap = DefineMap;
...
function makeIdentityFromMapSchema(typeSchema) {
    if(typeSchema.identity && typeSchema.identity.length) {
        return function identityCheck(a, b) {
            var aId = canReflect_1_17_6_canReflect.getIdentity(a, typeSchema),
                bId = canReflect_1_17_6_canReflect.getIdentity(b, typeSchema);
            return aId === bId;
        };
    } else {
...
function makeIdentityFromListSchema(listSchema) {
    return listSchema.values != null ?
        makeIdentityFromMapSchema( canReflect_1_17_6_canReflect.getSchema(listSchema.values) ) :
        defaultIdentity;
}

function makeIdentity(oldList, oldListLength) {
    var listSchema = canReflect_1_17_6_canReflect.getSchema(oldList),
        typeSchema;
    if(listSchema != null) {
        if(listSchema.values != null) {
            typeSchema = canReflect_1_17_6_canReflect.getSchema(listSchema.values);
        } else {
            return defaultIdentity;
        }
    }
    if(typeSchema == null && oldListLength > 0) {
        typeSchema = canReflect_1_17_6_canReflect.getSchema( canReflect_1_17_6_canReflect.getKeyValue(oldList, 0) );
    }
    if(typeSchema) {
...
var list = function(oldList, newList, schemaOrIdentity){
    var oldIndex = 0,
		newIndex =  0,
		oldLength = canReflect_1_17_6_canReflect.size( oldList ),
		newLength = canReflect_1_17_6_canReflect.size( newList ),
		patches = [];
...
var make$1 = canDefine_2_7_0_canDefine.make;
...
var onKeyValue = canDefine_2_7_0_canDefine.eventsProto[canSymbol_1_6_1_canSymbol.for("can.onKeyValue")];
var offKeyValue = canDefine_2_7_0_canDefine.eventsProto[canSymbol_1_6_1_canSymbol.for("can.offKeyValue")];
...
function getSchema$1() {
	...
	schema = canDefine_2_7_0_canDefine.updateSchemaKeys(schema, definitions);
	if(schema.keys["#"]) {
...
var DefineList = canConstruct_3_5_3_canConstruct.extend("DefineList",
	/** @static */
	{
		setup: function(base) {
			if (DefineList) {
	...
	/** @prototype */
	{
		...
		setup: function(items) {
			...
			canDefine_2_7_0_canDefine.setup.call(this, {}, false);
			...
			if (items) {
				this.splice.apply(this, [ 0, 0 ].concat(canReflect_1_17_6_canReflect.toArray(items)));
			}
		},
		__type: canDefine_2_7_0_canDefine.types.observable,
			...
			if ( !isNaN(index)) {
				...
				if (how === 'add') {
					if (itemsDefinition && typeof itemsDefinition.added === 'function') {
						canObservationRecorder_1_2_0_canObservationRecorder.ignore(itemsDefinition.added).call(this, newVal, index);
					}
					...
					//!steal-remove-start
					if(process.env.NODE_ENV !== 'production') {
						dispatched.reasonLog = [ canReflect_1_17_6_canReflect.getName(this), "added", newVal, "at", index ];
					}
					//!steal-remove-end
					...
					if (itemsDefinition && typeof itemsDefinition.removed === 'function') {
						canObservationRecorder_1_2_0_canObservationRecorder.ignore(itemsDefinition.removed).call(this, oldVal, index);
					}
					...
					//!steal-remove-start
					if(process.env.NODE_ENV !== 'production') {
						dispatched.reasonLog = [ canReflect_1_17_6_canReflect.getName(this), "remove", oldVal, "at", index ];
					}
					//!steal-remove-end
		...
		get: function(index) {
			if (arguments.length) {
				if(isNaN(index)) {
					canObservationRecorder_1_2_0_canObservationRecorder.add(this, index);
				} else {
					canObservationRecorder_1_2_0_canObservationRecorder.add(this, "length");
				}
				return this[index];
			} else {
				return canReflect_1_17_6_canReflect.unwrap(this, Map);
		...
		set: function(prop, value) {
			...
			// otherwise we are setting multiple
				...
				if (canReflect_1_17_6_canReflect.isListLike(prop)) {
					if (value) {
						this.replace(prop);
					} else {
						canReflect_1_17_6_canReflect.assignList(this, prop);
					}
				} else {
					canReflect_1_17_6_canReflect.assignMap(this, prop);
				}
			}
			return this;
		},
		...
		update: function(prop) {
			if (canReflect_1_17_6_canReflect.isListLike(prop)) {
				canReflect_1_17_6_canReflect.updateList(this, prop);
			} else {
				canReflect_1_17_6_canReflect.updateMap(this, prop);
			}
			return this;
		},
		assignDeep: function(prop) {
			if (canReflect_1_17_6_canReflect.isListLike(prop)) {
				canReflect_1_17_6_canReflect.assignDeepList(this, prop);
			} else {
				canReflect_1_17_6_canReflect.assignDeepMap(this, prop);
			}
			return this;
		},
		updateDeep: function(prop) {
			if (canReflect_1_17_6_canReflect.isListLike(prop)) {
				canReflect_1_17_6_canReflect.updateDeepList(this, prop);
			} else {
				canReflect_1_17_6_canReflect.updateDeepMap(this, prop);
			}
			return this;
		},
		_items: function() {
		...
		splice: function(index, howMany) {
			var args = canReflect_1_17_6_canReflect.toArray(arguments),
				added = [],
				i, len, listIndex,
...
for(var prop$1 in canDefine_2_7_0_canDefine.eventsProto) {
	Object.defineProperty(DefineList.prototype, prop$1, {
		enumerable:false,
		value: canDefine_2_7_0_canDefine.eventsProto[prop$1],
		writable: true
	});
}
...
var getArgs = function(args) {
	return args[0] && Array.isArray(args[0]) ?
		args[0] :
		canReflect_1_17_6_canReflect.toArray(args);
};
// Create `push`, `pop`, `shift`, and `unshift`
canReflect_1_17_6_canReflect.eachKey({
	push: "length",
	unshift: 0
},
	// Adds a method
...
canAssign_1_3_1_canAssign(DefineList.prototype, {
	...
	concat: function() {
		...
		canReflect_1_17_6_canReflect.eachIndex(arguments, function(arg) {
			if (canReflect_1_17_6_canReflect.isListLike(arg)) {
				// If it is list-like we want convert to a JS array then
				// pass each item of the array to this.__type
				var arr = Array.isArray(arg) ? arg : canReflect_1_17_6_canReflect.toArray(arg);
		...
		return new this.constructor(Array.prototype.concat.apply(canReflect_1_17_6_canReflect.toArray(this), args));
	},
...
// Add necessary event methods to this object.
for (var prop$1 in canDefine_2_7_0_canDefine.eventsProto) {
	DefineList[prop$1] = canDefine_2_7_0_canDefine.eventsProto[prop$1];
	Object.defineProperty(DefineList.prototype, prop$1, {
		enumerable: false,
		value: canDefine_2_7_0_canDefine.eventsProto[prop$1],
		writable: true
...
var defineListProto = {
		...
		if (isNaN(key)) {
			...
			if(process.env.NODE_ENV !== 'production') {
				Object.defineProperty(translationHandler, "name", {
					value: "translationHandler(" + key + ")::" + canReflect_1_17_6_canReflect.getName(this) + ".onKeyValue('length'," + canReflect_1_17_6_canReflect.getName(handler) + ")",
				});
			}
			//!steal-remove-end
	...
	"can.assignDeep": function(source){
		canQueues_1_1_4_canQueues.batch.start();
		canReflect_1_17_6_canReflect.assignList(this, source);
		canQueues_1_1_4_canQueues.batch.stop();
	},
...
canReflect_1_17_6_canReflect.assignSymbols(DefineList.prototype, defineListProto);

canReflect_1_17_6_canReflect.setKeyValue(DefineList.prototype, canSymbol_1_6_1_canSymbol.iterator, function() {
	var index = -1;
...
canDefine_2_7_0_canDefine.DefineList = DefineList;
...
function setVirtualProp(promise, property, value) {
	...
	canQueues_1_1_4_canQueues.enqueueByQueue(observeData.handlers.getNode([property]), promise, [value,old], function() {
		return {};
...
function setupPromise(value) {
	...
	canReflect_1_17_6_canReflect.assignSymbols(proto, {
...
var peek$3 = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canReflect_1_17_6_canReflect.getKeyValue.bind(canReflect_1_17_6_canReflect));
var observeReader;
...
if (process.env.NODE_ENV !== 'production') {
	bindName = function(source){
		...
		Object.defineProperty(fn, "name", {
			value: canReflect_1_17_6_canReflect.getName(source) + "."+canReflect_1_17_6_canReflect.getName(this)
		});
		return fn;
	};
}
...
var checkForObservableAndNotify = function(options, state, getObserves, value, index){
	if(options.foundObservable && !state.foundObservable) {
		if(canObservationRecorder_1_2_0_canObservationRecorder.trapsCount()) {
			canObservationRecorder_1_2_0_canObservationRecorder.addMany( getObserves() );
...
var objHasKeyAtIndex = function(obj, reads, index) {
	return !!(
		reads && reads.length &&
		canReflect_1_17_6_canReflect.hasKey(obj, reads[index].key)
	);
};
...
observeReader = {
	...
	read: function (parent, reads, options) {
		...
		if(options.foundObservable) {
			getObserves = canObservationRecorder_1_2_0_canObservationRecorder.trap();
		}
	...
	valueReaders: [
		{
			...
			test: function(value){
				return value && canReflect_1_17_6_canReflect.isFunctionLike(value) && !canReflect_1_17_6_canReflect.isConstructorLike(value);
			},
			read: function(value, i, reads, options, state, prev){
				if(options.callMethodsOnObservables && canReflect_1_17_6_canReflect.isObservableLike(prev) && canReflect_1_17_6_canReflect.isMapLike(prev)) {
		...
		},
		{
			...
			read: function(value, i, reads, options){
				...
				return canReflect_1_17_6_canReflect.getValue(value);
			},
	...
	propertyReaders: [
		{
			...
			test: function(value){
				...
				//  special reflections.
				if(canReflect_1_17_6_canReflect.isPromise(value) || typeof value === "object" && value && typeof value.then === "function") {
					canReflectPromise_2_2_0_canReflectPromise(value);
				}

				return canReflect_1_17_6_canReflect.isObservableLike(value) && canReflect_1_17_6_canReflect.isMapLike(value);
			},
			read: function(value, prop){
				var res = canReflect_1_17_6_canReflect.getKeyValue(value, prop.key);
				if(res !== undefined) {
					return res;
				} else {
			...
			write: canReflect_1_17_6_canReflect.setKeyValue
		},
		...
		// read a normal object
		{
			...
			write: function(base, prop, newVal){
				...
				if(newVal != null && typeof newVal === "object" && canReflect_1_17_6_canReflect.isMapLike(propValue) ) {
					dev.warn("can-stache-key: Merging data into \"" + prop + "\" because its parent is non-observable");
					canReflect_1_17_6_canReflect.update(propValue, newVal);
				} else if(propValue != null && propValue[setValueSymbol$1] !== undefined){
					canReflect_1_17_6_canReflect.setValue(propValue, newVal);
				} else {
					base[prop] = newVal;
				}
			}
...
function get(obj, name) {
    ...
    for (i = 0; i < length && canKey_1_2_0_utils.isContainer(current) && current !== null; i++) {
        container = current;
        current = canReflect_1_17_6_canReflect.getKeyValue( container, parts[i] );
    }
 ...
 */
canGlobals_1_2_0_canGlobalsInstance.define('location', function(){
	return canGlobals_1_2_0_canGlobalsInstance.getKeyValue('global').location;
});

var location_1 = canGlobals_1_2_0_canGlobalsInstance.makeExport('location');
...
canGlobals_1_2_0_canGlobalsInstance.define('MutationObserver', function(){
	var GLOBAL = canGlobals_1_2_0_canGlobalsInstance.getKeyValue('global');
	return GLOBAL.MutationObserver || GLOBAL.WebKitMutationObserver || GLOBAL.MozMutationObserver;
});

var mutationObserver = canGlobals_1_2_0_canGlobalsInstance.makeExport('MutationObserver');
...
canGlobals_1_2_0_canGlobalsInstance.define('customElements', function(){
	var GLOBAL = canGlobals_1_2_0_canGlobalsInstance.getKeyValue('global');
	return GLOBAL.customElements;
});

var customElements = canGlobals_1_2_0_canGlobalsInstance.makeExport('customElements');

var canGlobals_1_2_0_canGlobals = canGlobals_1_2_0_canGlobalsInstance;
...
function getNodesWithTreeWalker(rootNode) {
	...
	var walker = document$1().createTreeWalker(
		rootNode,
...
var eliminate$1 = canDomMutate_1_3_0_Util.eliminate;
var subscription$1 = canDomMutate_1_3_0_Util.subscription;
var isDocumentElement$1 = canDomMutate_1_3_0_Util.isDocumentElement;
var getAllNodes$1 = canDomMutate_1_3_0_Util.getAllNodes;
...
function observeMutations(target, observerKey, config, handler) {
	...
	if (observerData.observingCount === 0) {
		canGlobals_1_2_0_canGlobals.onKeyValue('MutationObserver', setupObserver);
		setupObserver();
	}
	...
	return function stopObservingMutations() {
		...
		if (observerData) {
			...
			if (observerData.observingCount <= 0) {
				...
				canGlobals_1_2_0_canGlobals.offKeyValue('MutationObserver', setupObserver);
			}
		}
	};
}
...
function handleTreeMutations(mutations) {
	...
	for (var m = 0; m < mutationCount; m++) {
		...
		for (var a = 0; a < addedCount; a++) {
			canDomMutate_1_3_0_Util.addToSet( getAllNodes$1(mutation.addedNodes[a]), added);
		}

		var removedCount = mutation.removedNodes.length;
		for (var r = 0; r < removedCount; r++) {
			canDomMutate_1_3_0_Util.addToSet( getAllNodes$1(mutation.removedNodes[r]), removed);
		}
	}
...
domMutate = {
	...
	*/
	dispatchNodeInsertion: function (node, callback) {
		var nodes = new Set();
		canDomMutate_1_3_0_Util.addToSet( getAllNodes$1(node), nodes);
...
var canDomMutate_1_3_0_canDomMutate = canNamespace_1_0_0_canNamespace.domMutate = domMutate;
...
var controlsSymbol = canSymbol_1_6_1_canSymbol.for("can.controls");
...
var Control = canConstruct_3_5_3_canConstruct.extend("Control",
	// ## *static functions*
	/**
	 * @static
	 */
	{
		...
		setup: function () {
			canConstruct_3_5_3_canConstruct.setup.apply(this, arguments);
      ...
      if(process.env.NODE_ENV !== 'production') {
	      Object.defineProperty(controlMethod, "name", {
	      	value: canReflect_1_17_6_canReflect.getName(this) + "["+name+"]",
	      });
	     }
      //!steal-remove-end
      return controlMethod;
			...
			if (options || !paramReplacer.test(methodName)) {
                var controlActionData = function() {
					...
					var name = methodName.replace(paramReplacer, function(matched, key) {
						...
						if (!parent || !(canReflect_1_17_6_canReflect.isObservableLike(parent) && canReflect_1_17_6_canReflect.isMapLike(parent)) && !value) {
                            unableToBind = true;
							return null;
						}
        ...
        if(process.env.NODE_ENV !== 'production') {
		    	Object.defineProperty(controlActionData, "name", {
		      	value: canReflect_1_17_6_canReflect.getName(controlInstance || this.prototype) + "["+methodName+"].actionData",
		      });
	      }
        //!steal-remove-end

				readyCompute = new canObservation_4_1_1_canObservation(controlActionData, this);
          ...
          if(process.env.NODE_ENV !== 'production') {
          	Object.defineProperty(handler, "name", {
            	value: canReflect_1_17_6_canReflect.getName(controlInstance) + "["+methodName+"].handler",
            });
          }
					//!steal-remove-end


					canReflect_1_17_6_canReflect.onValue(readyCompute, handler, "mutate");
          //!steal-remove-start
          if(process.env.NODE_ENV !== 'production') {
	          if(unableToBind) {
		...
		setup: function (element, options) {
			...
			if (canReflect_1_17_6_canReflect.isObservableLike(options) && canReflect_1_17_6_canReflect.isMapLike(options)) {
		...
		on: function (el, selector, eventName, func) {
			if (!el) {
				...
				var removalDisposal = canDomMutate_1_3_0_canDomMutate.onNodeRemoval(element, function () {
		...
		off: function () {
			...
			if( bindings ) {
				...
				canReflect_1_17_6_canReflect.eachKey(bindings.control || {}, function (value) {
					value(el);
				});
				canReflect_1_17_6_canReflect.eachKey(bindings.readyComputes || {}, function(value) {
					canReflect_1_17_6_canReflect.offValue(value.compute, value.handler, "mutate");
				});
			}
			// Adds bindings.
...
var canControl_4_4_0_canControl = canNamespace_1_0_0_canNamespace.Control = Control;

// ## Helpers
// Attribute names to ignore for setting viewModel values.
var paramReplacer$1 = /\{([^\}]+)\}/g;

var ComponentControl = canControl_4_4_0_canControl.extend({
		// the lookup path - where templated keys will be looked up
		...
		_action: function(methodName, options, controlInstance) {
			...
			if (!controlInstance && hasObjectLookup) {
				...
				return canControl_4_4_0_canControl._action.apply(this, arguments);
			}
		}
	},
	...
	// rebinds all templated event handlers.
	{
		setup: function(el, options) {
			...
			return canControl_4_4_0_canControl.prototype.setup.call(this, el, options);
		},
		off: function() {
			...
			if (this._bindings) {
				canReflect_1_17_6_canReflect.eachKey(this._bindings.readyComputes || {}, function(value) {
					canReflect_1_17_6_canReflect.offValue(value.compute, value.handler);
				});
			}
			// Call `Control.prototype.off` function on this instance to cleanup the bindings.
			canControl_4_4_0_canControl.prototype.off.apply(this, arguments);
			this._bindings.readyComputes = {};
		},
		destroy: function() {
			canControl_4_4_0_canControl.prototype.destroy.apply(this, arguments);
...
var addMutatedBy = function(mutatedByMap) {
	return function addMutatedBy(mutated, key, mutator) {
		...
		if (mutator.valueDependencies) {
			canReflect_1_17_6_canReflect.addValues(
		...
		if (mutator.keyDependencies) {
			canReflect_1_17_6_canReflect.each(mutator.keyDependencies, function(keysSet, obj) {
				...
				canReflect_1_17_6_canReflect.addValues(entry, keysSet);
			});
		}
	};
};
...
var deleteMutatedBy = function(mutatedByMap) {
	return function deleteMutatedBy(mutated, key, mutator) {
		...
		if (mutator.valueDependencies) {
			canReflect_1_17_6_canReflect.removeValues(
				dependencyRecord.valueDependencies,
				mutator.valueDependencies
			);
		}
		...
		if (mutator.keyDependencies) {
			canReflect_1_17_6_canReflect.each(mutator.keyDependencies, function(keysSet, obj) {
				...
				if (entry) {
					canReflect_1_17_6_canReflect.removeValues(entry, keysSet);
					if (!entry.size) {
...
var getKeyDependencies = function getKeyDependencies(obj, key) {
	if (isFunction(obj[getKeyDependenciesSymbol])) {
		return canReflect_1_17_6_canReflect.getKeyDependencies(obj, key);
	}
};

var getValueDependencies = function getValueDependencies(obj) {
	if (isFunction(obj[getValueDependenciesSymbol$1])) {
		return canReflect_1_17_6_canReflect.getValueDependencies(obj);
	}
};
...
var getWhatIChange = function getWhatIChange(obj, key) {
	if (isFunction(obj[getWhatIChangeSymbol])) {
		...
		return gotKey ?
			canReflect_1_17_6_canReflect.getWhatIChange(obj, key) :
			canReflect_1_17_6_canReflect.getWhatIChange(obj);
	}
};
...
// Symbols
var getChangesSymbol$2 = canSymbol_1_6_1_canSymbol.for("can.getChangesDependencyRecord");
var getValueSymbol$2 = canSymbol_1_6_1_canSymbol.for("can.getValue");
...
function defaultSetValue(newValue, observable) {
	canReflect_1_17_6_canReflect.setValue(observable, newValue);
}
...
function turnOffListeningAndUpdate(listenToObservable, updateObservable, updateFunction, queue) {
	if (listenToObservable[onValueSymbol$2]) {
		canReflect_1_17_6_canReflect.offValue(listenToObservable, updateFunction, queue);
...
function turnOnListeningAndUpdate(listenToObservable, updateObservable, updateFunction, queue) {
	if (listenToObservable[onValueSymbol$2]) {
		canReflect_1_17_6_canReflect.onValue(listenToObservable, updateFunction, queue);
...
function Bind(options) {
	...
	if (options.priority !== undefined) {
		canReflect_1_17_6_canReflect.setPriority(options.child, options.priority);
		canReflect_1_17_6_canReflect.setPriority(options.parent, options.priority);
	}
...
Object.defineProperty(Bind.prototype, "parentValue", {
	get: function() {
		return canReflect_1_17_6_canReflect.getValue(this._options.parent);
	}
});
...
canAssign_1_3_1_canAssign(Bind.prototype, {
	...
	start: function() {
		...
		if (this._childToParent === true && this._parentToChild === true) {
			// Two-way binding
			parentValue = canReflect_1_17_6_canReflect.getValue(options.parent);
			if (parentValue === undefined) {
				childValue = canReflect_1_17_6_canReflect.getValue(options.child);
...
function updateValue(args) {
	...
	if ((semaphore.value + args.partnerSemaphore.value) <= args.allowedUpdates) {
		...
		canQueues_1_1_4_canQueues.mutateQueue.enqueue(semaphore.decrement, semaphore, []);
		...
		if (args.sticky) {
			var observableValue = canReflect_1_17_6_canReflect.getValue(args.observable);
			if (observableValue !== canReflect_1_17_6_canReflect.getValue(args.partner)) {
		...
		//!steal-remove-start
		if(process.env.NODE_ENV !== 'production'){
			var currentValue = canReflect_1_17_6_canReflect.getValue(args.observable);
			if (currentValue !== args.newValue) {
				var warningParts = [
					"can-bind updateValue: attempting to update " + args.debugObservableName + " " + canReflect_1_17_6_canReflect.getName(args.observable) + " to new value: %o",
...
var canBind_1_0_1_canBind = canNamespace_1_0_0_canNamespace.Bind = Bind;

var canAttributeEncoder_1_1_0_canAttributeEncoder = createCommonjsModule(function (module) {
...
var callAttrStart = function(state, curIndex, handler, rest, lineNo){
	var attrName = rest.substring(typeof state.nameStart === "number" ? state.nameStart : curIndex, curIndex),
		newAttrName = canAttributeEncoder_1_1_0_canAttributeEncoder.encode(attrName);
...
var isInDocument$1 = canDomMutate_1_3_0_Util.isInDocument;
var getParents$1 = canDomMutate_1_3_0_Util.getParents;

var synthetic = {
	dispatchNodeInsertion: function (container, node) {
		if (isInDocument$1(node)) {
			canDomMutate_1_3_0_canDomMutate.dispatchNodeInsertion(node);
		}
	},
	dispatchNodeRemoval: function (container, node) {
		if (isInDocument$1(container) && !isInDocument$1(node)) {
			canDomMutate_1_3_0_canDomMutate.dispatchNodeRemoval(node);
		}
	}
};
...
var compat = {
	...
	setAttribute: function (name, value) {
		...
		if (oldAttributeValue !== newAttributeValue) {
			canDomMutate_1_3_0_canDomMutate.dispatchNodeAttributeChange(this, name, oldAttributeValue);
		}
		return result;
	},
...
setMutateStrategy(canGlobals_1_2_0_canGlobals.getKeyValue(mutationObserverKey));
canGlobals_1_2_0_canGlobals.onKeyValue(mutationObserverKey, setMutateStrategy);

var canDomMutate_1_3_0_node = canNamespace_1_0_0_canNamespace.domMutateNode = canDomMutate_1_3_0_canDomMutate.node = mutate;
...
var nodeLists = {
	...
	*/
	...
	after: function (oldElements, newFrag) {
		...
		if (last.nextSibling) {
			canDomMutate_1_3_0_node.insertBefore.call(last.parentNode, newFrag, last.nextSibling);
		} else {
			canDomMutate_1_3_0_node.appendChild.call(last.parentNode, newFrag );
		}
	},
	/**
	...
	replace: function (oldElements, newFrag) {
		...
		if(oldElements.length === 1) {
			canDomMutate_1_3_0_node.replaceChild.call(parentNode, newFrag, oldElements[0]);
		} else {
	...
	remove: function(elementsToBeRemoved){
		...
		for (var i = 0; i < elementsToBeRemoved.length; i++) {
			canDomMutate_1_3_0_node.removeChild.call(parent, elementsToBeRemoved[i]);
		}
	},
	nodeMap: nodeMap
};
var canViewNodelist_4_3_2_canViewNodelist = canNamespace_1_0_0_canNamespace.nodeLists = nodeLists;
...
var fragmentRE = /^\s*<(\w+)[^>]*>/,
	toString$1 = {}.toString,
	toDOMSymbol = canSymbol_1_6_1_canSymbol.for("can.toDOM");
...
var makeFrag = function(item, doc) {
	...
	if (!item || typeof item === "string") {
		...
		return frag;
	} else if (canReflect_1_17_6_canReflect.isListLike(item)) {
		frag = document.createDocumentFragment();
		canReflect_1_17_6_canReflect.eachIndex(item, function(item) {
...
var canViewCallbacks_4_3_1_canViewCallbacks = createCommonjsModule(function (module) {
...
var callbackMapSymbol = canSymbol_1_6_1_canSymbol.for('can.callbackMap');
...
var automountEnabled = function(){
	var document = canGlobals_1_2_0_canGlobals.getKeyValue("document");
...
var enableMutationObserver = function() {
	...
	var MutationObserver = canGlobals_1_2_0_canGlobals.getKeyValue("MutationObserver");
	if(MutationObserver) {
...
var attrs = function(attrMap) {
	var map = canReflect_1_17_6_canReflect.getKeyValue(attrMap, callbackMapSymbol) || attrMap;
	...
	canReflect_1_17_6_canReflect.eachKey(map, function(callback, exp){
		attr(exp, callback);
	});
};
...
var tag = function (tagName, tagHandler) {
	if(tagHandler) {
		...
		if(automountEnabled()) {
			var customElements = canGlobals_1_2_0_canGlobals.getKeyValue("customElements");
...
var callbacks = {
	...
	tagHandler: function(el, tagName, tagData){
		...
		if(tagCallback) {
			res = canObservationRecorder_1_2_0_canObservationRecorder.ignore(tagCallback)(el, tagData);
		...
		if (res && tagData.subtemplate) {
			...
			var nodeList = canViewNodelist_4_3_2_canViewNodelist.register([], undefined, tagData.parentNodeList || true, false);
			...
			canDomMutate_1_3_0_node.appendChild.call(el, frag);
		}
	}
};
		...
		if(node.attributes) {
			...
			for (var i = 0; i < attributes.length; i++) {
				...
				if (attribute && attribute.specified) {
					canDomMutate_1_3_0_node.setAttribute.call(copy, attribute.nodeName || attribute.name, attribute.nodeValue || attribute.value);
				}
			}
		}
			...
			if(node.attrs) {
				for(var attrName in node.attrs) {
					...
					if(typeof value === "function"){
						...
						canDomMutate_1_3_0_node.setAttribute.call(el, attrName, value);
					}
				}
			}
			if(node.attributes) {
		...
		if(keepsTextNodes) {
			...
			getCallback().callbacks.push({
				callback: function(){
					...
					canDomMutate_1_3_0_node.replaceChild.call(this.parentNode, el, this);
...
canNamespace_1_0_0_canNamespace.view = canNamespace_1_0_0_canNamespace.view || {};
var canViewTarget_4_1_0_canViewTarget = canNamespace_1_0_0_canNamespace.view.target = makeTarget;
...
var SimpleMap = canConstruct_3_5_3_canConstruct.extend("SimpleMap",
	{
		// ### setup
		...
		attr: function(prop, value) {
			...
			if(arguments.length === 0 ) {
				canObservationRecorder_1_2_0_canObservationRecorder.add(this,"can.keys");
				var data = {};
				canReflect_1_17_6_canReflect.eachKey(this._data, function(value, prop){
					canObservationRecorder_1_2_0_canObservationRecorder.add(this, prop);
					data[prop] = value;
				}, this);
				return data;
				...
				if(old !== value) {
					...
					if (process.env.NODE_ENV !== 'production') {
						dispatched = {
							keyChanged: !had ? prop : undefined,
							type: prop,
							reasonLog: [ canReflect_1_17_6_canReflect.getName(this) + "'s", prop, "changed to", value, "from", old ],
						};
					}
					//!steal-remove-end
			...
			// 1 argument
				...
				canQueues_1_1_4_canQueues.batch.start();
				canReflect_1_17_6_canReflect.eachKey(prop, function(value, key) {
					self.attr(key, value);
				});
				canQueues_1_1_4_canQueues.batch.stop();
			}
		...
		if( this._data.hasOwnProperty(prop) ) {
			...
			if (process.env.NODE_ENV !== 'production') {
				dispatched = {
					keyChanged: prop,
					type: prop,
					reasonLog: [ canReflect_1_17_6_canReflect.getName(this) + "'s", prop, "deleted", old ]
				};
			}
			//!steal-remove-end
...
//!steal-remove-end
canReflect_1_17_6_canReflect.assignSymbols(SimpleMap.prototype,simpleMapProto);
...
var canViewScope_4_11_0_templateContext = TemplateContext;

var Compute = function(newVal){
	if(arguments.length) {
		return canReflect_1_17_6_canReflect.setValue(this, newVal);
	} else {
		return canReflect_1_17_6_canReflect.getValue(this);
	}
};

var canViewScope_4_11_0_makeComputeLike = function(observable) {
    var compute = Compute.bind(observable);

	//!steal-remove-start
	if (process.env.NODE_ENV !== 'production') {
		Object.defineProperty(compute, "name", {
			value: "Compute<"+canReflect_1_17_6_canReflect.getName(observable) + ">",
		});
	}
	//!steal-remove-end
    ...
    canReflect_1_17_6_canReflect.assignSymbols(compute, {
        "can.getValue": function(){
            return canReflect_1_17_6_canReflect.getValue(observable);
        },
        "can.setValue": function(newVal){
            return canReflect_1_17_6_canReflect.setValue(observable, newVal);
        },
        "can.onValue": function(handler, queue){
            return canReflect_1_17_6_canReflect.onValue(observable, handler, queue);
        },
        "can.offValue": function(handler, queue){
            return canReflect_1_17_6_canReflect.offValue(observable, handler, queue);
        },
        "can.valueHasDependencies": function(){
            return canReflect_1_17_6_canReflect.valueHasDependencies(observable);
        },
        "can.getPriority": function(){
    		return canReflect_1_17_6_canReflect.getPriority( observable );
    	},
    	"can.setPriority": function(newPriority){
    		canReflect_1_17_6_canReflect.setPriority( observable, newPriority );
    	},
		"can.isValueLike": true,
...
var peekValue = canObservationRecorder_1_2_0_canObservationRecorder.ignore(canReflect_1_17_6_canReflect.getValue.bind(canReflect_1_17_6_canReflect));

var getFastPathRoot = canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(computeData){
	if( computeData.reads &&
				// a single property read
				computeData.reads.length === 1 ) {
		var root = computeData.root;
		if( root && root[canSymbol_1_6_1_canSymbol.for("can.getValue")] ) {
			root = canReflect_1_17_6_canReflect.getValue(root);
		}
		// on a map
		return root && canReflect_1_17_6_canReflect.isObservableLike(root) && canReflect_1_17_6_canReflect.isMapLike(root) &&
...
var ScopeKeyData = function(scope, key, options){
	...
	if (process.env.NODE_ENV !== 'production') {
		Object.defineProperty(this.read, "name", {
			value: canReflect_1_17_6_canReflect.getName(this) + ".read",
		});
		Object.defineProperty(this.dispatch, "name", {
			value: canReflect_1_17_6_canReflect.getName(this) + ".dispatch",
		});
	}
	//!steal-remove-end

	var observation = this.observation = new canObservation_4_1_1_canObservation(this.read, this);
	...
	this._thisArg = new canSimpleObservable_2_4_0_canSimpleObservable();
...
canAssign_1_3_1_canAssign(ScopeKeyData.prototype, {
	...
	onBound: function onBound(){
		this.bound = true;
		canReflect_1_17_6_canReflect.onValue(this.observation, this.dispatch, "notify");
	...
	onUnbound: function onUnbound() {
		this.bound = false;
		canReflect_1_17_6_canReflect.offValue(this.observation, this.dispatch, "notify");
		this.toSlowPath();
	},
	set: function(newVal){
		...
		if(root) {
			if(this.reads.length) {
				...
				canReflect_1_17_6_canReflect.setValue(root,newVal);
			}
		} else {
	...
	get: function() {
		if (canObservationRecorder_1_2_0_canObservationRecorder.isRecording()) {
			canObservationRecorder_1_2_0_canObservationRecorder.add(this);
			if (!this.bound) {
				canObservation_4_1_1_canObservation.temporarilyBind(this);
			}
		}
	...
	toFastPath: function(fastPathRoot){
		...
		observation.dependencyChange = function(target, newVal){
			...
			return canObservation_4_1_1_canObservation.prototype.dependencyChange.apply(this, arguments);
		};
	...
	toSlowPath: function(){
		this.observation.dependencyChange = canObservation_4_1_1_canObservation.prototype.dependencyChange;
		this.observation.onBound = canObservation_4_1_1_canObservation.prototype.onBound;
		this.fastPath = false;
	},
	read: function(){
		var data;
		...
		if (this.root) {
			...
			if (process.env.NODE_ENV !== 'production') {
				...
				if(this.reads.length) {
					callMutateWithRightArgs(canReflectDependencies_1_1_1_canReflectDependencies.deleteMutatedBy, peekValue(this._thisArg) || this.root, this.reads,this);
				}
		...
		if (process.env.NODE_ENV !== 'production') {
			if (data.rootObserve) {
				...
				callMutateWithRightArgs(canReflectDependencies_1_1_1_canReflectDependencies.addMutatedBy, data.thisArg || data.rootObserve, data.reads,{
...
if (process.env.NODE_ENV !== 'production') {
	scopeKeyDataPrototype["can.getName"] = function() {
		return canReflect_1_17_6_canReflect.getName(this.constructor) + "{{" + this.key + "}}";
	};
}
//!steal-remove-end
canReflect_1_17_6_canReflect.assignSymbols(ScopeKeyData.prototype, scopeKeyDataPrototype);

// Creates a compute-like for legacy reasons ...
Object.defineProperty(ScopeKeyData.prototype, "compute", {
	get: function(){
		var compute = canViewScope_4_11_0_makeComputeLike(this);
...
var canViewScope_4_11_0_scopeKeyData = ScopeKeyData;

var canViewScope_4_11_0_compute_data = function(scope, key, options){
	return new canViewScope_4_11_0_scopeKeyData(scope, key, options || {
		args: []
	});
};
...
canAssign_1_3_1_canAssign(Scope, {
	...
	TemplateContext: canViewScope_4_11_0_templateContext,
	// ### keyInfo(key)
	...
	isTemplateContextOrCanNotHaveProperties: function(currentScope){
		...
		if(currentContext instanceof canViewScope_4_11_0_templateContext) {
			return true;
...
canAssign_1_3_1_canAssign(Scope.prototype, {
	...
	_walk: function(keyReads, options, howToRead) {
			...
			readOptions = canAssign_1_3_1_canAssign({
				...
				earlyExit: function(parentValue, nameIndex) {
					...
					if(isVariableScope === true && nameIndex === 0) {
						...
						updateSetObservable = canReflect_1_17_6_canReflect.hasKey( parentValue, keyReads[nameIndex].key);
					} else {
						updateSetObservable =
							// Has more matches
							nameIndex > setObserveDepth ||
							// The same number of matches but it has the key
							nameIndex === setObserveDepth && (typeof parentValue === "object" && canReflect_1_17_6_canReflect.hasOwnKey( parentValue, keyReads[nameIndex].key));
					}
		...
		var isRecording = canObservationRecorder_1_2_0_canObservationRecorder.isRecording(),
			readAContext = false;
		...
		while (currentScope) {
			...
			var getObserves = canObservationRecorder_1_2_0_canObservationRecorder.trap();
			...
			if (data.value !== undefined || data.parentHasKey) {
				...
				if(!observes.length && isRecording) {
					...
					canObservationRecorder_1_2_0_canObservationRecorder.addMany(observes);
				}
		...
		canObservationRecorder_1_2_0_canObservationRecorder.addMany(undefinedObserves);
		return {
	...
	getDataForScopeSet: function getDataForScopeSet(key, options) {
		...
		var opts = canAssign_1_3_1_canAssign({
			...
			read: function(context, keys){
				...
				if(keys.length > 1) {
					...
					if( parent != null && canReflect_1_17_6_canReflect.hasKey(parent, keys[keys.length-1].key ) ) {
						return {
							parent: parent,
							parentHasKey: true,
							value: undefined
				...
				// If we have only one key, try to find a context with this key
					...
					if( canReflect_1_17_6_canReflect.hasKey(context, keys[0].key ) ) {
						return {
							parent: context,
							parentHasKey: true,
							value: undefined
		...
		if(!canReflect_1_17_6_canReflect.isObservableLike(parent) && canReflect_1_17_6_canReflect.isObservableLike(parent[propName])) {
			if(canReflect_1_17_6_canReflect.isMapLike(parent[propName])) {
				return {
					parent: parent,
					key: propName,
					how: "updateDeep",
			...
			else if(canReflect_1_17_6_canReflect.isValueLike(parent[propName])){
	...
	getHelperOrPartial: function(keyReads) {
		...
		while (scope) {
			...
			if (context instanceof canViewScope_4_11_0_templateContext) {
	...
	peek: canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(key, options) {
		return this.get(key, options);
	}),
	// TODO: Remove in 6.0
	peak: canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(key, options) {
		//!steal-remove-start
		if (process.env.NODE_ENV !== 'production') {
	...
	getTemplateContext: function() {
		...
		var templateContext = this.getScope(function(scope) {
			lastScope = scope;
			return scope._context instanceof canViewScope_4_11_0_templateContext;
		});

		// if there is no reference scope, add one as the root
		if(!templateContext) {
			templateContext = new Scope(new canViewScope_4_11_0_templateContext());
	...
	addTemplateContext: function(){
		return this.add(new canViewScope_4_11_0_templateContext());
	},
	...
	getRoot: function() {
		...
		if (cur._context instanceof canViewScope_4_11_0_templateContext) {
			cur = child;
		}
		return cur._context;
	},
	...
	getPathsForKey: function getPathsForKey(key) {
		//!steal-remove-start
			...
			var getKeyDefinition = function(obj, key) {
				...
				var objHasKey = canReflect_1_17_6_canReflect.hasKey(obj, key);
	...
	set: function(key, value, options) {
		...
		switch (data.how) {
			...
			case "setValue":
				canReflect_1_17_6_canReflect.setValue("key" in data ? parent[data.key] : parent, value);
				break;

			case "setKeyValue":
				canReflect_1_17_6_canReflect.setKeyValue(parent, data.key, value);
				break;

			case "updateDeep":
				canReflect_1_17_6_canReflect.updateDeep(parent[data.key], value);
				break;
		}
	},
	...
	attr: canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(key, value, options) {
	...
	computeData: function(key, options) {
		return canViewScope_4_11_0_compute_data(this, key, options);
	},
	...
	isSpecial: function(){
		return this._meta.notContext || this._meta.special || (this._context instanceof canViewScope_4_11_0_templateContext) || this._meta.variable;
	}
});
// Legacy name for _walk.
Scope.prototype._read = Scope.prototype._walk;

canReflect_1_17_6_canReflect.assignSymbols(Scope.prototype, {
...
if (process.env.NODE_ENV !== 'production') {
	Scope.prototype.log = function() {
		...
		while(scope) {
			...
			console.log(indent, canReflect_1_17_6_canReflect.getName(scope._context) + contextType, scope._context);
	        scope = scope._parent;
	        indent += " ";
	    }
	};
...
canNamespace_1_0_0_canNamespace.view = canNamespace_1_0_0_canNamespace.view || {};
var canViewScope_4_11_0_canViewScope = canNamespace_1_0_0_canNamespace.view.Scope = Scope;
...
var isViewSymbol = canSymbol_1_6_1_canSymbol.for("can.isView");
...
var utils$1 = {
	...
	makeRendererConvertScopes: function (renderer, parentScope, nodeList, observeObservables, metadata) {
		var convertedRenderer = function (newScope, newOptions, parentNodeList) {
			...
			if (newScope !== undefined && !(newScope instanceof canViewScope_4_11_0_canViewScope)) {
				if (parentScope) {
					newScope = parentScope.add(newScope);
				}
				else {
					newScope = new canViewScope_4_11_0_canViewScope(newScope || {});
				}
			}
			if (metadata) {
				metadata.rendered = true;
		...
		return observeObservables ? convertedRenderer :
			canObservationRecorder_1_2_0_canObservationRecorder.ignore(convertedRenderer);
	},
	makeView: function(renderer){
		var view = canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(scope, nodeList){
			if(!(scope instanceof canViewScope_4_11_0_canViewScope)) {
				scope = new canViewScope_4_11_0_canViewScope(scope);
			}
	...
	getItemsStringContent: function(items, isObserveList, helperOptions){
		var txt = "",
			...
			isObservable = canReflect_1_17_6_canReflect.isObservableLike(items);
	...
	getItemsFragContent: function(items, helperOptions, scope) {
		...
		// Check if using hash
		if (canReflect_1_17_6_canReflect.size(hashExprs) > 0) {
			hashOptions = {};
			canReflect_1_17_6_canReflect.eachKey(hashExprs, function (exprs, key) {
		...
		for (var i = 0; i < len; i++) {
			...
			if (canReflect_1_17_6_canReflect.size(hashOptions) > 0) {
...
canAssign_1_3_1_canAssign(HTMLSection.prototype,{
	...
	compile: function(){
		this.compiled = canViewTarget_4_1_0_canViewTarget(this.targetData, document$1());
		if(this.inverseData) {
			this.inverseCompiled = canViewTarget_4_1_0_canViewTarget(this.inverseData, document$1());
...
var live = {
	setup: function(el, bind, unbind) {
		...
		removalDisposal = canDomMutate_1_3_0_canDomMutate.onNodeRemoval(el, function () {
	...
	listen: function(el, compute, change, queueName) {
		return live.setup(
			...
			function bind() {
				...
				canReflect_1_17_6_canReflect.onValue(compute, change, queueName || "notify");
			...
			function unbind(data) {
				canReflect_1_17_6_canReflect.offValue(compute, change, queueName || "notify");
				...
				if (data.nodeList) {
					canViewNodelist_4_3_2_canViewNodelist.unregister(data.nodeList);
				}
			}
		);
	},
	...
	replace: function(nodes, val, teardown) {
		...
		canViewNodelist_4_3_2_canViewNodelist.register(nodes, teardown);
		// Mark each node as belonging to the node list.
		canViewNodelist_4_3_2_canViewNodelist.update(nodes, canChildNodes_1_2_0_canChildNodes(frag));
		// Replace old nodes with new on the DOM
		canViewNodelist_4_3_2_canViewNodelist.replace(oldNodes, frag);
		return nodes;
	},
	// #### getParentNode
...
var canDomDataState_1_0_2_canDomDataState = createCommonjsModule(function (module) {
...
var setData = function(name, value) {
	...
	if (name !== undefined) {
		...
		if (isNode && !removedDisposalMap[id]) {
			var target = this;
			removedDisposalMap[id] = canDomMutate_1_3_0_canDomMutate.onNodeRemoval(target, function () {
...
var formElements = {"INPUT": true, "TEXTAREA": true, "SELECT": true},
		...
		return {
			...
			set: function(value){
				if(prop in this) {
					...
					canDomMutate_1_3_0_node.setAttribute.call(this, prop, "");
				}
			},
			remove: function(){
				this[prop] = false;
	...
	setupMO = function(el, callback){
		var attrMO = canDomDataState_1_0_2_canDomDataState.get.call(el, "attrMO");
		if(!attrMO) {
			...
			if(MO) {
				...
				canDomDataState_1_0_2_canDomDataState.set.call(el, "attrMO", observer);
			} else {
				canDomDataState_1_0_2_canDomDataState.set.call(el, "attrMO", true);
				canDomDataState_1_0_2_canDomDataState.set.call(el, "canBindingCallback", {onMutation: onMutation});
			}
		}
	},
	...
	setChildOptionsOnChange = function(select, aEL){
		var handler = canDomDataState_1_0_2_canDomDataState.get.call(select, "attrSetChildOptions");
		if(handler) {
			return Function.prototype;
		}
		handler = function(){
		...
		canDomDataState_1_0_2_canDomDataState.set.call(select, "attrSetChildOptions", handler);
		aEL.call(select, "change", handler);
		return function(rEL){
			canDomDataState_1_0_2_canDomDataState.clean.call(select, "attrSetChildOptions");
...
var specialAttributes = {
	...
	"class": {
		...
		set: function(val){
			...
			if(isSVG(this)) {
				canDomMutate_1_3_0_node.setAttribute.call(this, "class", "" + val);
			} else {
				this.className = val;
			}
		}
		...
		set: function(val){
			...
			if (cur !== val) {
				if (!docEl.contains(element)) {
					var insertionDisposal = canDomMutate_1_3_0_canDomMutate.onNodeInsertion(element, function () {
						insertionDisposal();
						focusTask();
					});
				} else {
	...
	innerHTML: propProp("innerHTML", {
		addEventListener: function(eventName, handler, aEL){
			...
			["change", "blur"].forEach(function(eventName){
				...
				canDomEvents_1_3_2_canDomEvents.addEventListener(el, eventName, localHandler);
	...
	selected: {
		...
		set: function(val){
			val = !!val;
			canDomDataState_1_0_2_canDomDataState.set.call(this, "lastSetValue", val);
			this.selected = val;
		},
		addEventListener: function(eventName, handler, aEL){
			var option = this;
			...
			var localHandler = function(changeEvent){
				...
				lastVal = canDomDataState_1_0_2_canDomDataState.get.call(option, "lastSetValue") || lastVal;
				if(curVal !== lastVal) {
					lastVal = curVal;

					canDomEvents_1_3_2_canDomEvents.dispatch(option, eventName);
				}
			};

			var removeChangeHandler = setChildOptionsOnChange(select, aEL);
			canDomEvents_1_3_2_canDomEvents.addEventListener(select, "change", localHandler);
			aEL.call(option, eventName, handler);

			return function(rEL){
				removeChangeHandler(rEL);
				canDomEvents_1_3_2_canDomEvents.removeEventListener(select, "change", localHandler);
	...
	style: {
		set: (function () {
			...
			if ( el && el.style && ("cssText" in el.style) ) {
				...
				return function (val) {
					canDomMutate_1_3_0_node.setAttribute.call(this, "style", val);
				};
			}
		})()
	},
	...
	value: {
		...
		set: function(value){
			...
			if(nodeName === "select") {
				canDomDataState_1_0_2_canDomDataState.set.call(this, "attrValueLastVal", value);
				...
				if(!docEl.contains(this)) {
					var select = this;
					var insertionDisposal = canDomMutate_1_3_0_canDomMutate.onNodeInsertion(select, function () {
						insertionDisposal();
				...
				setupMO(this, function(){
					var value = canDomDataState_1_0_2_canDomDataState.get.call(this, "attrValueLastVal");
					attr.set(this, "value", value);
					canDomEvents_1_3_2_canDomEvents.dispatch(this, "change");
				});
			}
		},
		test: function(){
	...
	values: {
		...
		set: function(values){
			...
			// store new DOM state
			canDomDataState_1_0_2_canDomDataState.set.call(this, "stickyValues", attr.get(this,"values") );
			...
			setupMO(this, function(){
				...
				var previousValues = canDomDataState_1_0_2_canDomDataState.get.call(this,
					"stickyValues");
				...
				var currentValues = canDomDataState_1_0_2_canDomDataState.get.call(this,
					"stickyValues");
				...
				if (changes.length) {
					canDomEvents_1_3_2_canDomEvents.dispatch(this, "values");
				}
			});
		},
		addEventListener: function(eventName, handler, aEL){
			...
			canDomEvents_1_3_2_canDomEvents.addEventListener(this, "change", localHandler);
			aEL.call(this, eventName, handler);

			return function(rEL){
				canDomEvents_1_3_2_canDomEvents.removeEventListener(this, "change", localHandler);
...
var attr = {
	...
	attribute: function(attrName) {
		return {
			...
			set: function(val) {
				canDomMutate_1_3_0_node.setAttribute.call(this, attrName, val);
			}
		};
	},
	...
	remove: function (el, attrName) {
		...
		if(typeof remover === "function" && test.call(el)) {
			...
			canDomMutate_1_3_0_node.removeAttribute.call(el, attrName);
		}
	}
};

var canAttributeObservable_1_1_5_behaviors = attr;
...
core.attr = function(el, attributeName, compute) {
	function liveUpdateAttr(newVal) {
		canQueues_1_1_4_canQueues.domUIQueue.enqueue(canAttributeObservable_1_1_5_behaviors.set, canAttributeObservable_1_1_5_behaviors, [el, attributeName, newVal]);
	}
	//!steal-remove-start
	if(process.env.NODE_ENV !== 'production') {
		// register that the handler changes the parent element
		canReflect_1_17_6_canReflect.assignSymbols(liveUpdateAttr, {
		...
		Object.defineProperty(liveUpdateAttr, "name", {
			value: "live.attr update::"+canReflect_1_17_6_canReflect.getName(compute),
		});
	}
	//!steal-remove-end
	...
	canAttributeObservable_1_1_5_behaviors.set(el, attributeName, canReflect_1_17_6_canReflect.getValue(compute));
};
...
core.attrs = function(el, compute, scope, options) {
	...
	if (!canReflect_1_17_6_canReflect.isObservableLike(compute)) {
		...
		for (var name in attrs) {
			canDomMutate_1_3_0_node.setAttribute.call(el, name, attrs[name]);
		}
		return;
	}
	...
	function liveAttrsUpdate(newVal) {
		...
		for (name in newAttrs) {
			...
			if (newValue !== oldValue) {
				...
				canDomMutate_1_3_0_node.setAttribute.call(el, name, newValue);
				// get registered callback for attribute name and fire
				var callback = canViewCallbacks_4_3_1_canViewCallbacks.attr(name);
				if (callback) {
					callback(el, {
						attributeName: name,
						scope: scope,
		...
		for (name in oldAttrs) {
			canDomMutate_1_3_0_node.removeAttribute.call(el, name);
		}
		oldAttrs = newAttrs;
	}
	...
	if(process.env.NODE_ENV !== 'production') {
		// register that the handler changes the parent element
		canReflect_1_17_6_canReflect.assignSymbols(liveAttrsUpdate, {
			"can.getChangesDependencyRecord": function() {
				var s = new Set();
				s.add(el);
				return {
		...
		Object.defineProperty(liveAttrsUpdate, "name", {
			value: "live.attrs update::"+canReflect_1_17_6_canReflect.getName(compute),
		});
		canReflectDependencies_1_1_1_canReflectDependencies.addMutatedBy(el, compute);
	}
	//!steal-remove-end
	...
	canReflect_1_17_6_canReflect.onValue(compute, liveAttrsUpdate,"domUI");

	var removalDisposal;
	var teardownHandler = function() {
		canReflect_1_17_6_canReflect.offValue(compute, liveAttrsUpdate,"domUI");
		if (removalDisposal) {
			removalDisposal();
			removalDisposal = undefined;
		}
	...
	liveAttrsUpdate(canReflect_1_17_6_canReflect.getValue(compute));
};

var viewInsertSymbol = canSymbol_1_6_1_canSymbol.for("can.viewInsert");
...
function updateNodeList(data, frag, nodeListUpdatedByFn) {
	if(data.nodeList.isUnregistered !== true) {
		...
		var newChildren = canReflect_1_17_6_canReflect.toArray(canChildNodes_1_2_0_canChildNodes(frag));
		if(!nodeListUpdatedByFn) {
			canViewNodelist_4_3_2_canViewNodelist.update(data.nodeList, newChildren, data.oldNodes);
		}
...
core.html = function(el, compute, parentNode, nodeListOrOptions) {
	...
	var meta = {reasonLog: "live.html replace::"+canReflect_1_17_6_canReflect.getName(compute)};
	...
	function liveHTMLUpdateHTML(newVal) {
		...
		var attached = canViewNodelist_4_3_2_canViewNodelist.first(nodes).parentNode;
		// update the nodes in the DOM with the new rendered value
		if (attached) {
			makeAndPut(newVal, true);
		}
		var pn = canViewNodelist_4_3_2_canViewNodelist.first(nodes).parentNode;
	...
	if(process.env.NODE_ENV !== 'production') {
		// register that the handler changes the parent element
		canReflect_1_17_6_canReflect.assignSymbols(liveHTMLUpdateHTML, {
			"can.getChangesDependencyRecord": function() {
				var s = new Set();
				s.add(parentNode);
				return {
		...
		Object.defineProperty(liveHTMLUpdateHTML, "name", {
			value: "live.html update::"+canReflect_1_17_6_canReflect.getName(compute),
		});
	}
	//!steal-remove-end
	...
	makeAndPut = function(val, useQueue) {
		...
		if(useQueue === true) {
			...
			data.oldNodes = canViewNodelist_4_3_2_canViewNodelist.unregisterChildren(nodes, true);
			...
			if (isFunction) {
				...
				nodeListUpdatedByFn = canViewNodelist_4_3_2_canViewNodelist.first(nodes) === frag.firstChild;
			}
			canQueues_1_1_4_canQueues.domUIQueue.enqueue(updateNodeList, null, [data, frag, nodeListUpdatedByFn], meta);
		} else {
			// this is initialization, update right away.
			data.oldNodes = canViewNodelist_4_3_2_canViewNodelist.update(nodes, canChildNodes_1_2_0_canChildNodes(frag));
			if (isFunction) {
				val(frag.firstChild);
			}
			canViewNodelist_4_3_2_canViewNodelist.replace(data.oldNodes, frag);
		}
	...
	if (!nodeList) {
		canViewNodelist_4_3_2_canViewNodelist.register(nodes, data.teardownCheck);
	} else {
		nodeList.unregistered = data.teardownCheck;
	}
	// Finally give the subtree an initial value
	makeAndPut(canReflect_1_17_6_canReflect.getValue(compute));
};

function SetObservable(initialValue, setter) {
	this.setter = setter;

	canSimpleObservable_2_4_0_canSimpleObservable.call(this, initialValue);
}

SetObservable.prototype = Object.create(canSimpleObservable_2_4_0_canSimpleObservable.prototype);
...
canReflect_1_17_6_canReflect.assignSymbols(SetObservable.prototype, {
	"can.setValue": SetObservable.prototype.set
});

var setObservable = SetObservable;

var onValueSymbol$3 = canSymbol_1_6_1_canSymbol.for("can.onValue"),
...
var Patcher = function(observableOrList, priority) {
	...
	this.isObservableValue = canReflect_1_17_6_canReflect.isValueLike(this.observableOrList) || canReflect_1_17_6_canReflect.isObservableLike(this.observableOrList);
	if(this.isObservableValue) {
	    this.priority = canReflect_1_17_6_canReflect.getPriority(observableOrList);
	} else {
	...
	if(process.env.NODE_ENV !== 'production') {
		Object.defineProperty(this.onList, "name", {
			value: "live.list new list::"+canReflect_1_17_6_canReflect.getName(observableOrList),
		});
		Object.defineProperty(this.onPatchesNotify, "name", {
			value: "live.list notify::"+canReflect_1_17_6_canReflect.getName(observableOrList),
		});
		Object.defineProperty(this.onPatchesDerive, "name", {
			value: "live.list derive::"+canReflect_1_17_6_canReflect.getName(observableOrList),
		});
	}
	//!steal-remove-end
};
...
Patcher.prototype = {
	...
	setup: function() {
		if (this.observableOrList[onValueSymbol$3]) {
			...
			// new list.
			canReflect_1_17_6_canReflect.onValue(this.observableOrList, this.onList, "notify");
			// listen on the current value (which shoudl be a list) if there is one
			this.setupList(canReflect_1_17_6_canReflect.getValue(this.observableOrList));
		} else {
	...
	teardown: function() {
		if (this.observableOrList[offValueSymbol$1]) {
			canReflect_1_17_6_canReflect.offValue(this.observableOrList, this.onList, "notify");
		}
	},
	...
	onPatchesNotify: function onPatchesNotify(patches) {
		...
		// TODO: share priority
		canQueues_1_1_4_canQueues.deriveQueue.enqueue(this.onPatchesDerive, this, [], {
	...
	onPatchesDerive: function onPatchesDerive() {
		...
		this.patches = [];
		canQueues_1_1_4_canQueues.enqueueByQueue(this.handlers.getNode([]), this.currentList, [patches, this.currentList], null,["Apply patches", patches]);
	}
};

canReflect_1_17_6_canReflect.assignSymbols(Patcher.prototype, {
	"can.onPatches": function(handler, queue) {
		this.handlers.add([queue || "mutate", handler]);
	},
	"can.offPatches": function(handler, queue) {
...
var renderAndAddToNodeLists = function(newNodeLists, parentNodeList, render, context, args) {
		...
		if (parentNodeList) {
			...
			//  as a child.
			canViewNodelist_4_3_2_canViewNodelist.register(itemNodeList, null, true, true);
		...
		var children = canReflect_1_17_6_canReflect.toArray(canChildNodes_1_2_0_canChildNodes(itemFrag));
		if (parentNodeList) {
			// if a parent list was supplied, children of the frag become the
			//  child nodeList items.
			canViewNodelist_4_3_2_canViewNodelist.update(itemNodeList, children);
			newNodeLists.push(itemNodeList);
		} else {
			// If no parent nodeList, register the new array of frag children as a nodeList
			//  and push into the nodeLists
			newNodeLists.push(canViewNodelist_4_3_2_canViewNodelist.register(children));
		}
		return itemFrag;
	},
	// #### removeFromNodeList
	...
	removeFromNodeList = function(masterNodeList, index, length) {
		...
		removedMappings.forEach( function(nodeList) {
			...
			var nodesToRemove = canViewNodelist_4_3_2_canViewNodelist.unregister(nodeList);
...
function ListDOMPatcher(el, compute, render, context, parentNode, nodeList, falseyRender) {
	...
	this.masterNodeList = nodeList || canViewNodelist_4_3_2_canViewNodelist.register([el], null, true);
	this.placeholder = el;

	// A mapping of items to their indices
	this.indexMap = [];

	this.isValueLike = canReflect_1_17_6_canReflect.isValueLike(this.value);
	this.isObservableLike = canReflect_1_17_6_canReflect.isObservableLike(this.value);
	...
	if(process.env.NODE_ENV !== 'production') {
		Object.defineProperty(this.onPatches, "name", {
			value: "live.list update::"+canReflect_1_17_6_canReflect.getName(compute),
		});
	}
	//!steal-remove-end
}
...
ListDOMPatcher.prototype = {
	...
	add: function(items, index) {
		...
		items.forEach( function(item, key) {
			...
			var itemIndex = new canSimpleObservable_2_4_0_canSimpleObservable(key + index),
				itemCompute = new setObservable(item, function(newVal) {
					canReflect_1_17_6_canReflect.setKeyValue(this.patcher.currentList, itemIndex.get(), newVal );
				}.bind(this)),
		...
		if (!this.indexMap.length) {
			...
			canViewNodelist_4_3_2_canViewNodelist.remove(falseyItemsToRemove);
		}

		// Check if we are adding items at the end
		if (!masterNodeList[masterListIndex]) {
			canViewNodelist_4_3_2_canViewNodelist.after(masterListIndex === 1 ? [this.placeholder] : [canViewNodelist_4_3_2_canViewNodelist.last(this.masterNodeList[masterListIndex - 1])], frag);
		} else {
			// Add elements before the next index's first element.
			var el = canViewNodelist_4_3_2_canViewNodelist.first(masterNodeList[masterListIndex]);
			canDomMutate_1_3_0_node.insertBefore.call(el.parentNode, frag, el);
		}
	...
	remove: function(items, index) {
		...
		if (!this.exit) {
			...
			this.addFalseyIfEmpty();
			canViewNodelist_4_3_2_canViewNodelist.remove(itemsToRemove);
		} else {
			canViewNodelist_4_3_2_canViewNodelist.unregister(this.masterNodeList);
		}
	},
	// #### addFalseyIfEmpty
	...
	addFalseyIfEmpty: function() {
		if (this.falseyRender && this.indexMap.length === 0) {
			...
			canViewNodelist_4_3_2_canViewNodelist.after([this.masterNodeList[0]], falseyFrag);
	...
	move: function move(newIndex, currentIndex) {
		...
		var movedElements = canFragment_1_3_0_canFragment(canViewNodelist_4_3_2_canViewNodelist.flatten(masterNodeList[currentIndex]));
		...
		if (currentIndex < newIndex) {
			referenceElement = canViewNodelist_4_3_2_canViewNodelist.last(referenceNodeList).nextSibling;
		} else {
			referenceElement = canViewNodelist_4_3_2_canViewNodelist.first(referenceNodeList);
		}
...
core.list = function(el, list, render, context, parentNode, nodeList, falseyRender) {
	if (el.nodeType !== Node.TEXT_NODE) {
		...
		if (!nodeList) {
			...
			textNode = document.createTextNode("");
			canViewNodelist_4_3_2_canViewNodelist.replace(nodeList, textNode);
			canViewNodelist_4_3_2_canViewNodelist.update(nodeList, [textNode]);
			el = textNode;
		}
	}
...
core.text = function(el, compute, parentNode, nodeList) {
	...
	el.nodeValue = core.makeString(canReflect_1_17_6_canReflect.getValue(compute));
	...
	if(process.env.NODE_ENV !== 'production') {
		// register that the handler changes the parent element
		canReflect_1_17_6_canReflect.assignSymbols(liveTextUpdateTextNode, {
			"can.getChangesDependencyRecord": function() {
				var s = new Set();
				s.add(parent);
				return {
		...
		Object.defineProperty(liveTextUpdateTextNode, "name", {
			value: "live.text update::"+canReflect_1_17_6_canReflect.getName(compute),
		});
	}
	//!steal-remove-end
	...
	if(!nodeList) {
		nodeList = canViewNodelist_4_3_2_canViewNodelist.register([el], null, true);
	}
...
var canViewLive_4_2_6_canViewLive = core;
...
canAssign_1_3_1_canAssign(TextSectionBuilder.prototype,{
	...
	compile: function(state){
		...
		return function(scope){
			...
			//!steal-remove-end
			var observation = new canObservation_4_1_1_canObservation(textSectionRender, null, {isObservable: false});

			canReflect_1_17_6_canReflect.onValue(observation, noop);

			var value = canReflect_1_17_6_canReflect.getValue(observation);
			if( canReflect_1_17_6_canReflect.valueHasDependencies( observation ) ) {
				if(state.textContentOnly) {
					canViewLive_4_2_6_canViewLive.text(this, observation);
				}
				else if(state.attr) {
					canViewLive_4_2_6_canViewLive.attr(this, state.attr, observation);
				}
				else {
					canViewLive_4_2_6_canViewLive.attrs(this, observation, scope);
				}
				canReflect_1_17_6_canReflect.offValue(observation, noop);
			} else {
				if(state.textContentOnly) {
					this.nodeValue = value;
				}
				else if(state.attr) {
					canDomMutate_1_3_0_node.setAttribute.call(this, state.attr, value);
				}
				else {
					canViewLive_4_2_6_canViewLive.attrs(this, value);
				}
			}
		};
	}
...
function SetterObservable(getter, setter) {
	this.setter = setter;
	this.observation = new canObservation_4_1_1_canObservation(getter);
	this.handler = this.handler.bind(this);
		...
		canReflect_1_17_6_canReflect.assignSymbols(this, {
			"can.getName": function() {
				return (
					canReflect_1_17_6_canReflect.getName(this.constructor) +
					"<" +
					canReflect_1_17_6_canReflect.getName(getter) +
					">"
				);
			}
		});
...
canReflect_1_17_6_canReflect.assignSymbols(SetterObservable.prototype, {
...
function getObservableValue_fromKey(key, scope, readOptions) {
	...
	canObservation_4_1_1_canObservation.temporarilyBind(data);
...
function computeHasDependencies(compute){
	return compute[canSymbol_1_6_1_canSymbol.for("can.valueHasDependencies")] ?
		canReflect_1_17_6_canReflect.valueHasDependencies(compute) : compute.computeInstance.hasDependencies;
}
...
function getObservableValue_fromDynamicKey_fromObservable(key, root, helperOptions, readOptions) {
	...
	var getKeys = function(){
		return canStacheKey_1_4_0_canStacheKey.reads(("" + canReflect_1_17_6_canReflect.getValue(key)).replace(/\./g, "\\."));
	};
	var parentHasKey;
	var computeValue = new setter(function getDynamicKey() {
		var readData = canStacheKey_1_4_0_canStacheKey.read( canReflect_1_17_6_canReflect.getValue(root) , getKeys());
		parentHasKey = readData.parentHasKey;
		return readData.value;
	}, function setDynamicKey(newVal){
		canStacheKey_1_4_0_canStacheKey.write(canReflect_1_17_6_canReflect.getValue(root), getKeys(), newVal);
	});
	canObservation_4_1_1_canObservation.temporarilyBind(computeValue);
	computeValue.initialValue = canReflect_1_17_6_canReflect.getValue(computeValue);
...
function toComputeOrValue(value) {
	...
	if(canReflect_1_17_6_canReflect.isObservableLike(value)) {
		// we only want to do this for things that `should` have dependencies, but dont.
		if(canReflect_1_17_6_canReflect.isValueLike(value) && canReflect_1_17_6_canReflect.valueHasDependencies(value) === false) {
			return canReflect_1_17_6_canReflect.getValue(value);
		}
		// if compute data
		if(value.compute) {
			...
			return canViewScope_4_11_0_makeComputeLike(value);
		}
	}
	return value;
}
...
Hashes.prototype.value = function(scope, helperOptions){
	...
	return new canObservation_4_1_1_canObservation(function(){
		var finalHash = {};
		for(var prop in hash) {
			finalHash[prop] = hash[prop].call ? canReflect_1_17_6_canReflect.getValue( hash[prop].value ) : expressionHelpers.toComputeOrValue( hash[prop].value );
		}
		return finalHash;
	});
};
...
if (process.env.NODE_ENV !== 'production') {
	Hashes.prototype.sourceText = function(){
		var hashes = [];
		canReflect_1_17_6_canReflect.eachKey(this.hashExprs, function(expr, prop){
...
//!steal-remove-start
if (process.env.NODE_ENV !== 'production') {
	var canSymbol = canSymbol_1_6_1_canSymbol;
}
//!steal-remove-end
...
var isViewSymbol$1 = canSymbol_1_6_1_canSymbol.for("can.isView");
		...
		for(var i = 0, len = args.length; i < len; i++) {
			if (doNotWrapArguments) {
				...
				finalArgs[i] = args[i].call ?
					canReflect_1_17_6_canReflect.getValue( args[i].value ) :
...
Call.prototype.value = function(scope, helperOptions){
	...
	var method = this.methodExpr.value(scope, { proxyMethods: false }),
		func = canReflect_1_17_6_canReflect.getValue( method );

	var getArgs = callExpression.args(scope , func && func.ignoreArgLookup);

	var computeFn = function(newVal){
		var func = canReflect_1_17_6_canReflect.getValue( method );
	...
	if (typeof initialValue === "function") {
		...
		if (process.env.NODE_ENV !== 'production') {
			Object.defineProperty(helperFn, "name", {
				configurable: true,
				value: canReflect_1_17_6_canReflect.getName(this)
			});
		}
		//!steal-remove-end
	}
...
if (process.env.NODE_ENV !== 'production') {
	Helper.prototype.sourceText = function(){
		...
		if(canReflect_1_17_6_canReflect.size(this.hashExprs) > 0){
...
//!steal-remove-end
if (process.env.NODE_ENV !== 'production') {
	canReflect_1_17_6_canReflect.assignSymbols(Helper.prototype,{
		"can.getName": function() {
			return canReflect_1_17_6_canReflect.getName(this.constructor) + "{{" + (this.sourceText()) + "}}";
		}
	});
}
//!steal-remove-end
...
var Lookup = function(key, root, sourceText) {
	this.key = key;
	this.rootExpr = root;
	canReflect_1_17_6_canReflect.setKeyValue(this, sourceTextSymbol$1, sourceText);
};
Lookup.prototype.value = function(scope, readOptions){
	...
	if (process.env.NODE_ENV !== 'production') {
		if (typeof value.initialValue === 'undefined' && this.key !== "debugger" && !value.parentHasKey) {
			...
			var reads = canStacheKey_1_4_0_canStacheKey.reads(this.key);
...
var convertToAtLookup = function(ast){
	if(ast.type === "Lookup") {
		canReflect_1_17_6_canReflect.setKeyValue(ast, sourceTextSymbol$2, ast.key);
		...
		while(cursor.index < tokens.length) {
			...
			// Bracket
				...
				if (lastToken && (lastToken.type === "Call" || lastToken.type === "Bracket"  )  ) {
					...
					//!steal-remove-start
					if (process.env.NODE_ENV !== 'production') {
						canReflect_1_17_6_canReflect.setKeyValue(bracket$$1, canSymbol_1_6_1_canSymbol.for("can-stache.originalKey"), top.key);
					}
					//!steal-remove-end
...
var toDOMSymbol$1 = canSymbol_1_6_1_canSymbol.for("can.toDOM");
...
var mustacheLineBreakRegExp = /(?:(^|\r?\n)(\s*)(\{\{([\s\S]*)\}\}\}?)([^\S\n\r]*)($|\r?\n))|(\{\{([\s\S]*)\}\}\}?)/g,
	...
	k = function(){};
var viewInsertSymbol$1 = canSymbol_1_6_1_canSymbol.for("can.viewInsert");
...
var core$1 = {
	...
	makeEvaluator: function (scope, nodeList, mode, exprData, truthyRenderer, falseyRenderer, stringOnly) {
		...
		if(!mode || helperOptions.metadata.rendered) {
			...
			return function(){
				// Get the value
				var finalValue = canReflect_1_17_6_canReflect.getValue(value);
				var result;
				...
				else if ( typeof finalValue !== "string" && canReflect_1_17_6_canReflect.isListLike(finalValue) ) {
					var isObserveList = canReflect_1_17_6_canReflect.isObservableLike(finalValue) &&
						canReflect_1_17_6_canReflect.isListLike(finalValue);

					if(canReflect_1_17_6_canReflect.getKeyValue(finalValue, "length")) {
						if (stringOnly) {
	...
	makeLiveBindingPartialRenderer: function(expressionString, state){
		...
		return function(scope, parentSectionNodeList){
			...
			canViewNodelist_4_3_2_canViewNodelist.register(nodeList, null, parentSectionNodeList || true, state.directlyNested);

			var partialFrag = new canObservation_4_1_1_canObservation(function(){
				var localPartialName = partialName;
				// If the second parameter of a partial is a custom context
				if(exprData && exprData.argExprs.length === 1) {
					var newContext = canReflect_1_17_6_canReflect.getValue( exprData.argExprs[0].value(scope) );
				...
				var partial = canReflect_1_17_6_canReflect.getKeyValue(scope.templateContext.partials, localPartialName);
				var renderer;
				...
				var res = canObservationRecorder_1_2_0_canObservationRecorder.ignore(renderer)();
				return canFragment_1_3_0_canFragment(res);
			});
			canReflect_1_17_6_canReflect.setPriority(partialFrag,nodeList.nesting );

			canViewLive_4_2_6_canViewLive.html(this, partialFrag, this.parentNode, nodeList);
		};
	},
	...
	makeStringBranchRenderer: function(mode, expressionString, state){
		...
		var branchRenderer = function branchRenderer(scope, truthyRenderer, falseyRenderer){
			...
			if(gotObservableValue) {
				res = canReflect_1_17_6_canReflect.getValue(evaluator);
			} else {
				res = evaluator();
			}
	...
	makeLiveBindingBranchRenderer: function(mode, expressionString, state){
		...
		var branchRenderer = function branchRenderer(scope, parentSectionNodeList, truthyRenderer, falseyRenderer){
			...
			if(gotObservableValue) {
				...
				//!steal-remove-end
				observable = new canObservation_4_1_1_canObservation(evaluator,null,{isObservable: false});
			}

			if(canReflect_1_17_6_canReflect.setPriority(observable, nodeList.nesting) === false) {
			...
			canReflect_1_17_6_canReflect.onValue(observable, k);

			var value = canReflect_1_17_6_canReflect.getValue(observable);
			...
			if(typeof value === "function" && !(exprData instanceof expression$1.Lookup)) {
				...
				// performed in value.
				canObservationRecorder_1_2_0_canObservationRecorder.ignore(value)(this);

			}
			// If the computeValue has observable dependencies, setup live binding.
			else if( canReflect_1_17_6_canReflect.valueHasDependencies(observable) ) {
				// Depending on where the template is, setup live-binding differently.
				if(state.attr) {
					canViewLive_4_2_6_canViewLive.attr(this, state.attr, observable);
				}
				else if( state.tag )  {
					canViewLive_4_2_6_canViewLive.attrs( this, observable );
				}
					...
					//!steal-remove-end
					canViewLive_4_2_6_canViewLive.text(this, observable, this.parentNode, nodeList);
				} else {
					canViewLive_4_2_6_canViewLive.html(this, observable, this.parentNode, {
						nodeList: nodeList
					});
				}
			}
			// If the computeValue has no observable dependencies, just set the value on the element.
				...
				if(state.attr) {
					canDomMutate_1_3_0_canDomMutate.setAttribute(this, state.attr, value);
				}
				else if(state.tag) {
					canViewLive_4_2_6_canViewLive.attrs(this, value);
				}
				else if(state.text && !valueShouldBeInsertedAsHTML(value)) {
					this.nodeValue = canViewLive_4_2_6_canViewLive.makeString(value);
				}
				else if( value != null ){
					if (typeof value[viewInsertSymbol$1] === "function") {
						...
						var oldNodes = canViewNodelist_4_3_2_canViewNodelist.update(nodeList, [insert]);
						canViewNodelist_4_3_2_canViewNodelist.replace(oldNodes, insert);
					} else {
						canViewNodelist_4_3_2_canViewNodelist.replace([this], canFragment_1_3_0_canFragment(value, this.ownerDocument));
					}
				}
			}
			// Unbind the compute.
			canReflect_1_17_6_canReflect.offValue(observable, k);
		};
...
canGlobals_1_2_0_canGlobalsInstance.define('base-url', function(){
	var global = canGlobals_1_2_0_canGlobalsInstance.getKeyValue('global');
	var domDocument = canGlobals_1_2_0_canGlobalsInstance.getKeyValue('document');
...
var baseUrl = canGlobals_1_2_0_canGlobalsInstance.makeExport('base-url');
...
//!steal-remove-start
if (process.env.NODE_ENV !== 'production') {
	var canReflect = canReflect_1_17_6_canReflect;

	var canSymbol$1 = canSymbol_1_6_1_canSymbol;
...
var truthyObservable = function(observable){
    return new canObservation_4_1_1_canObservation(function truthyObservation(){
        var val = canReflect_1_17_6_canReflect.getValue(observable);
...
var bindAndRead = function (value) {
	if ( value && canReflect_1_17_6_canReflect.isValueLike(value) ) {
		canObservation_4_1_1_canObservation.temporarilyBind(value);
		return canReflect_1_17_6_canReflect.getValue(value);
	} else {
		return value;
	}
...
function forOfObject(object, variableName, options){
	var result = [];
	canReflect_1_17_6_canReflect.each(object, function(val, key){
...
var forHelper = function(helperOptions) {
	...
	if(resolved && !canReflect_1_17_6_canReflect.isListLike(resolved)) {
		return forOfObject(resolved,variableName, helperOptions);
	}
	if(options.stringOnly) {
		var parts = [];
		canReflect_1_17_6_canReflect.eachIndex(resolved, function(value, index){
			var variableScope = {};
			if(variableName !== undefined){
				variableScope[variableName] = value;
			}
		...
		return function(el){
			...
			canViewNodelist_4_3_2_canViewNodelist.register(nodeList, null, options.nodeList, true);
			// runs nest replacements
			canViewNodelist_4_3_2_canViewNodelist.update(options.nodeList, [el]);
			...
			canViewLive_4_2_6_canViewLive.list(el, items, cb, options.context, el.parentNode, nodeList, function(list, parentNodeList){
...
canStacheHelpers_1_2_0_canStacheHelpers.for = forHelper;

function isVariable(scope) {
	return scope._meta.variable === true;
}

canStacheHelpers_1_2_0_canStacheHelpers["let"] = function(options){
	var variableScope = options.scope.getScope(isVariable);
	if(!variableScope) {
		throw new Error("There is no variable scope!");
	}
	canReflect_1_17_6_canReflect.assignMap(variableScope._context, options.hash);
...
var helpersCore = {
	...
	makeSimpleHelper: function(fn) {
		return function() {
			var realArgs = [];
			canReflect_1_17_6_canReflect.eachIndex(arguments, function(val) {
	...
	addBuiltInHelpers: function() {
		canReflect_1_17_6_canReflect.each(builtInHelpers, function(helper, helperName) {
			...
			if (process.env.NODE_ENV !== 'production') {
				Object.defineProperty(callLogic, "name", {
					value: name+"("+args.map(function(arg){
						return canReflect_1_17_6_canReflect.getName(arg);
					}).join(",")+")",
					configurable: true
				});
			}
			//!steal-remove-end
			var callFn = new canObservation_4_1_1_canObservation(callLogic);
...
var ifHelper = canAssign_1_3_1_canAssign(function ifHelper(expr, options) {
	...
	if (expr && canReflect_1_17_6_canReflect.isValueLike(expr)) {
		value = canReflect_1_17_6_canReflect.getValue(new truthyObservable(expr));
	} else {
...
var switchHelper = function(expression, options){
	...
	canReflect_1_17_6_canReflect.assignSymbols(defaultHelper, {
		"can.isValueLike": true,
		"can.isFunctionLike": false,
		"can.getValue": function() {
...
var joinBaseHelper = function(firstExpr/* , expr... */){
	...
	var templateModule = canReflect_1_17_6_canReflect.getKeyValue(options.scope.templateContext.helpers, 'module');
...
var eachHelper = function(items) {
	...
	if ((
		canReflect_1_17_6_canReflect.isObservableLike(resolved) && canReflect_1_17_6_canReflect.isListLike(resolved) ||
			( canReflect_1_17_6_canReflect.isListLike(resolved) && canReflect_1_17_6_canReflect.isValueLike(items) )
	) && !options.stringOnly) {
		// Tells that a helper has been called, this function should be returned through
		// checking its value.
		options.metadata.rendered = true;
	...
	if (!!expr && canReflect_1_17_6_canReflect.isListLike(expr)) {
		result = utils$1.getItemsFragContent(expr, options, options.scope);
		return options.stringOnly ? result.join('') : result;
	} else if (canReflect_1_17_6_canReflect.isObservableLike(expr) && canReflect_1_17_6_canReflect.isMapLike(expr) || expr instanceof Object) {
		result = [];
		canReflect_1_17_6_canReflect.each(expr, function(val, key){
...
var withHelper = function (expr, options) {
	...
	if(!options) {
		...
		if(options.hash && canReflect_1_17_6_canReflect.size(options.hash) > 0) {
...
var dataHelper = function(attr, value) {
	...
	return function setData(el) {
		...
		//!steal-remove-end
		canDomDataState_1_0_2_canDomDataState.set.call( el, attr, data );
	};
};
...
core$2.addConverter = function(name, getterSetter) {
	if(typeof name === "object") {
		if(!converterPackages.has(name)) {
			...
			canReflect_1_17_6_canReflect.eachKey(name, function(getterSetter, name) {
				core$2.addConverter(name, getterSetter);
			});
		}
		return;
	}
...
var converterHelpers = {
	"not": {
		get: function(obs, options){
			if(core$2.looksLikeOptions(options)) {
				return canReflect_1_17_6_canReflect.getValue(obs) ? options.inverse() : options.fn();
			} else {
				return !canReflect_1_17_6_canReflect.getValue(obs);
			}

		},
		set: function(newVal, obs){
			canReflect_1_17_6_canReflect.setValue(obs, !newVal);
		}
	}
};

core$2.addConverter(converterHelpers);
...
if(!canViewCallbacks_4_3_1_canViewCallbacks.tag("content")) {
	// This was moved from the legacy view/scanner.js to here.
	// This makes sure content elements will be able to have a callback.
	canViewCallbacks_4_3_1_canViewCallbacks.tag("content", function(el, tagData) {
		return tagData.scope;
	});
}

var isViewSymbol$2 = canSymbol_1_6_1_canSymbol.for("can.isView");
...
function stache (filename, template) {
	...
	canViewParser_4_1_2_canViewParser(template, {
		...
		start: function(tagName, unary, lineNo){
			...
			var isCustomTag =  canViewCallbacks_4_3_1_canViewCallbacks.tag(tagName);
			...
			if(unary){
				...
				if(isCustomTag) {
					...
					addAttributesCallback(state.node, function(scope, parentNodeList){
						...
						//!steal-remove-end
						canViewCallbacks_4_3_1_canViewCallbacks.tagHandler(this,tagName, {
							scope: scope,
							subtemplate: null,
							templateType: "stache",
		...
		attrEnd: function(attrName, lineNo){
			if(state.node.section) {
				...
				var attrCallback = canViewCallbacks_4_3_1_canViewCallbacks.attr(attrName);

				//!steal-remove-start
				if (process.env.NODE_ENV !== 'production') {
					var decodedAttrName = canAttributeEncoder_1_1_0_canAttributeEncoder.decode(attrName);
	...
	var scopifiedRenderer = canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(scope, options, nodeList){

		// Support passing nodeList as the second argument
		if (nodeList === undefined && canReflect_1_17_6_canReflect.isListLike(options)) {
			nodeList = options;
			options = undefined;
		}
		...
		// helperOptions (.fn, .inverse, etc) when called as Call Expressions
		canReflect_1_17_6_canReflect.eachKey(options && options.helpers, function(helperValue) {
			helperValue.requiresOptionsArgument = true;
		});

		// helpers, partials, tags, vars
		var templateContext = new canViewScope_4_11_0_templateContext(options);

		// copy inline partials over
		canReflect_1_17_6_canReflect.eachKey(inlinePartials, function(partial, partialName) {
			canReflect_1_17_6_canReflect.setKeyValue(templateContext.partials, partialName, partial);
		});

		// allow the current renderer to be called with {{>scope.view}}
		canReflect_1_17_6_canReflect.setKeyValue(templateContext, 'view', scopifiedRenderer);
		//!steal-remove-start
		if (process.env.NODE_ENV !== 'production') {
			canReflect_1_17_6_canReflect.setKeyValue(templateContext, 'filename', section.filename);
		}
		//!steal-remove-end
		...
		if ( !(scope instanceof canViewScope_4_11_0_canViewScope) ) {
			scope = new canViewScope_4_11_0_canViewScope(templateContext).add(scope);
		} else {
			// we are going to split ...
			var templateContextScope = new canViewScope_4_11_0_canViewScope(templateContext);
...
stache.safeString = function(text){
	...
	return canReflect_1_17_6_canReflect.assignSymbols({},{
		"can.toDOM": function(){
			return text;
		}
	});
...
stache.addBindings = canViewCallbacks_4_3_1_canViewCallbacks.attrs;

var canStache_4_15_2_canStache = canNamespace_1_0_0_canNamespace.stache = stache;
...
var canViewModel_4_0_1_canViewModel = canNamespace_1_0_0_canNamespace.viewModel = function (el, attr, val) {
	...
	} else if (canReflect_1_17_6_canReflect.isListLike(el) && !el.nodeType) {
		el = el[0];
	}

	if (canReflect_1_17_6_canReflect.isObservableLike(attr) && canReflect_1_17_6_canReflect.isMapLike(attr)) {
	...
	switch (arguments.length) {
		...
		case 1:
			return scope;
		case 2:
			return canReflect_1_17_6_canReflect.getKeyValue(scope, attr);
		default:
			canReflect_1_17_6_canReflect.setKeyValue(scope, attr, val);
			return el;
	}
};
...
var canAttributeObservable_1_1_5_event = canEvent;
...
var canAttributeObservable_1_1_5_getEventName = function getEventName(el, prop, bindingData) {
	var event = "change";
	...
	if (canAttributeObservable_1_1_5_behaviors.findSpecialListener(prop)) {
		event = prop;
	}
...
canDomEvents_1_3_2_canDomEvents.addEvent(canEventDomRadiochange_2_2_0_canEventDomRadiochange, internalRadioChangeEventType);
...
function canUtilAEL () {
	...
	args.unshift(this);
	return canDomEvents_1_3_2_canDomEvents.addEventListener.apply(null, args);
}

function canUtilREL () {
	var args = slice$4.call(arguments, 0);
	args.unshift(this);
	return canDomEvents_1_3_2_canDomEvents.removeEventListener.apply(null, args);
}
...
function AttributeObservable(el, prop, bindingData, event) {
	...
	this.event = event || canAttributeObservable_1_1_5_getEventName(el, prop, bindingData);
	this.handler = this.handler.bind(this);
...
Object.assign(AttributeObservable.prototype, {
	...
	get: function get() {
		...
		var value = canAttributeObservable_1_1_5_behaviors.get(this.el, this.prop);
		if (typeof value === 'function') {
	...
	set: function set(newVal) {
		var setterDispatchedEvents = canAttributeObservable_1_1_5_behaviors.setAttrOrProp(this.el, this.prop, newVal);
	...
	handler: function handler(newVal, event) {
		var old = this._value;
		var queuesArgs = [];
		this._value = canAttributeObservable_1_1_5_behaviors.get(this.el, this.prop);
	...
	onBound: function onBound() {
		...
		observable._handler = function(event) {
			observable.handler(canAttributeObservable_1_1_5_behaviors.get(observable.el, observable.prop), event);
		};

		if (observable.event === internalRadioChangeEventType) {
			canAttributeObservable_1_1_5_event.on.call(observable.el, "change", observable._handler);
		}

		var specialBinding = canAttributeObservable_1_1_5_behaviors.findSpecialListener(observable.prop);
		if (specialBinding) {
			observable._specialDisposal = specialBinding.call(observable.el, observable.prop, observable._handler, canUtilAEL);
		}

		canAttributeObservable_1_1_5_event.on.call(observable.el, observable.event, observable._handler);
	...
	onUnbound: function onUnbound() {
		...
		if (observable.event === internalRadioChangeEventType) {
			canAttributeObservable_1_1_5_event.off.call(observable.el, "change", observable._handler);
		}
		...
		canAttributeObservable_1_1_5_event.off.call(observable.el, observable.event, observable._handler);
	},
...
canReflect_1_17_6_canReflect.assignSymbols(AttributeObservable.prototype, {
	"can.isMapLike": false,
...
var canAttributeObservable_1_1_5_canAttributeObservable = AttributeObservable;
...
var runEventCallback = function (el, ev, data, scope, expr, attributeName, attrVal) {
	...
	var updateFn = function() {
		...
		value = canReflect_1_17_6_canReflect.isValueLike(value) ?
			canReflect_1_17_6_canReflect.getValue(value) :
			value;
	...
	//!steal-remove-end
	canQueues_1_1_4_canQueues.mutateQueue.enqueue.apply(canQueues_1_1_4_canQueues.mutateQueue, mutateQueueArgs);
	canQueues_1_1_4_canQueues.batch.stop();
};
...
var behaviors = {
	...
	viewModel: function(el, tagData, makeViewModel, initialViewModelData, staticDataBindingsOnly) {
		...
		canReflect_1_17_6_canReflect.each(el.attributes || [], function(node) {
			...
			if (dataBinding) {
				...
				if (bindingInfo.parentToChild) {
					var parentValue = bindingInfo.stickyParentToChild ? canViewScope_4_11_0_makeComputeLike(dataBinding.parent) : dataBinding.canBinding.parentValue;
		...
		if (!bindingsState.isSettingViewModel) {
			attributeDisposal = canDomMutate_1_3_0_canDomMutate.onNodeAttributeChange(el, function(ev) {
	...
	data: function(el, attrData) {
		if (canDomDataState_1_0_2_canDomDataState.get.call(el, "preventDataBindings")) {
			return;
		}
		var viewModel,
			getViewModel = canObservationRecorder_1_2_0_canObservationRecorder.ignore(function() {
		...
		//!steal-remove-start
		if (process.env.NODE_ENV !== 'production') {
			if (dataBinding.bindingInfo.child === "viewModel" && !canDomDataState_1_0_2_canDomDataState.get(el, "viewModel")) {
		...
		if (attrData.nodeList) {
			canViewNodelist_4_3_2_canViewNodelist.register([], tearItAllDown, attrData.nodeList, false);
		}
		...
		attributeDisposal = canDomMutate_1_3_0_canDomMutate.onNodeAttributeChange(el, attributeListener);
		removedDisposal = canDomMutate_1_3_0_canDomMutate.onNodeRemoval(el, function() {
			var doc = el.ownerDocument;
			var ownerNode = doc.contains ? doc : doc.documentElement;
	...
	event: function(el, data) {
		...
		var attributeName = canAttributeEncoder_1_1_0_canAttributeEncoder.decode(data.attributeName),
		...
		var handler = function(ev) {
			var attrVal = el.getAttribute(canAttributeEncoder_1_1_0_canAttributeEncoder.encode(attributeName));
			if (!attrVal) {
				return;
			}
			...
			if (expr instanceof expression_1.Hashes) {
				...
				var isObservableValue = canReflect_1_17_6_canReflect.isObservableLike(value) && canReflect_1_17_6_canReflect.isValueLike(value);
				runScope.set(key, isObservableValue ? canReflect_1_17_6_canReflect.getValue(value) : value);
		...
		var unbindEvent = function() {
			canAttributeObservable_1_1_5_event.off.call(bindingContext, event, handler);
		...
		canAttributeObservable_1_1_5_event.on.call(bindingContext, event, handler);
		attributesDisposal = canDomMutate_1_3_0_canDomMutate.onNodeAttributeChange(el, attributesHandler);
		removalDisposal = canDomMutate_1_3_0_canDomMutate.onNodeRemoval(el, removalHandler);
	}
};
...
var getObservableFrom = {
	...
	scope: function(el, scope, scopeProp, bindingData, mustBeGettable, stickyCompute) {
		if (!scopeProp) {
			return new canSimpleObservable_2_4_0_canSimpleObservable();
		} else {
			...
			if (mustBeGettable || scopeProp.indexOf("(") >= 0 ) {
				...
				var observation = {};
				canReflect_1_17_6_canReflect.assignSymbols(observation, {
						...
						if (process.env.NODE_ENV !== 'production') {
							...
							if (data.parent && data.key) {
								result = "ObservableFromScope<" +
									canReflect_1_17_6_canReflect.getName(data.parent) +
									"." +
									data.key +
									">";
							}
		...
		var observation = new setter(
			...
			function setViewModelProperty(newVal) {
				...
				if (stickyCompute) {
					...
					var oldValue = canReflect_1_17_6_canReflect.getKeyValue(viewModel, setName);
					if (canReflect_1_17_6_canReflect.isObservableLike(oldValue)) {
						canReflect_1_17_6_canReflect.setValue(oldValue, newVal);
					} else {
						canReflect_1_17_6_canReflect.setKeyValue(
							viewModel,
							setName,
							new canSimpleObservable_2_4_0_canSimpleObservable(canReflect_1_17_6_canReflect.getValue(stickyCompute))
						);
					}
				} else {
					if (isBoundToContext) {
						canReflect_1_17_6_canReflect.setValue(viewModel, newVal);
					} else {
						canReflect_1_17_6_canReflect.setKeyValue(viewModel, setName, newVal);
					}
				}
			}
		);
	...
	attribute: function(el, scope, prop, bindingData, mustBeGettable, stickyCompute, event, bindingInfo) {
		return new canAttributeObservable_1_1_5_canAttributeObservable(el, prop, bindingData, event);
	}
};
...
canReflect_1_17_6_canReflect.each(bindingRules, function(value, key) {
...
var getBindingInfo = function(node, attributeViewModelBindings, templateType, tagName, favorViewModel) {
	var bindingInfo,
		attributeName = canAttributeEncoder_1_1_0_canAttributeEncoder.decode(node.name),
...
var makeDataBinding = function(node, el, bindingData) {
	...
	//!steal-remove-start
	if (process.env.NODE_ENV !== 'production') {
		var nodeHTML = canAttributeEncoder_1_1_0_canAttributeEncoder.decode(node.name)+"="+JSON.stringify(node.value);
	...
	// Create the binding
	var canBinding = new canBind_1_0_1_canBind(bindingOptions);
...
canStacheBindings[canSymbol_1_6_1_canSymbol.for("can.callbackMap")] = bindings;
canViewCallbacks_4_3_1_canViewCallbacks.attrs(canStacheBindings);

var canStacheBindings_4_5_1_canStacheBindings = canStacheBindings;
...
// Symbols
var createdByCanComponentSymbol = canSymbol_1_6_1_canSymbol("can.createdByCanComponent");
var getValueSymbol$3 = canSymbol_1_6_1_canSymbol.for("can.getValue");
var setValueSymbol$3 = canSymbol_1_6_1_canSymbol.for("can.setValue");
var viewInsertSymbol$2 = canSymbol_1_6_1_canSymbol.for("can.viewInsert");
var viewModelSymbol$1 = canSymbol_1_6_1_canSymbol.for('can.viewModel');

canStache_4_15_2_canStache.addBindings(canStacheBindings_4_5_1_canStacheBindings);
...
function addContext(el, tagData, insertionElementTagData) {
	...
	canDomDataState_1_0_2_canDomDataState.set.call(el, "preventDataBindings", true);

	// insertionElementTagData is where the <content> element is in the shadow dom
	// it should be used for bindings
	var teardown = canStacheBindings_4_5_1_canStacheBindings.behaviors.viewModel(el, insertionElementTagData, function(initialData, hasDataBinding, bindingState) {
		...
		if(bindingState && bindingState.isSettingOnViewModel === true) {
			...
			return vm = new canSimpleObservable_2_4_0_canSimpleObservable(initialData);
		}
	}, undefined, true);
...
function makeInsertionTagCallback(tagName, componentTagData, shadowTagData, leakScope, getPrimaryTemplate) {
	...
	return function hookupFunction(el, insertionElementTagData) {
		...
		if (template) {
			...
			var nodeList = canViewNodelist_4_3_2_canViewNodelist.register([el], function() {
				if(tagData.teardown) {
					tagData.teardown();
				}
			...
			var newNodes = canReflect_1_17_6_canReflect.toArray( canChildNodes_1_2_0_canChildNodes(frag) );
			var oldNodes = canViewNodelist_4_3_2_canViewNodelist.update(nodeList, newNodes);
			canViewNodelist_4_3_2_canViewNodelist.replace(oldNodes, frag);
...
function getSetupFunctionForComponentVM(componentInitVM) {
	...
	return canObservationRecorder_1_2_0_canObservationRecorder.ignore(function(el, makeViewModel, initialVMData) {
		...
		canReflect_1_17_6_canReflect.eachKey(componentInitVM, function(parent, propName) {
			var canGetParentValue = parent != null && !!parent[getValueSymbol$3];
			var canSetParentValue = parent != null && !!parent[setValueSymbol$3];
			...
			if (canGetParentValue === true || canSetParentValue) {
				...
				var child = new setter(
					...
					function(newValue) {
						canReflect_1_17_6_canReflect.setKeyValue(viewModel, propName, newValue);
					}
				);

				// Create the binding similar to what’s in can-stache-bindings
				var canBinding = new canBind_1_0_1_canBind({
					child: child,
					parent: parent,
					queue: "domUI",
					...
					updateParentName: "update " + canReflect_1_17_6_canReflect.getName(parent) + " of <" + el.nodeName.toLowerCase() + ">"
					//!steal-remove-end
				});
...
var Component = canConstruct_3_5_3_canConstruct.extend(
	...
	// ## Static
	{
		...
		setup: function() {
			...
			if (Component) {
				...
				if(this.prototype.events !== undefined && canReflect_1_17_6_canReflect.size(this.prototype.events) !== 0) {
				...
				if (process.env.NODE_ENV !== 'production') {
					...
					if (this.prototype.viewModel && canReflect_1_17_6_canReflect.isConstructorLike(this.prototype.viewModel)) {
				...
				if(this.prototype.ViewModel) {
					...
					if(protoViewModel) {
						if(typeof protoViewModel === "function") {
							if(canReflect_1_17_6_canReflect.isObservableLike(protoViewModel.prototype) && canReflect_1_17_6_canReflect.isMapLike(protoViewModel.prototype)) {
								this.ViewModel = protoViewModel;
							} else {
								this.viewModelHandler = protoViewModel;
							}
						} else {
							if(canReflect_1_17_6_canReflect.isObservableLike(protoViewModel) && canReflect_1_17_6_canReflect.isMapLike(protoViewModel)) {
								//!steal-remove-start
								if (process.env.NODE_ENV !== 'production') {
				...
				if (typeof this.renderer === "string") {
					...
					this.renderer = canStache_4_15_2_canStache(viewName, this.renderer);
				}

				// Register this component to be created when its `tag` is found.
				canViewCallbacks_4_3_1_canViewCallbacks.tag(this.prototype.tag, function(el, tagData) {
		...
		setup: function(el, componentTagData) {
			...
			if (componentContent !== undefined) {
				...
				if (typeof componentContent === "function") {
					...
					componentTagData.subtemplate = canStache_4_15_2_canStache(componentContent);
				}
			}

			// Check for the component being instantiated with a scope
			var componentScope = componentTagData.scope;
			if (componentScope !== undefined && componentScope instanceof canViewScope_4_11_0_canViewScope === false) {
				componentTagData.scope = new canViewScope_4_11_0_canViewScope(componentScope);
			}
			...
			if (componentTemplates !== undefined) {
				canReflect_1_17_6_canReflect.eachKey(componentTemplates, function(template, name) {
					// Check if it’s a string that needs to be parsed by stache
					if (typeof template === "string") {
						var debugName = name + " template";
						componentTemplates[name] = canStache_4_15_2_canStache(debugName, template);
					}
				});
			}
			...
			var preventDataBindings = canDomDataState_1_0_2_canDomDataState.get.call(el, "preventDataBindings");
			var viewModel, frag;
			...
			if (preventDataBindings) {
				...
				if (componentTagData.setupBindings) {
					...
					setupFn = function(el, callback, data) {
						return canStacheBindings_4_5_1_canStacheBindings.behaviors.viewModel(el, componentTagData, callback, data);
					};
				}
				teardownBindings = setupFn(el, function(initialViewModelData) {
					...
					if(viewModelHandler) {
						...
						if (canReflect_1_17_6_canReflect.isObservableLike(scopeResult) && canReflect_1_17_6_canReflect.isMapLike(scopeResult) ) {
							// If the function returns a can.Map, use that as the viewModel
							viewModelInstance = scopeResult;
						} else if (canReflect_1_17_6_canReflect.isObservableLike(scopeResult.prototype) && canReflect_1_17_6_canReflect.isMapLike(scopeResult.prototype)) {
			...
			if(this.helpers !== undefined) {
				canReflect_1_17_6_canReflect.eachKey(this.helpers, function(val, prop) {
			...
			if(this.constructor.Control) {
				...
				var removalDisposal = canDomMutate_1_3_0_canDomMutate.onNodeRemoval(el, function () {
					var doc = el.ownerDocument;
			...
			if( hasShadowTemplate ) {
				...
				if (leakScope.intoShadowContent) {
					...
					shadowTagData = {
						scope: new canViewScope_4_11_0_canViewScope(this.viewModel, null, { viewModel: true }),
						options: options
					};
				}
			...
			var nodeList = canViewNodelist_4_3_2_canViewNodelist.register([], function() {
				component._torndown = true;
				canDomEvents_1_3_2_canDomEvents.dispatch(el, "beforeremove", false);
				if(teardownBindings) {
					teardownBindings();
				}
			...
			teardownFunctions.push(function() {
				canViewNodelist_4_3_2_canViewNodelist.unregister(nodeList);
			});
			this.nodeList = nodeList;
			...
			canViewNodelist_4_3_2_canViewNodelist.update(nodeList, canChildNodes_1_2_0_canChildNodes(el));
			...
			if(viewModel && viewModel.connectedCallback) {
				...
				if(componentInPage) {
					...
					var insertionDisposal = canDomMutate_1_3_0_canDomMutate.onNodeInsertion(el, function () {
						insertionDisposal();
						disconnectedCallback = viewModel.connectedCallback(el);
					});
				}
...
var canComponent_4_4_4_canComponent = canNamespace_1_0_0_canNamespace.Component = Component;
...
var map$3 = function(oldObject, newObject){
	...
	oldObjectClone = canReflect_1_17_6_canReflect.assignMap({}, oldObject);

    canReflect_1_17_6_canReflect.eachKey(newObject, function(value, newProp){
...
function makeDiffListIdentityComparison(oldList, newList, parentKey, nestedPatches) {
    var listSchema = canReflect_1_17_6_canReflect.getSchema(oldList),
        ...
        oldListLength = canReflect_1_17_6_canReflect.size( oldList );
    if(listSchema != null) {
        if(listSchema.values != null) {
            typeSchema = canReflect_1_17_6_canReflect.getSchema(listSchema.values);
        }
    ...
    return function(a, b, aIndex) {
        if(canReflect_1_17_6_canReflect.isPrimitive(a)) {
            return a === b;
        }
        if(canReflect_1_17_6_canReflect.isPrimitive(b)) {
            return a === b;
        }
...
function diffDeep(dest, source, parentKey){
    ...
    if (dest && canReflect_1_17_6_canReflect.isMoreListLikeThanMapLike(dest)) {
        var nestedPatches = [],
        ...
        patches.forEach(function(patch){
            ...
            var destVal = dest && canReflect_1_17_6_canReflect.getKeyValue(dest, key),
                sourceVal = source && canReflect_1_17_6_canReflect.getKeyValue(source, key);
...
function smartMerge(instance, props) {
	...
	props = canReflect_1_17_6_canReflect.serialize(props);

	if (canReflect_1_17_6_canReflect.isMoreListLikeThanMapLike(instance)) {
...
function mergeMap(instance, data) {
	...
	// for each key in
	canReflect_1_17_6_canReflect.eachKey(instance, function(value, prop) {
		if(!canReflect_1_17_6_canReflect.hasKey(data, prop)) {
			canReflect_1_17_6_canReflect.deleteKeyValue(instance, prop);
			return;
		}
		var newValue = canReflect_1_17_6_canReflect.getKeyValue(data, prop);
		canReflect_1_17_6_canReflect.deleteKeyValue(data, prop);
		...
		if (canReflect_1_17_6_canReflect.isPrimitive(value)) {
			canReflect_1_17_6_canReflect.setKeyValue(instance, prop, newValue);
			return;
		}


		var newValueIsList = Array.isArray(newValue),
			currentValueIsList = canReflect_1_17_6_canReflect.isMoreListLikeThanMapLike(value);

		if (currentValueIsList && newValueIsList) {

			mergeList(value, newValue);

		} else if (!newValueIsList && !currentValueIsList && canReflect_1_17_6_canReflect.isMapLike(value) && canReflect_1_17_6_canReflect.isPlainObject(newValue)) {

			// TODO: the `TYPE` should probably be infered from the `_define` property definition.
			var schema = canReflect_1_17_6_canReflect.getSchema(value);
			if (schema && schema.identity && schema.identity.length) {
				var id = canReflect_1_17_6_canReflect.getIdentity(value, schema);
				if (id != null && id === canReflect_1_17_6_canReflect.getIdentity(newValue, schema)) {
					mergeMap(value, newValue);
					return;
				}
			}
			canReflect_1_17_6_canReflect.setKeyValue(instance, prop, canReflect_1_17_6_canReflect.new(value.constructor, newValue));
		} else {
			canReflect_1_17_6_canReflect.setKeyValue(instance, prop, newValue);
		}
	});
	canReflect_1_17_6_canReflect.eachKey(data, function(value, prop) {
		canReflect_1_17_6_canReflect.setKeyValue(instance, prop, value);
	});
}

function mergeList(list$$1, data) {
	var ItemType, itemSchema;
	var listSchema = canReflect_1_17_6_canReflect.getSchema(list$$1);
	if (listSchema) {
		ItemType = listSchema.values;
	}

	if (ItemType) {
		itemSchema = canReflect_1_17_6_canReflect.getSchema(ItemType);
	}
	if (!itemSchema && canReflect_1_17_6_canReflect.size(list$$1) > 0) {
		itemSchema = canReflect_1_17_6_canReflect.getSchema(canReflect_1_17_6_canReflect.getKeyValue(list$$1, 0));
	}

	var identity;
	if(itemSchema && itemSchema.identity && itemSchema.identity.length) {
		identity = function(a, b) {
		   var aId = canReflect_1_17_6_canReflect.getIdentity(a, itemSchema),
			   bId = canReflect_1_17_6_canReflect.getIdentity(b, itemSchema);
		   var eq = aId === bId;
		   if (eq) {
	...
	var hydrate = ItemType ? canReflect_1_17_6_canReflect.new.bind(canReflect_1_17_6_canReflect, ItemType) : function(v) {
		return v;
	};
...
var canDiff_1_4_2_canDiff = canNamespace_1_0_0_canNamespace.diff = diff;
...
var _delete = function deleteAtPath(data, path) {
    ...
    for(var i = 0; i < parts.length - 1; i++) {
        if(current) {
            current = canReflect_1_17_6_canReflect.getKeyValue( current, parts[i]);
        }
    }

    if(current) {
        canReflect_1_17_6_canReflect.deleteKeyValue(current, parts[parts.length - 1 ]);
    }
};
...
var setValueSymbol$4 = canSymbol_1_6_1_canSymbol.for("can.setValue");
...
function set$1(object, path, value) {
    ...
    // Set the value
    if (current) {
        canReflect_1_17_6_canReflect.setKeyValue(current, parts[i], value);
    } else {
...
var walk = function walk(obj, name, keyCallback){
    ...
    for (i = 0; i < length; i++) {
        container = current;
        part = parts[i];
        current = canKey_1_2_0_utils.isContainer(container) && canReflect_1_17_6_canReflect.getKeyValue( container, part );
...
function deleteKeys(parentsAndKeys) {
    for(var i  = parentsAndKeys.length - 1; i >= 0; i--) {
        ...
        if(canReflect_1_17_6_canReflect.size(parentAndKey.parent) !== 0) {
            return;
        }
    }
}
...
var transform = function(obj, transformer){
    var copy = canReflect_1_17_6_canReflect.serialize( obj);

    canReflect_1_17_6_canReflect.eachKey(transformer, function(writeKey, readKey){
...
function withKey(obj, key, fn) {
	...
	if (isFunction$2(obj[onKeyValueSymbol$3])) {
		canReflect_1_17_6_canReflect.onKeyValue(obj, key, noop$2);
	}

	result = fn(obj, key);

	if (isFunction$2(obj[offKeyValueSymbol$2])) {
		canReflect_1_17_6_canReflect.offKeyValue(obj, key, noop$2);
	}
...
function withoutKey(obj, fn) {
	...
	if (isFunction$2(obj[onValueSymbol$4])) {
		canReflect_1_17_6_canReflect.onValue(obj, noop$2);
	}

	result = fn(obj);

	if (isFunction$2(obj[offValueSymbol$2])) {
		canReflect_1_17_6_canReflect.offValue(obj, noop$2);
	}
...
var makeNode = function makeNode(obj, key) {
	...
	var node = {
		obj: obj,
		name: canReflect_1_17_6_canReflect.getName(obj),
		value: gotKey ? canReflect_1_17_6_canReflect.getKeyValue(obj, key) : canReflect_1_17_6_canReflect.getValue(obj)
	};
...
var getGraph = function getGraph(obj, key) {
	...
	var visitKeyDependencies = function visitKeyDependencies(source, meta, cb) {
		canReflect_1_17_6_canReflect.eachKey(source.keyDependencies || {}, function(keys, obj) {
			canReflect_1_17_6_canReflect.each(keys, function(key) {
				cb(obj, meta, key);
			});
		});
	};
	...
	var visitValueDependencies = function visitValueDependencies(source, meta, cb) {
		canReflect_1_17_6_canReflect.eachIndex(source.valueDependencies || [], function(obj) {
			cb(obj, meta);
		});
	};
	...
	var visit = function visit(obj, meta, key) {
		...
		if (data && data.whatIChange) {
			...
			// kind :: derive | mutate
			canReflect_1_17_6_canReflect.eachKey(data.whatIChange, function(dependencyRecord, kind) {
				nextMeta.kind = kind;
		...
		if (data && data.whatChangesMe) {
			...
			// kind :: derive | mutate
			canReflect_1_17_6_canReflect.eachKey(data.whatChangesMe, function(dependencyRecord, kind) {
				nextMeta.kind = kind;
				visitKeyDependencies(dependencyRecord, nextMeta, visit);
				visitValueDependencies(dependencyRecord, nextMeta, visit);
			});
...
var formatGraph = function formatGraph(graph) {
	...
	var nodesDataSet = graph.nodes.map(function(node) {
		return {
			...
			label:
				canReflect_1_17_6_canReflect.getName(node.obj) +
				(node.key ? "." + node.key : "")
		};
	});
...
var logData = function log(data) {
	...
	if (data.derive.length) {
		...
		canReflect_1_17_6_canReflect.eachIndex(data.derive, log);
		console.groupEnd();
	}

	if (data.mutations.length) {
		console.group("MUTATED BY");
		canReflect_1_17_6_canReflect.eachIndex(data.mutations, log);
		console.groupEnd();
	}

	if (data.twoWay.length) {
		console.group("TWO WAY");
		canReflect_1_17_6_canReflect.eachIndex(data.twoWay, log);
		console.groupEnd();
	}
...
var global$2 = canGlobals_1_2_0_canGlobals.getKeyValue("global");
...
function registerWithDevtools() {
	...
	var devtoolsCanModules = {
		...
		Reflect: canReflect_1_17_6_canReflect,
		queues: canQueues_1_1_4_canQueues,
...
var canDebug_2_0_1_canDebug = function() {
...
canDomEvents_1_3_2_canDomEvents.addEvent(canEventDomEnter_2_2_0_canEventDomEnter);
...
canComponent_4_4_4_canComponent.extend({
	tag: "editable-span",
...
const isList = val => val instanceof list$1;
canStache_4_15_2_canStache.addHelper("isList", isList);
canStache_4_15_2_canStache.addHelper("isNumber", val => typeof val === "number");
canStache_4_15_2_canStache.addHelper("isEven", num => num % 2 === 0);
...
const getTypeName = val => {
	if (canReflect_1_17_6_canReflect.isObservableLike(val)) {
		if (canReflect_1_17_6_canReflect.isListLike(val)) {
			return "Array";
		} else if (canReflect_1_17_6_canReflect.isMapLike(val)) {
			return "Object";
		}
	}
...
const ParsedJSONNode = map$2.extend("ParsedJSONNode", {
	key: NumberOrString,
...
const ParsedJSON = list$1.extend("ParsedJSON", {
	"#": ParsedJSONNode
});
...
const parseKeyValue = (key, value, parentPath) => {
	...
	const mightHaveChildren = canReflect_1_17_6_canReflect.isObservableLike(value) && (canReflect_1_17_6_canReflect.isListLike(value) || canReflect_1_17_6_canReflect.isMapLike(value));

	if (mightHaveChildren) {
		parsedValue = [];

		value.forEach((childValue, childKey) => {
			parsedValue.push(parseKeyValue(childKey, childValue, path));
		});
	} else {
		parsedValue = value;
	}
...
const JSONTreeEditor = canComponent_4_4_4_canComponent.extend({
	...
	ViewModel: {
		...
		displayedOptions: {
			value({ listenTo, lastSet, resolve }) {
				let options = resolve(new list$1());
		...
		expandedKeys: {
			value({ listenTo, lastSet, resolve }) {
				...
				listenTo("add-child", (ev, path) => {
					...
					let parent = canKey_1_2_0_canKey.get(this.json, path);

					if (parent instanceof list$1) {
						path = path + ".0";
					}
		...
		json: {
			...
			value({ listenTo, lastSet, resolve }) {
				...
				const resetJson = newJson => {
					json = resolve(new map$2(newJson));
				};
				...
				listenTo("set-json-path-value", (ev, path, value) => {
					if (value.match(wrappedInQuotesRegex)) {
						...
						value = canStringToAny_1_2_0_canStringToAny(value);
					}

					canKey_1_2_0_canKey.set(json, path, value);
				});

				listenTo("delete-json-path", (ev, path) => {
					canKey_1_2_0_canKey.deleteKey(this.json, path);
				});

				listenTo("add-child", (ev, path) => {
					let parent = canKey_1_2_0_canKey.get(json, path);
		...
		get parsedJSON() {
			...
			canReflect_1_17_6_canReflect.each(this.json, (value, key) => {
		...
		displayedKeyValueEditors: {
			value({ listenTo, lastSet, resolve }) {
				let displayedEditors = resolve(new list$1());
...
const KeyValueEditor = canComponent_4_4_4_canComponent.extend({
...
var viewmodelEditor = canComponent_4_4_4_canComponent.extend({
	tag: "viewmodel-editor",
	ViewModel: {
		// allow overwriting editor for testing
		editor: "any",
		tagName: "string",
		viewModelData: { Type: map$2, Default: map$2 },
		...
		json: {
			value({ listenTo, lastSet, resolve }) {
				let json = resolve(new map$2(this.serializedViewModelData));
				let jsonPatches = [];

				const setPatches = (newJSON, oldJSON) => {
					const patches = canDiff_1_4_2_canDiff.deep(oldJSON, newJSON);
				...
				const serializedJSON = new canObservation_4_1_1_canObservation(() => json.serialize());
				canReflect_1_17_6_canReflect.onValue(serializedJSON, setPatches);
				...
				listenTo("serializedViewModelData", (ev, vmData) => {
					...
					canReflect_1_17_6_canReflect.offValue(serializedJSON, setPatches);
					canReflect_1_17_6_canReflect.assignDeep(json, newJson);
					canReflect_1_17_6_canReflect.onValue(serializedJSON, setPatches);
				});
		...
		getPatchedData(destination, patches) {
			...
			patches.forEach(({ type, key: key$$1, value, index, deleteCount, insert }) => {
				switch (type) {
					case "add":
					case "set":
						canKey_1_2_0_canKey.set(patchedData, key$$1, value);
						break;
					case "delete":
						canKey_1_2_0_canKey.deleteKey(patchedData, key$$1);
						break;
					case "splice":
						let arr = canKey_1_2_0_canKey.get(patchedData, key$$1);
		...
		get jsonEditorPatches() {
			return canDiff_1_4_2_canDiff.deep(this.serializedViewModelData, this.json.serialize());
		},
...
export default viewmodelEditor;
export { canComponent_4_4_4_canComponent as Component, map$2 as DefineMap, canKey_1_2_0_canKey as key, canDiff_1_4_2_canDiff as diff, canReflect_1_17_6_canReflect as Reflect, canObservation_4_1_1_canObservation as Observation };
