...
const helpers$1 = {
	...
	convertItem: function(Constructor, item) {
		if(Constructor.items) {
			const definition = mixins$1.normalizeTypeDefinition(Constructor.items.type || Constructor.items);
	...
	if (descriptor && descriptor.set) {
		...
		if (change) {
			...
			if(keyIsString && !(key in target)) {
				mixins$2.expando(target, key, value);
			} else {
...
const MixedInArray = mixinTypeEvents$1(mixinMapProps(ProxyArray));
...
class ObservableArray extends MixedInArray {
	...
	constructor(items, props) {
		...
		mixins$3.finalizeClass(new.target);
		mixins$3.initialize(this, props || {});
...
makeDefineInstanceKey$2(ObservableArray);
...
var canObservableArray = canNamespace_1_0_0_canNamespace.ObservableArray = createConstructorFunction$1(
	ObservableArray
);
...
ObservableObject = mixinTypeEvents$2(mixinMapProps$1(ObservableObject));
makeDefineInstanceKey$3(ObservableObject);

// Export a constructor function to workaround an issue where ES2015 classes
// cannot be extended in code that's transpiled by Babel.
var canObservableObject = canNamespace_1_0_0_canNamespace.ObservableObject = createConstructorFunction$2(
	ObservableObject
);
...
export { canStacheElement as StacheElement, canObservableObject as ObservableObject, canObservableArray as ObservableArray, canKey_1_2_1_canKey as key, canDiff_1_5_0_canDiff as diff, canReflect_1_18_0_canReflect as Reflect, canType_1_1_2_canType as type, canObservation_4_2_0_canObservation as Observation };
