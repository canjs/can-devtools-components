...
var canSymbol_1_6_3_canSymbol = canNamespace_1_0_0_canNamespace.Symbol = CanSymbol;

var helpers = {
	makeGetFirstSymbolValue: function(symbolNames){
		var symbols = symbolNames.map(function(name){
			return canSymbol_1_6_3_canSymbol.for(name);
		});
...
function isConstructorLike(func){
	...
	var value = func[canSymbol_1_6_3_canSymbol.for("can.new")];
	if(value !== undefined) {
		return value;
	}
...
function isFunctionLike(obj){
	var result,
		symbolValue = !!obj && obj[canSymbol_1_6_3_canSymbol.for("can.isFunctionLike")];
...
function isValueLike(obj) {
	...
	symbolValue = obj[canSymbol_1_6_3_canSymbol.for("can.isValueLike")];
	if( typeof symbolValue !== "undefined") {
		return symbolValue;
	}
	var value = obj[canSymbol_1_6_3_canSymbol.for("can.getValue")];
	if(value !== undefined) {
		return !!value;
	}
}
...
function isMapLike(obj) {
	...
	var isMapLike = obj[canSymbol_1_6_3_canSymbol.for("can.isMapLike")];
	if(typeof isMapLike !== "undefined") {
		return !!isMapLike;
	}
	var value = obj[canSymbol_1_6_3_canSymbol.for("can.getKeyValue")];
	if(value !== undefined) {
		return !!value;
	}
...
// Specially optimized
var onValueSymbol = canSymbol_1_6_3_canSymbol.for("can.onValue"),
	onKeyValueSymbol = canSymbol_1_6_3_canSymbol.for("can.onKeyValue"),
	onPatchesSymbol = canSymbol_1_6_3_canSymbol.for("can.onPatches");
...
function isListLike( list ) {
	...
	symbolValue = list[canSymbol_1_6_3_canSymbol.for("can.isListLike")];
	if( typeof symbolValue !== "undefined") {
		return symbolValue;
	}
	var value = list[canSymbol_1_6_3_canSymbol.iterator];
	if(value !== undefined) {
		return !!value;
	}
...
var type = {
	...
	isMoreListLikeThanMapLike: function(obj){
		...
		var value = obj[canSymbol_1_6_3_canSymbol.for("can.isMoreListLikeThanMapLike")];
		if(value !== undefined) {
			return value;
		}
...
var call = {
	...
	call: function(func, context){
		...
		var apply = func[canSymbol_1_6_3_canSymbol.for("can.apply")];
		if(apply) {
	...
	"new": function(func){
		...
		var makeNew = func[canSymbol_1_6_3_canSymbol.for("can.new")];
		if(makeNew) {
...
var setKeyValueSymbol = canSymbol_1_6_3_canSymbol.for("can.setKeyValue"),
	getKeyValueSymbol = canSymbol_1_6_3_canSymbol.for("can.getKeyValue"),
	getValueSymbol = canSymbol_1_6_3_canSymbol.for("can.getValue"),
	setValueSymbol = canSymbol_1_6_3_canSymbol.for("can.setValue");
...
var reflections = {
	...
	deleteKeyValue: function(obj, key) {
		var deleteKeyValue = obj[canSymbol_1_6_3_canSymbol.for("can.deleteKeyValue")];
		if(deleteKeyValue) {
	...
	splice: function(obj, index, removing, adding){
		...
		if(typeof removing !== "number") {
			var updateValues = obj[canSymbol_1_6_3_canSymbol.for("can.updateValues")];
			if(updateValues) {
		...
		var splice = obj[canSymbol_1_6_3_canSymbol.for("can.splice")];
		if(splice) {
	...
	addValues: function(obj, adding, index) {
		var add = obj[canSymbol_1_6_3_canSymbol.for("can.addValues")];
		if(add) {
	...
	removeValues: function(obj, removing, index) {
		var removeValues = obj[canSymbol_1_6_3_canSymbol.for("can.removeValues")];
		if(removeValues) {
...
function makeFallback(symbolName, fallbackName) {
	return function(obj, event, handler, queueName){
		var method = obj[canSymbol_1_6_3_canSymbol.for(symbolName)];
		if(method !== undefined) {
...
var observe = {
	...
	getChangesDependencyRecord: function getChangesDependencyRecord(handler) {
		var fn = handler[canSymbol_1_6_3_canSymbol.for("can.getChangesDependencyRecord")];
   ...
   * arr.pop();  // logs [{type: "remove", property:"0"},
	...
	onEvent: function(obj, eventName, callback, queue){
		if(obj) {
			var onEvent = obj[canSymbol_1_6_3_canSymbol.for("can.onEvent")];
	...
	offEvent: function(obj, eventName, callback, queue){
		if(obj) {
			var offEvent = obj[canSymbol_1_6_3_canSymbol.for("can.offEvent")];
	...
	setPriority: function(obj, priority) {
		if(obj) {
			var setPriority =  obj[canSymbol_1_6_3_canSymbol.for("can.setPriority")];
	...
	getPriority: function(obj) {
		if(obj) {
			var getPriority =  obj[canSymbol_1_6_3_canSymbol.for("can.getPriority")];
...
var getKeyValueSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.getKeyValue");
var shiftedGetKeyValue = shiftFirstArgumentToThis(getSet.getKeyValue);
var setKeyValueSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.setKeyValue");
var shiftedSetKeyValue = shiftFirstArgumentToThis(getSet.setKeyValue);

var sizeSymbol = canSymbol_1_6_3_canSymbol.for("can.size");
...
var fastHasOwnKey = function(obj){
	var hasOwnKey = obj[canSymbol_1_6_3_canSymbol.for("can.hasOwnKey")];
	if(hasOwnKey) {
...
shapeReflections = {
	...
	eachIndex: function(list, callback, context){
		...
		if(Array.isArray(list)) {
			...
			var iter, iterator = list[canSymbol_1_6_3_canSymbol.iterator];
	...
	"hasOwnKey": function(obj, key){
		...
		var getOwnKeys = obj[canSymbol_1_6_3_canSymbol.for("can.getOwnKeys")];
		if( getOwnKeys ) {
			var found = false;
	...
	getOwnEnumerableKeys: function(obj){
		...
		var getOwnEnumerableKeys = obj[canSymbol_1_6_3_canSymbol.for("can.getOwnEnumerableKeys")];
		if(getOwnEnumerableKeys) {
			return getOwnEnumerableKeys.call(obj);
		}
		if( obj[canSymbol_1_6_3_canSymbol.for("can.getOwnKeys")] && obj[canSymbol_1_6_3_canSymbol.for("can.getOwnKeyDescriptor")] ) {
			var keys = [];
	...
	getOwnKeyDescriptor: function(obj, key){
		var getOwnKeyDescriptor = obj[canSymbol_1_6_3_canSymbol.for("can.getOwnKeyDescriptor")];
	 ...
	 */
	unwrap: makeSerializer("unwrap",[canSymbol_1_6_3_canSymbol.for("can.unwrap")]),
	/**
	 ...
	 */
	serialize: makeSerializer("serialize",[canSymbol_1_6_3_canSymbol.for("can.serialize"), canSymbol_1_6_3_canSymbol.for("can.unwrap")]),
	...
	assignDeep: function(target, source){
		var assignDeep = target[canSymbol_1_6_3_canSymbol.for("can.assignDeep")];
		if(assignDeep) {
	...
	updateDeep: function(target, source){
		var updateDeep = target[canSymbol_1_6_3_canSymbol.for("can.updateDeep")];
		if(updateDeep) {
	...
	hasKey: function(obj, key) {
		...
		var hasKey = obj[canSymbol_1_6_3_canSymbol.for("can.hasKey")];
		if(hasKey) {
	...
	assignSymbols: function(target, source){
		shapeReflections.eachKey(source, function(value, key){
			var symbol = type.isSymbolLike(canSymbol_1_6_3_canSymbol[key]) ? canSymbol_1_6_3_canSymbol[key] : canSymbol_1_6_3_canSymbol.for(key);
	...
	defineInstanceKey: function(cls, key, properties) {
		var defineInstanceKey = cls[canSymbol_1_6_3_canSymbol.for("can.defineInstanceKey")];
		if(defineInstanceKey) {
			return defineInstanceKey.call(cls, key, properties);
		}
		var proto = cls.prototype;
		defineInstanceKey = proto[canSymbol_1_6_3_canSymbol.for("can.defineInstanceKey")];
		if(defineInstanceKey) {
...
var getSchemaSymbol = canSymbol_1_6_3_canSymbol.for("can.getSchema"),
    isMemberSymbol = canSymbol_1_6_3_canSymbol.for("can.isMember"),
    newSymbol = canSymbol_1_6_3_canSymbol.for("can.new");
...
var getNameSymbol = canSymbol_1_6_3_canSymbol.for("can.getName");
...
if (typeof Map !== "undefined") {
  ...
  if (typeof Map.prototype.keys !== "function") {
    Map.prototype.keys = Map.prototype[canSymbol_1_6_3_canSymbol.for("can.getOwnEnumerableKeys")] = keysPolyfill;
  }
}
...
if (typeof Set !== "undefined") {
  ...
  if (typeof Set.prototype[canSymbol_1_6_3_canSymbol.iterator] !== "function") {
	  Set.prototype[canSymbol_1_6_3_canSymbol.iterator] = function() {
		  var arr = [];
		  var currentIndex = 0;
...
var addParentSymbol = canSymbol_1_6_3_canSymbol.for("can.addParent"),
	getValueSymbol = canSymbol_1_6_3_canSymbol.for("can.getValue");
...
var dispatchSymbol = canSymbol_1_6_3_canSymbol.for("can.dispatch");
var getChangesSymbol = canSymbol_1_6_3_canSymbol.for("can.getChangesDependencyRecord");
var getValueDependenciesSymbol = canSymbol_1_6_3_canSymbol.for("can.getValueDependencies");
...
canReflect_1_17_7_canReflect.assign(Observation.prototype, {
	...
	onBound: function(){
		...
		canObservationRecorder_1_3_0_canObservationRecorder.start();
	...
	onUnbound: function(){
		...
		this.newDependencies = canObservationRecorder_1_3_0_canObservationRecorder.makeDependenciesRecorder();
	},
...
var dispatchSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.dispatch");
...
var peek = canObservationRecorder_1_3_0_canObservationRecorder.ignore(canReflect_1_17_7_canReflect.getValue.bind(canReflect_1_17_7_canReflect));
...
var peek$1 = canObservationRecorder_1_3_0_canObservationRecorder.ignore(canReflect_1_17_7_canReflect.getValue.bind(canReflect_1_17_7_canReflect));
...
var metaSymbol = canSymbol_1_6_3_canSymbol.for("can.meta"),
	dispatchBoundChangeSymbol = canSymbol_1_6_3_canSymbol.for("can.dispatchInstanceBoundChange"),
	dispatchInstanceOnPatchesSymbol = canSymbol_1_6_3_canSymbol.for("can.dispatchInstanceOnPatches"),
	onKeyValueSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.onKeyValue"),
	offKeyValueSymbol = canSymbol_1_6_3_canSymbol.for("can.offKeyValue"),
	onEventSymbol = canSymbol_1_6_3_canSymbol.for("can.onEvent"),
	offEventSymbol = canSymbol_1_6_3_canSymbol.for("can.offEvent"),
	onValueSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.onValue"),
	offValueSymbol = canSymbol_1_6_3_canSymbol.for("can.offValue");
...
var getChangesSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.getChangesDependencyRecord");
...
canReflect_1_17_7_canReflect.assignMap(ResolverObservable.prototype, {
	...
	stopListening: function(){
		...
		var meta = this.binder[canSymbol_1_6_3_canSymbol.for("can.meta")];
...
var metaSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.meta");
...
var newSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.new"),
	serializeSymbol = canSymbol_1_6_3_canSymbol.for("can.serialize");
...
var peek$2 = canObservationRecorder_1_3_0_canObservationRecorder.ignore(canReflect_1_17_7_canReflect.getValue.bind(canReflect_1_17_7_canReflect));
...
var canDefine_2_7_4_canDefine = define = canNamespace_1_0_0_canNamespace.define = function(typePrototype, defines, baseDefine) {
	...
	var iteratorSymbol = canSymbol_1_6_3_canSymbol.iterator || canSymbol_1_6_3_canSymbol.for("iterator");
...
define.makeDefineInstanceKey = function(constructor) {
	constructor[canSymbol_1_6_3_canSymbol.for("can.defineInstanceKey")] = function(property, value) {
...
var canMetaSymbol = canSymbol_1_6_3_canSymbol.for("can.meta");
...
var onKeyValueSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.onKeyValue");
var offKeyValueSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.offKeyValue");
...
// Ensure the "obj" passed as an argument has an object on @@can.meta
var canDefine_2_7_4_ensureMeta = function ensureMeta(obj) {
	var metaSymbol = canSymbol_1_6_3_canSymbol.for("can.meta");
	var meta = obj[metaSymbol];
...
var defineHelpers = {
	...
	defineExpando: canDefine_2_7_4_canDefine.expando,
	...
	log: function(key) {
		...
		var meta = canDefine_2_7_4_ensureMeta(instance);
...
var getSchemaSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.getSchema");
...
function getSchema() {
	...
	return canDefine_2_7_4_canDefine.updateSchemaKeys(schema, definitions);
}

var sealedSetup = function(props){
	canDefine_2_7_4_canDefine.setup.call(
		this,
		props || {},
...
var DefineMap = canConstruct_3_5_3_canConstruct.extend("DefineMap",{
	setup: function(base){
		...
		if(DefineMap) {
			...
			var result = canDefine_2_7_4_canDefine(prototype, prototype, base.prototype._define);
				canDefine_2_7_4_canDefine.makeDefineInstanceKey(this, result);

			type$1(this);
			for(key in DefineMap.prototype) {
				canDefine_2_7_4_canDefine.defineConfigurableAndNotEnumerable(prototype, key, prototype[key]);
			}
			// If someone provided their own setup, we call that.
			if(prototype.setup === DefineMap.prototype.setup) {
				canDefine_2_7_4_canDefine.defineConfigurableAndNotEnumerable(prototype, "setup", sealedSetup);
			}
		...
		canDefine_2_7_4_canDefine.defineConfigurableAndNotEnumerable(prototype, "constructor", this);
	...
	"*": {
		type: canDefine_2_7_4_canDefine.types.observable
	}
});
...
canReflect_1_17_7_canReflect.setKeyValue(DefineMap.prototype, canSymbol_1_6_3_canSymbol.iterator, function() {
	return new canDefine_2_7_4_canDefine.Iterator(this);
});

// Add necessary event methods to this object.
for(var prop in canDefine_2_7_4_canDefine.eventsProto) {
	DefineMap[prop] = canDefine_2_7_4_canDefine.eventsProto[prop];
	Object.defineProperty(DefineMap.prototype, prop, {
		enumerable:false,
		value: canDefine_2_7_4_canDefine.eventsProto[prop],
		writable: true
	});
}
...
var eventsProtoSymbols = ("getOwnPropertySymbols" in Object) ?
  Object.getOwnPropertySymbols(canDefine_2_7_4_canDefine.eventsProto) :
  getSymbolsForIE(canDefine_2_7_4_canDefine.eventsProto);

eventsProtoSymbols.forEach(function(sym) {
  Object.defineProperty(DefineMap.prototype, sym, {
  	configurable: true,
    enumerable:false,
    value: canDefine_2_7_4_canDefine.eventsProto[sym],
    writable: true
  });
});
...
if(process.env.NODE_ENV !== 'production') {
	...
	canDefine_2_7_4_canDefine.defineConfigurableAndNotEnumerable(DefineMap.prototype, "log", defineHelpers_1.log);
}
//!steal-remove-end

// tells `can-define` to use this
canDefine_2_7_4_canDefine.DefineMap = DefineMap;
...
var make$1 = canDefine_2_7_4_canDefine.make;
...
var onKeyValue = canDefine_2_7_4_canDefine.eventsProto[canSymbol_1_6_3_canSymbol.for("can.onKeyValue")];
var offKeyValue = canDefine_2_7_4_canDefine.eventsProto[canSymbol_1_6_3_canSymbol.for("can.offKeyValue")];
var getSchemaSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.getSchema");
...
function getSchema$1() {
	...
	schema = canDefine_2_7_4_canDefine.updateSchemaKeys(schema, definitions);
	if(schema.keys["#"]) {
...
var DefineList = canConstruct_3_5_3_canConstruct.extend("DefineList",
	...
	/** @prototype */
	{
		...
		setup: function(items) {
			...
			canDefine_2_7_4_canDefine.setup.call(this, {}, false);
		...
		__type: canDefine_2_7_4_canDefine.types.observable,
...
for(var prop$1 in canDefine_2_7_4_canDefine.eventsProto) {
	Object.defineProperty(DefineList.prototype, prop$1, {
		enumerable:false,
		value: canDefine_2_7_4_canDefine.eventsProto[prop$1],
		writable: true
	});
}
...
var eventsProtoSymbols$1 = ("getOwnPropertySymbols" in Object) ?
  Object.getOwnPropertySymbols(canDefine_2_7_4_canDefine.eventsProto) :
  [canSymbol_1_6_3_canSymbol.for("can.onKeyValue"), canSymbol_1_6_3_canSymbol.for("can.offKeyValue")];
...
// Add necessary event methods to this object.
for (var prop$1 in canDefine_2_7_4_canDefine.eventsProto) {
	DefineList[prop$1] = canDefine_2_7_4_canDefine.eventsProto[prop$1];
	Object.defineProperty(DefineList.prototype, prop$1, {
		enumerable: false,
		value: canDefine_2_7_4_canDefine.eventsProto[prop$1],
		writable: true
...
var defineListProto = {
	...
	"can.onPatches": function(handler,queue){
		this[canSymbol_1_6_3_canSymbol.for("can.onKeyValue")](localOnPatchesSymbol, handler,queue);
	},
	"can.offPatches": function(handler,queue) {
		this[canSymbol_1_6_3_canSymbol.for("can.offKeyValue")](localOnPatchesSymbol, handler,queue);
	}
};
...
canReflect_1_17_7_canReflect.setKeyValue(DefineList.prototype, canSymbol_1_6_3_canSymbol.iterator, function() {
	var index = -1;
...
canDefine_2_7_4_canDefine.DefineList = DefineList;

var list$1 = canNamespace_1_0_0_canNamespace.DefineList = DefineList;

var getKeyValueSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.getKeyValue"),
	observeDataSymbol = canSymbol_1_6_3_canSymbol.for("can.meta");
...
var getValueSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.getValue");
var setValueSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.setValue");

var isValueLikeSymbol = canSymbol_1_6_3_canSymbol.for("can.isValueLike");
var peek$3 = canObservationRecorder_1_3_0_canObservationRecorder.ignore(canReflect_1_17_7_canReflect.getKeyValue.bind(canReflect_1_17_7_canReflect));
var observeReader;
...
var controlsSymbol = canSymbol_1_6_3_canSymbol.for("can.controls");
...
var getWhatIChangeSymbol = canSymbol_1_6_3_canSymbol.for("can.getWhatIChange");
var getKeyDependenciesSymbol = canSymbol_1_6_3_canSymbol.for("can.getKeyDependencies");
var getValueDependenciesSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.getValueDependencies");
...
// Symbols
var getChangesSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.getChangesDependencyRecord");
var getValueSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.getValue");
var onValueSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.onValue");
var onEmitSymbol = canSymbol_1_6_3_canSymbol.for("can.onEmit");
var offEmitSymbol = canSymbol_1_6_3_canSymbol.for("can.offEmit");
var setValueSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.setValue");
...
function turnOffListeningAndUpdate(listenToObservable, updateObservable, updateFunction, queue) {
	...
	if (listenToObservable[onValueSymbol$2]) {
		offValueOrOffEmitFn = canReflect_1_17_7_canReflect.offValue;
...
function turnOnListeningAndUpdate(listenToObservable, updateObservable, updateFunction, queue) {
	...
	if (listenToObservable[onValueSymbol$2]) {
		onValueOrOnEmitFn = canReflect_1_17_7_canReflect.onValue;
	} else if (listenToObservable[onEmitSymbol]) {
	...
	*/
	...
	remove: function(elementsToBeRemoved){
		...
		for (var i = 0; i < elementsToBeRemoved.length; i++) {
			canDomMutate_1_3_6_node.removeChild.call(parent, elementsToBeRemoved[i]);
		}
	},
	nodeMap: nodeMap
};
...
var fragmentRE = /^\s*<(\w+)[^>]*>/,
	toString$1 = {}.toString,
	toDOMSymbol = canSymbol_1_6_3_canSymbol.for("can.toDOM");
...
var callbackMapSymbol = canSymbol_1_6_3_canSymbol.for('can.callbackMap');
...
var dispatchSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.dispatch");
...
var getFastPathRoot = canObservationRecorder_1_3_0_canObservationRecorder.ignore(function(computeData){
	if( computeData.reads &&
		...
		if( root && root[canSymbol_1_6_3_canSymbol.for("can.getValue")] ) {
...
function getMutated(scopeKeyData){
	...
	return !canReflect_1_17_7_canReflect.isPrimitive(value$$1) ? value$$1 : scopeKeyData.root;
}
...
var isViewSymbol = canSymbol_1_6_3_canSymbol.for("can.isView");
...
core.attr = function(el, attributeName, compute) {
	...
	canAttributeObservable_1_2_1_behaviors.set(el, attributeName, canReflect_1_17_7_canReflect.getValue(compute));
};
...
var viewInsertSymbol = canSymbol_1_6_3_canSymbol.for("can.viewInsert");
...
var onValueSymbol$3 = canSymbol_1_6_3_canSymbol.for("can.onValue"),
	offValueSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.offValue");
var onPatchesSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.onPatches");
var offPatchesSymbol = canSymbol_1_6_3_canSymbol.for("can.offPatches");
...
var onPatchesSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.onPatches");
var offPatchesSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.offPatches");
...
//!steal-remove-start
if (process.env.NODE_ENV !== 'production') {
	var canSymbol = canSymbol_1_6_3_canSymbol;
}
//!steal-remove-end
...
var sourceTextSymbol = canSymbol_1_6_3_canSymbol.for("can-stache.sourceText");
var isViewSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.isView");
...
Call.prototype.value = function(scope, helperOptions){
	...
	canObservation_4_1_1_canObservation.temporarilyBind(method);
...
var sourceTextSymbol$1 = canSymbol_1_6_3_canSymbol.for("can-stache.sourceText");
...
var sourceTextSymbol$2 = canSymbol_1_6_3_canSymbol.for("can-stache.sourceText");
...
var expression = {
	...
	hydrateAst: function(ast, options, methodType, isArg){
		...
		if(ast.type === "Lookup") {
			...
			//!steal-remove-start
			if (process.env.NODE_ENV !== 'production') {
				originalKey = ast[canSymbol_1_6_3_canSymbol.for("can-stache.originalKey")];
			}
			//!steal-remove-end
			return new bracket(
		...
		while(cursor.index < tokens.length) {
			...
			// Bracket
				...
				if (lastToken && (lastToken.type === "Call" || lastToken.type === "Bracket"  )  ) {
					...
					//!steal-remove-start
					if (process.env.NODE_ENV !== 'production') {
						canReflect_1_17_7_canReflect.setKeyValue(bracket$$1, canSymbol_1_6_3_canSymbol.for("can-stache.originalKey"), top.key);
					}
					//!steal-remove-end
...
var toDOMSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.toDOM");
...
var mustacheLineBreakRegExp = /(?:(^|\r?\n)(\s*)(\{\{([\s\S]*)\}\}\}?)([^\S\n\r]*)($|\r?\n))|(\{\{([\s\S]*)\}\}\}?)/g,
	...
	k = function(){};
var viewInsertSymbol$1 = canSymbol_1_6_3_canSymbol.for("can.viewInsert");
...
var core$1 = {
	...
	makeLiveBindingPartialRenderer: function(expressionString, state){
		...
		return function(scope, parentSectionNodeList){
			...
			var partialFrag = new canObservation_4_1_1_canObservation(function(){
				...
				var partial = canReflect_1_17_7_canReflect.getKeyValue(partialScope.templateContext.partials, localPartialName);
				var renderer;
	...
	makeStringBranchRenderer: function(mode, expressionString, state){
		...
		var branchRenderer = function branchRenderer(scope, truthyRenderer, falseyRenderer){
			...
			var gotObservableValue = evaluator[canSymbol_1_6_3_canSymbol.for("can.onValue")],
				res;
...
if (process.env.NODE_ENV !== 'production') {
	...
	var canSymbol$1 = canSymbol_1_6_3_canSymbol;
...
var isViewSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.isView");
...
var canStache_4_15_12_canStache = canNamespace_1_0_0_canNamespace.stache = stache;

var viewModelSymbol = canSymbol_1_6_3_canSymbol.for('can.viewModel');
...
var onValueSymbol$4 = canSymbol_1_6_3_canSymbol.for('can.onValue');
var offValueSymbol$2 = canSymbol_1_6_3_canSymbol.for('can.offValue');
var onEmitSymbol$1 = canSymbol_1_6_3_canSymbol.for('can.onEmit');
var offEmitSymbol$1 = canSymbol_1_6_3_canSymbol.for('can.offEmit');
...
var onKeyValueSymbol$3 = canSymbol_1_6_3_canSymbol.for("can.onKeyValue");
...
var behaviors = {
	...
	viewModel: function(el, tagData, makeViewModel, initialViewModelData, staticDataBindingsOnly) {
		...
		canReflect_1_17_7_canReflect.eachListLike(el.attributes || [], function(node) {
	...
	event: function(el, data) {
		...
		if (startsWith.call(attributeName, onMatchStr)) {
			...
			var viewModel = el[canSymbol_1_6_3_canSymbol.for('can.viewModel')];
...
canStacheBindings[canSymbol_1_6_3_canSymbol.for("can.callbackMap")] = bindings;
canViewCallbacks_4_3_2_canViewCallbacks.attrs(canStacheBindings);

var canStacheBindings_4_7_3_canStacheBindings = canStacheBindings;
...
// Symbols
var createdByCanComponentSymbol = canSymbol_1_6_3_canSymbol("can.createdByCanComponent");
var getValueSymbol$3 = canSymbol_1_6_3_canSymbol.for("can.getValue");
var setValueSymbol$3 = canSymbol_1_6_3_canSymbol.for("can.setValue");
var viewInsertSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.viewInsert");
var viewModelSymbol$1 = canSymbol_1_6_3_canSymbol.for('can.viewModel');

canStache_4_15_12_canStache.addBindings(canStacheBindings_4_7_3_canStacheBindings);
...
function addContext(el, tagData, insertionElementTagData) {
	...
	var teardown = canStacheBindings_4_7_3_canStacheBindings.behaviors.viewModel(el, insertionElementTagData, function(initialData, hasDataBinding, bindingState) {
		...
		setup: function() {
			...
			if (Component) {
				...
				if (typeof this.renderer === "string") {
					...
					this.renderer = canStache_4_15_12_canStache(viewName, this.renderer);
				}
		...
		setup: function(el, componentTagData) {
			...
			if (componentContent !== undefined) {
				...
				if (typeof componentContent === "function") {
					...
					componentTagData.subtemplate = canStache_4_15_12_canStache(componentContent);
				}
			}
			...
			if (componentTemplates !== undefined) {
				canReflect_1_17_7_canReflect.eachKey(componentTemplates, function(template, name) {
					...
					if (typeof template === "string") {
						...
						componentTemplates[name] = canStache_4_15_12_canStache(debugName, template);
					}
				});
			}
			...
			if (preventDataBindings) {
				...
				if (componentTagData.setupBindings) {
					...
					setupFn = function(el, callback, data) {
						return canStacheBindings_4_7_3_canStacheBindings.behaviors.viewModel(el, componentTagData, callback, data);
					};
				}
...
var canComponent_4_4_10_canComponent = canNamespace_1_0_0_canNamespace.Component = Component;
...
var canDiff_1_4_3_canDiff = canNamespace_1_0_0_canNamespace.diff = diff;
...
var setValueSymbol$4 = canSymbol_1_6_3_canSymbol.for("can.setValue");
...
var onValueSymbol$5 = canSymbol_1_6_3_canSymbol.for("can.onValue");
var offValueSymbol$3 = canSymbol_1_6_3_canSymbol.for("can.offValue");
var onKeyValueSymbol$4 = canSymbol_1_6_3_canSymbol.for("can.onKeyValue");
var offKeyValueSymbol$2 = canSymbol_1_6_3_canSymbol.for("can.offKeyValue");
...
function registerWithDevtools() {
	...
	var devtoolsCanModules = {
		Symbol: canSymbol_1_6_3_canSymbol,
...
canComponent_4_4_10_canComponent.extend({
	tag: "editable-span",
...
canStache_4_15_12_canStache.addHelper("isList", isList);
canStache_4_15_12_canStache.addHelper("isNumber", val => typeof val === "number");
canStache_4_15_12_canStache.addHelper("isEven", num => num % 2 === 0);
const removeTrailingBracketsOrBraces = str => str.replace(/\[\]|\{\}$/, "");
canStache_4_15_12_canStache.addHelper("removeTrailingBracketsOrBraces", removeTrailingBracketsOrBraces);
...
const JSONTreeEditor = canComponent_4_4_10_canComponent.extend({
...
const KeyValueEditor = canComponent_4_4_10_canComponent.extend({
...
var viewmodelEditor = canComponent_4_4_10_canComponent.extend({
	...
	ViewModel: {
		...
		json: {
			value({ listenTo, lastSet, resolve }) {
				...
				const setPatches = (newJSON, oldJSON) => {
					const patches = canDiff_1_4_3_canDiff.deep(oldJSON, newJSON);
		...
		get jsonEditorPatches() {
			return canDiff_1_4_3_canDiff.deep(this.serializedViewModelData, this.json.serialize());
		},
...
export { canComponent_4_4_10_canComponent as Component, map$2 as DefineMap, canKey_1_2_0_canKey as key, canDiff_1_4_3_canDiff as diff, canReflect_1_17_7_canReflect as Reflect, canObservation_4_1_1_canObservation as Observation };
