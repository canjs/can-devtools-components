...
class TaskList extends canObservableArray {
	...
	static get items() {
		return canType_1_1_3_canType.convert(Task);
	}
}
...
class QueuesLogstack extends canStacheElement {
	...
	static get props() {
		return {
			stack: {
				type: canType_1_1_3_canType.convert(TaskList),
...
export { canStacheElement as StacheElement, canType_1_1_3_canType as type, canObservableArray as ObservableArray };
