...
class Task extends canObservableObject {
	static get props() {
		return {
			queue: String,
			context: String,
...
class TaskList extends canObservableArray {
	static get props() {
		return {};
	}

	static get items() {
		return canType_1_1_2_canType.convert(Task);
	}
}

class QueuesLogstack extends canStacheElement {
	static get view() {
		return `
			{{# if(this.stack) }}
	...
	static get props() {
		return {
			stack: {
				type: canType_1_1_2_canType.convert(TaskList),
...
export { canStacheElement as StacheElement, canType_1_1_2_canType as type, canObservableArray as ObservableArray };
