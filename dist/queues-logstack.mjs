...
var queuesLogstack = canComponent_4_4_4_canComponent.extend({
	tag: "queues-logstack",
	ViewModel: {
		stack: { Type: list$1, Default: list$1 },
		selectedTask: {
...
export { canComponent_4_4_4_canComponent as Component, list$1 as DefineList };
